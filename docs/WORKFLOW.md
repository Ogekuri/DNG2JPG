    ...
    - `run(...)`: execute conversion pipeline [`src/dng2jpg/dng2jpg.py`]
      ...
      - `_parse_run_options(...)`: parse positional/optional CLI arguments into normalized option dataclasses [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_parse_auto_levels_option(...)`: parse `--auto-levels` optional boolean value [`src/dng2jpg/dng2jpg.py`]
          - `print_error(...)`: emit parse diagnostics [`src/shell_scripts/utils.py`]
        - `_parse_auto_levels_highlight_reconstruction_option(...)`: parse highlight reconstruction toggle [`src/dng2jpg/dng2jpg.py`]
          - `print_error(...)`: emit parse diagnostics [`src/shell_scripts/utils.py`]
        - `_parse_auto_levels_highlight_reconstruction_method(...)`: parse highlight reconstruction method selector [`src/dng2jpg/dng2jpg.py`]
          - `print_error(...)`: emit parse diagnostics [`src/shell_scripts/utils.py`]
      ...
      - `_encode_jpg(...)`: encode merged TIFF into final JPG with configured postprocess stages [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_apply_auto_levels_rgb_uint16(...)`: apply clip-based auto-level normalization and optional highlight reconstruction [`src/dng2jpg/dng2jpg.py`]
          - `_to_linear_srgb(...)`: convert sRGB tensor to linear RGB [`src/dng2jpg/dng2jpg.py`]
          - `_clamp01(...)`: clamp float tensor into `[0,1]` [`src/dng2jpg/dng2jpg.py`]
          - `_reconstruct_highlights_luminance(...)`: reconstruct clipped highlights using luminance-preserving scaling [`src/dng2jpg/dng2jpg.py`]
            - `_compute_bt709_luminance(...)`: compute BT.709 luminance channel [`src/dng2jpg/dng2jpg.py`]
          - `_reconstruct_highlights_cielab_blending(...)`: reconstruct clipped highlights using CIELab chroma attenuation [`src/dng2jpg/dng2jpg.py`]
            - `_from_linear_srgb(...)`: convert linear RGB tensor to sRGB [`src/dng2jpg/dng2jpg.py`]
            - `_to_linear_srgb(...)`: convert sRGB tensor to linear RGB [`src/dng2jpg/dng2jpg.py`]
            - `_clamp01(...)`: clamp float tensor into `[0,1]` [`src/dng2jpg/dng2jpg.py`]
          - `_reconstruct_highlights_blend(...)`: reconstruct clipped highlights using neighborhood blending [`src/dng2jpg/dng2jpg.py`]
          - `_from_linear_srgb(...)`: convert linear RGB tensor to sRGB [`src/dng2jpg/dng2jpg.py`]
