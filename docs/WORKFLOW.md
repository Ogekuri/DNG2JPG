  ...
  - `main(...)`: parse top-level argv and dispatch management/conversion branches [`src/dng2jpg/core.py`]
    ...
    - `run(...)`: execute conversion pipeline [`src/dng2jpg/dng2jpg.py`]
      ...
      - `_encode_jpg(...)`: encode merged RGB float into final JPG with float stage interfaces and one final quantization [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_apply_auto_levels_float(...)`: apply auto-levels histogram stage and optional highlight reconstruction on RGB float [`src/dng2jpg/dng2jpg.py`]
        - `_build_autoexp_histogram_rgb_float(...)`: build BT.709 luminance histogram from normalized RGB float input [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_hlrecovery_luminance_uint16(...)`: execute Luminance Recovery highlight reconstruction method [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_hlrecovery_color_propagation_uint16(...)`: execute Color Propagation highlight reconstruction method [`src/dng2jpg/dng2jpg.py`]
          - `_box_mean_3x3_uint16(...)`: compute deterministic `3x3` neighborhood means for RGB-space recovery [`src/dng2jpg/dng2jpg.py`]
          - `_dilate_mask_uint16(...)`: expand clipped-pixel masks by one pixel [`src/dng2jpg/dng2jpg.py`]
        - `_hlrecovery_inpaint_opposed_uint16(...)`: execute Inpaint Opposed highlight reconstruction method [`src/dng2jpg/dng2jpg.py`]
          - `_box_mean_3x3_uint16(...)`: compute deterministic `3x3` neighborhood means for RGB-space recovery [`src/dng2jpg/dng2jpg.py`]
          - `_dilate_mask_uint16(...)`: expand clipped-pixel masks by one pixel [`src/dng2jpg/dng2jpg.py`]
        - `_clip_auto_levels_out_of_gamut_uint16(...)`: normalize overflowing RGB triplets back into uint16 gamut [`src/dng2jpg/dng2jpg.py`]
