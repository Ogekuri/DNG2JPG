  ...
  - `main(...)`: parse top-level argv and dispatch management/conversion branches [`src/dng2jpg/core.py`]
    ...
    - `run(...)`: execute conversion pipeline [`src/dng2jpg/dng2jpg.py`]
      ...
      - `_run_hdr_plus_merge(...)`: merge bracket images through HDR+ temporal/spatial tile backend [`src/dng2jpg/dng2jpg.py`]
        - `_order_hdr_plus_reference_paths(...)`: reorder bracket files into reference-first HDR+ frame order [`src/dng2jpg/dng2jpg.py`]
          - `_order_bracket_paths(...)`: enforce canonical bracket filenames before HDR+ reordering [`src/dng2jpg/dng2jpg.py`]
        - `_normalize_uint16_rgb_image(...)`: normalize bracket payloads into RGB uint16 tensors [`src/dng2jpg/dng2jpg.py`]
      ...
      - `_encode_jpg(...)`: encode merged TIFF into final JPG with uint16 static postprocess and single final quantization [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_apply_auto_brightness_rgb_uint16(...)`: apply original BT.709 key-adaptive photographic auto-brightness on uint16 RGB [`src/dng2jpg/dng2jpg.py`]
        ...
        - `_apply_auto_levels_uint16(...)`: apply auto-levels histogram stage and optional highlight reconstruction [`src/dng2jpg/dng2jpg.py`]
          - `_build_autoexp_histogram_rgb_uint16(...)`: build BT.709 luminance histogram for auto-levels [`src/dng2jpg/dng2jpg.py`]
