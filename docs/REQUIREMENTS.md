...
| TST-060 | `tests/test_uint16_postprocess_pipeline.py::test_parse_run_options_accepts_white_balance_modes_and_analysis_source_defaults`; verifies accepted mode/source sets and default stage-disabled plus `ev-zero` analysis source behavior. |
