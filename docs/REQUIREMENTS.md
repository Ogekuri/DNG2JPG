...
- **REQ-172**: MUST print normalized EXIF merge-gamma inputs containing `ColorSpace`, `InteroperabilityIndex`, `ImageModel`, and `ImageMake` values whenever `--gamma=auto` is resolved from RAW/DNG metadata.
