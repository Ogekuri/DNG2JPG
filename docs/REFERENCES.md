...
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L194)
...
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.0` (L200)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.3` (L201)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L202)
