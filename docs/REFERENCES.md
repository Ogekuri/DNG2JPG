...
# dng2jpg.py | Python | 14576L | 461 symbols | 33 imports | 303 comments
...
- var `WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO = "ev-zero"` (L138)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE = "linear-base"` (L139)
- var `XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE = 99.5` (L140)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START = 0.95` (L141)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH = 0.2` (L142)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L143)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L144)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L145)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L146)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L147)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L148)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L149)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L150)
- var `DEFAULT_REINHARD02_CONTRAST = 0.9` (L151)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L152)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.9` (L153)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L154)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L155)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L156)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.9` (L157)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L158)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.2` (L159)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L160)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L161)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.2` (L162)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L163)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.0` (L164)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L165)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L166)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.4` (L167)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L168)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.0` (L169)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L170)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L171)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L172)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.4` (L173)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L174)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L175)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_DEBEVEC_POST_GAMMA` (L176)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS` (L177)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_DEBEVEC_CONTRAST` (L178)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_DEBEVEC_SATURATION` (L179)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_DEBEVEC` (L180)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L181)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA` (L182)
- var `DEFAULT_OPENCV_TONEMAP_MAP = OPENCV_TONEMAP_MAP_REINHARD` (L183)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L184)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L185)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L186)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L187)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L188)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L189)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L190)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA = 1.0` (L191)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS = 1.0` (L192)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST = 1.4` (L193)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 0.6` (L194)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA = 1.0` (L195)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS = 1.0` (L196)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST = 1.0` (L197)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION = 1.0` (L198)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA = 0.9` (L199)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.2` (L200)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.4` (L201)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 0.5` (L202)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L203)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L204)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L205)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L206)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L207)
- var `HDRPLUS_TILE_SIZE = 32` (L208)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L209)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L210)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L211)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L212)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L213)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L214)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L215)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L217)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L482-517)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L519-547)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L549-572)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L574-592)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L594-612)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L614-639)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L641-662)
...
### class `class OpenCvTonemapOptions` `@dataclass(frozen=True)` (L664-693)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L695-793)
...
- fn `def auto_white_balance_mode(self) -> str | None` (L755-766)
...
- fn `def auto_white_balance_analysis_source(self) -> str` (L768-779)
...
- fn `def auto_white_balance_xphoto_domain(self) -> str` (L781-793)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L795-811)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L813-831)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L833-854)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L856-877)
...
### class `class OpenCvRadiancePathAdapters` `@dataclass(frozen=True)` (L879-900)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L902-925)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L927-946)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L948-968)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L970-987)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L989-1006)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L1008-1026)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L1027-1063)
...
### fn `def _border(left, middle, right)` `priv` (L1047-1049)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L1050-1053)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L1064-1080)
...
### fn `def _print_help_section(title)` `priv` (L1081-1095)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L1096-1137)
...
### fn `def print_help(version)` (L1138-1337)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1608-1625)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1626-1671)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1672-1684)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1685-1712)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1713-1740)
...
### fn `def _is_forced_static_auto_bracketing_selected(args)` `priv` (L1741-1762)
...
### fn `def _print_forced_static_auto_bracketing_diagnostics(ev_delta)` `priv` (L1763-1779)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1780-1802)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1803-1822)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1823-1842)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1843-1863)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1864-1888)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1889-1910)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1911-1963)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1964-1966)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2139-2210)
...
### fn `def _percentile(percentile_value)` `priv` (L2175-2185)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _normalize_percentile(stat_name, stat_value)` `priv` (L2196-2204)

### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2211-2243)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2244-2273)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2274-2277)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2324-2347)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2348-2388)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2389-2446)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2447-2450)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2498-2516)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2517-2548)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2549-2598)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2599-2647)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2648-2668)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2669-2699)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2700-2727)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2728-2749)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2750-2770)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2771-2796)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2797-2815)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2816-2861)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2862-2888)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2889-2988)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2989-3027)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L3028-3056)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L3057-3061)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L3091-3108)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L3109-3126)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L3127-3131)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3219-3236)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3237-3240)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3297-3317)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3318-3344)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3345-3368)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3369-3390)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3391-3414)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3415-3490)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3491-3507)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3508-3530)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3531-3555)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3556-3578)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3579-3604)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3605-3636)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3637-3733)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3734-3765)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3766-3838)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3839-3988)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3989-4007)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L4008-4084)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4085-4141)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4142-4175)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4176-4199)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4200-4227)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4228-4259)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4260-4272)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4273-4302)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4303-4329)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4330-4360)
...
### fn `def _resolve_default_postprocess(` `priv` (L4361-4365)

### fn `def _parse_gamma_option(option_value)` `priv` (L4474-4512)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4513-4532)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4533-4584)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4585-4653)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4654-4700)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4701-4760)
...
### fn `def _format_gamma_number(value)` `priv` (L4712-4725)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4761-4803)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4804-4835)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4836-4865)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4866-4922)
...
### fn `def _parse_run_options(args)` `priv` (L4923-5122)
...
### fn `def _load_image_dependencies()` `priv` (L5590-5627)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5628-5658)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5659-5721)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5722-5816)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5766-5783)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5817-5848)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5849-5871)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5872-5873)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5904-5946)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5947-6085)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L6086-6092)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L6142-6156)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L6157-6174)
...
### fn `def _safe_pow2_ev(exponent, context)` `priv` (L6175-6212)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6213-6241)
...
### fn `def _clip_bracket_rgb_unit_interval(np_module, image_rgb_float)` `priv` (L6242-6265)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6266-6295)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6296-6299)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6325-6354)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6355-6401)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6402-6405)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6437-6476)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6477-6479)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6510-6512)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6539-6541)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6582-6586)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6622-6628)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6699-6721)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6722-6724)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6767-6770)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6805-6820)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6821-6828)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6916-6919)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6954-6985)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6986-6989)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L7015-7018)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L7040-7048)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L7145-7152)

### fn `def _extract_bracket_images_float(` `priv` (L7238-7244)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7299-7324)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7325-7340)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7341-7356)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7357-7364)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7440-7443)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7491-7510)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7511-7542)
...
### fn `def _rescale_mertens_fusion_to_display_range(np_module, fusion_rgb_float)` `priv` (L7543-7564)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7565-7570)

### fn `def _adapt_opencv_radiance_input_high_precision(np_module, image_rgb_float)` `priv` (L7603-7622)
...
### fn `def _estimate_opencv_camera_response_high_precision(` `priv` (L7623-7627)

### fn `def _estimate_opencv_camera_response_uint8_legacy(` `priv` (L7648-7652)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L7679-7684)
...
### fn `def _merge_opencv_radiance_high_precision(` `priv` (L7710-7715)
...
### fn `def _merge_opencv_radiance_uint8_legacy(` `priv` (L7748-7753)
...
### fn `def _probe_opencv_high_precision_radiance_support(` `priv` (L7787-7790)
...
### fn `def _select_opencv_radiance_path_adapters(` `priv` (L7829-7832)
...
### fn `def _print_opencv_radiance_path_diagnostic(path_label)` `priv` (L7866-7880)
...
### fn `def _quantize_opencv_radiance_rgb_uint8(np_module, image_rgb_float)` `priv` (L7881-7902)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7903-7910)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7971-7990)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7991-7996)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L8076-8089)
...
### fn `def _run_opencv_merge_backend(` `priv` (L8090-8098)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L8195-8223)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L8224-8270)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L8271-8304)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L8305-8325)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L8326-8344)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L8345-8369)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L8370-8388)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L8389-8394)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L8447-8453)

### fn `def _hdrplus_align_layer(` `priv` (L8526-8533)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L8623-8710)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L8711-8735)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8736-8740)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8821-8827)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8876-8948)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8949-8954)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L9050-9060)
...
### fn `def _collect_missing_external_executables(` `priv` (L9061-9063)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L9082-9111)
...
### fn `def _resolve_numpy_dependency()` `priv` (L9112-9131)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L9132-9172)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L9173-9191)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L9192-9219)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L9220-9247)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L9248-9274)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L9275-9299)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L9300-9305)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L9335-9355)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L9356-9361)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L9420-9437)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L9438-9442)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L9472-9522)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L9523-9571)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L9572-9600)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L9601-9622)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L9623-9653)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L9654-9714)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L9715-9737)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9738-9762)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9763-9793)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9794-9799)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9918-9935)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9936-9953)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9954-9974)
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9975-9990)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9991-10043)
...
### fn `def _should_use_low_variance_auto_brightness_fallback(` `priv` (L10044-10048)

### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L10102-10147)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L10148-10153)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L10244-10271)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L10272-10310)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L10311-10341)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L10342-10363)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L10364-10411)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L10412-10431)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L10432-10470)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L10471-10498)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L10499-10550)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L10551-10603)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L10604-10643)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L10644-10667)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L10668-10731)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L10732-10751)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L10752-10772)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L10773-10789)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L10790-10805)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L10806-10822)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10823-10838)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10839-10854)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10906-10947)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10948-10980)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10981-11180)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L11339-11431)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L11352-11368)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L11369-11371)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L11372-11391)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L11392-11394)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L11395-11406)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L11432-11565)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L11566-11572)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L11604-11641)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L11642-11672)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L11673-11694)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L11695-11709)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L11710-11909)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11940-11943)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L12027-12050)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L12051-12056)

### fn `def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)` `priv` (L12100-12127)
...
### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L12128-12242)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L12243-12403)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L12273-12306)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L12404-12405)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L12435-12481)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L12482-12510)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L12511-12512)

### fn `def _f_lab(values)` `priv` (L12547-12554)
...
### fn `def _f2xyz(values)` `priv` (L12555-12561)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L12597-12598)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L12632-12737)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L12738-12739)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L12774-12796)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L12797-12820)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L12821-12865)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12866-12867)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12897-12898)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12951-12952)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12994-12997)
...
### fn `def _clamp01(np_module, values)` `priv` (L13055-13068)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L13069-13091)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L13092-13125)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L13126-13156)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L13157-13197)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L13198-13199)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L13256-13286)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L13287-13318)
...
### fn `def logistic(z_values)` (L13309-13311)
- @brief Execute sigmoidal contrast stage on display-referred RGB.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L13319-13344)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L13345-13368)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L13369-13392)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L13393-13414)
...
### fn `def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)` `priv` (L13415-13442)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L13443-13449)

### fn `def _apply_auto_adjust_stage_float(` `priv` (L13572-13578)
...
### fn `def _load_piexif_dependency()` `priv` (L13624-13641)
...
### fn `def _clip_postprocess_exit_rgb(np_module, image_rgb_float)` `priv` (L13642-13664)
...
### fn `def _postprocess(` `priv` (L13665-13673)

### fn `def _quantize_final_rgb_uint8(np_module, image_rgb_float)` `priv` (L13797-13823)
...
### fn `def _encode_jpg(` `priv` (L13824-13832)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L13891-13925)
...
### fn `def _is_supported_runtime_os()` `priv` (L13926-13945)
...
### fn `def _print_validated_run_parameters(` `priv` (L13946-13961)

### fn `def run(args)` (L14139-14338)
...
|`WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO`|var|pub|138||
|`WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE`|var|pub|139||
|`XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE`|var|pub|140||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START`|var|pub|141||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH`|var|pub|142||
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|143||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|144||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|145||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|146||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|147||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|148||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|149||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|150||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|151||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|152||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|153||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|154||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|155||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|156||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|157||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|158||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|159||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|160||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|161||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|162||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|163||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|164||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|165||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|166||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|167||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|168||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|169||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|170||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|171||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|172||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|173||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|174||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|175||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|176||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|177||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|178||
|`DEFAULT_OPENCV_SATURATION`|var|pub|179||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|180||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|181||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|182||
|`DEFAULT_OPENCV_TONEMAP_MAP`|var|pub|183||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|184||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|185||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|186||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|187||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|188||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|189||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|190||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA`|var|pub|191||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS`|var|pub|192||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST`|var|pub|193||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|194||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA`|var|pub|195||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS`|var|pub|196||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST`|var|pub|197||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION`|var|pub|198||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA`|var|pub|199||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS`|var|pub|200||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST`|var|pub|201||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|202||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|203||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|204||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|205||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|206||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|207||
|`HDRPLUS_TILE_SIZE`|var|pub|208||
|`HDRPLUS_TILE_STRIDE`|var|pub|209||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|210||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|211||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|212||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|213||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|214||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|215||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|217||
|`AutoAdjustOptions`|class|pub|482-517|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|519-547|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|549-572|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|574-592|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|594-612|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|614-639|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|641-662|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|664-693|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|695-793|class PostprocessOptions|
|`PostprocessOptions.auto_white_balance_mode`|fn|pub|755-766|def auto_white_balance_mode(self) -> str | None|
|`PostprocessOptions.auto_white_balance_analysis_source`|fn|pub|768-779|def auto_white_balance_analysis_source(self) -> str|
|`PostprocessOptions.auto_white_balance_xphoto_domain`|fn|pub|781-793|def auto_white_balance_xphoto_domain(self) -> str|
|`DebugArtifactContext`|class|pub|795-811|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|813-831|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|833-854|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|856-877|class OpenCvMergeOptions|
|`OpenCvRadiancePathAdapters`|class|pub|879-900|class OpenCvRadiancePathAdapters|
|`HdrPlusOptions`|class|pub|902-925|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|927-946|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|948-968|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|970-987|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|989-1006|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|1008-1026|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|1027-1063|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|1047-1049|def _border(left, middle, right)|
|`_line`|fn|priv|1050-1053|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|1064-1080|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|1081-1095|def _print_help_section(title)|
|`_print_help_option`|fn|priv|1096-1137|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1138-1337|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1608-1625|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1626-1671|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1672-1684|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1685-1712|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1713-1740|def _parse_ev_center_option(ev_center_raw)|
|`_is_forced_static_auto_bracketing_selected`|fn|priv|1741-1762|def _is_forced_static_auto_bracketing_selected(args)|
|`_print_forced_static_auto_bracketing_diagnostics`|fn|priv|1763-1779|def _print_forced_static_auto_bracketing_diagnostics(ev_d...|
|`_parse_percentage_option`|fn|priv|1780-1802|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1803-1822|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1823-1842|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1843-1863|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1864-1888|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1889-1910|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1911-1963|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1964-1966|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2139-2210|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2175-2185|def _percentile(percentile_value)|
|`_normalize_percentile`|fn|priv|2196-2204|def _normalize_percentile(stat_name, stat_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2211-2243|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2244-2273|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2274-2277|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2324-2347|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2348-2388|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2389-2446|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2447-2450|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2498-2516|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2517-2548|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2549-2598|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2599-2647|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2648-2668|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2669-2699|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2700-2727|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2728-2749|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2750-2770|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2771-2796|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2797-2815|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2816-2861|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2862-2888|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2889-2988|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2989-3027|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|3028-3056|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|3057-3061|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|3091-3108|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|3109-3126|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|3127-3131|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3219-3236|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3237-3240|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3297-3317|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3318-3344|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3345-3368|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3369-3390|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3391-3414|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3415-3490|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3491-3507|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3508-3530|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3531-3555|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3556-3578|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3579-3604|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3605-3636|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3637-3733|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3734-3765|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3766-3838|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3839-3988|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3989-4007|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|4008-4084|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|4085-4141|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4142-4175|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4176-4199|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4200-4227|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4228-4259|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4260-4272|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4273-4302|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4303-4329|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4330-4360|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4361-4365|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4474-4512|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4513-4532|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4533-4584|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4585-4653|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4654-4700|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4701-4760|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4712-4725|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4761-4803|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4804-4835|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4836-4865|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4866-4922|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4923-5122|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5590-5627|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5628-5658|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5659-5721|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5722-5816|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5766-5783|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5817-5848|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5849-5871|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5872-5873|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5904-5946|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5947-6085|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|6086-6092|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|6142-6156|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|6157-6174|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_safe_pow2_ev`|fn|priv|6175-6212|def _safe_pow2_ev(exponent, context)|
|`_build_exposure_multipliers`|fn|priv|6213-6241|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_clip_bracket_rgb_unit_interval`|fn|priv|6242-6265|def _clip_bracket_rgb_unit_interval(np_module, image_rgb_...|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6266-6295|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6296-6299|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6325-6354|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6355-6401|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6402-6405|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6437-6476|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6477-6479|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6510-6512|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6539-6541|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6582-6586|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6622-6628|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6699-6721|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6722-6724|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6767-6770|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6805-6820|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6821-6828|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6916-6919|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6954-6985|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6986-6989|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|7015-7018|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|7040-7048|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|7145-7152|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|7238-7244|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7299-7324|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7325-7340|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7341-7356|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7357-7364|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7440-7443|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7491-7510|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7511-7542|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_rescale_mertens_fusion_to_display_range`|fn|priv|7543-7564|def _rescale_mertens_fusion_to_display_range(np_module, f...|
|`_run_opencv_merge_mertens`|fn|priv|7565-7570|def _run_opencv_merge_mertens(|
|`_adapt_opencv_radiance_input_high_precision`|fn|priv|7603-7622|def _adapt_opencv_radiance_input_high_precision(np_module...|
|`_estimate_opencv_camera_response_high_precision`|fn|priv|7623-7627|def _estimate_opencv_camera_response_high_precision(|
|`_estimate_opencv_camera_response_uint8_legacy`|fn|priv|7648-7652|def _estimate_opencv_camera_response_uint8_legacy(|
|`_estimate_opencv_camera_response`|fn|priv|7679-7684|def _estimate_opencv_camera_response(|
|`_merge_opencv_radiance_high_precision`|fn|priv|7710-7715|def _merge_opencv_radiance_high_precision(|
|`_merge_opencv_radiance_uint8_legacy`|fn|priv|7748-7753|def _merge_opencv_radiance_uint8_legacy(|
|`_probe_opencv_high_precision_radiance_support`|fn|priv|7787-7790|def _probe_opencv_high_precision_radiance_support(|
|`_select_opencv_radiance_path_adapters`|fn|priv|7829-7832|def _select_opencv_radiance_path_adapters(|
|`_print_opencv_radiance_path_diagnostic`|fn|priv|7866-7880|def _print_opencv_radiance_path_diagnostic(path_label)|
|`_quantize_opencv_radiance_rgb_uint8`|fn|priv|7881-7902|def _quantize_opencv_radiance_rgb_uint8(np_module, image_...|
|`_run_opencv_merge_radiance`|fn|priv|7903-7910|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7971-7990|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7991-7996|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|8076-8089|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|8090-8098|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|8195-8223|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|8224-8270|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|8271-8304|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|8305-8325|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|8326-8344|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|8345-8369|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|8370-8388|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|8389-8394|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|8447-8453|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|8526-8533|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|8623-8710|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|8711-8735|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8736-8740|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8821-8827|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8876-8948|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8949-8954|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|9050-9060|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|9061-9063|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|9082-9111|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|9112-9131|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|9132-9172|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|9173-9191|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|9192-9219|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|9220-9247|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|9248-9274|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|9275-9299|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|9300-9305|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|9335-9355|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|9356-9361|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|9420-9437|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|9438-9442|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|9472-9522|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|9523-9571|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|9572-9600|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|9601-9622|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|9623-9653|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|9654-9714|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|9715-9737|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9738-9762|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9763-9793|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9794-9799|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9918-9935|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9936-9953|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9954-9974|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9975-9990|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9991-10043|def _analyze_luminance_key(np_module, luminance, eps)|
|`_should_use_low_variance_auto_brightness_fallback`|fn|priv|10044-10048|def _should_use_low_variance_auto_brightness_fallback(|
|`_choose_auto_key_value`|fn|priv|10102-10147|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|10148-10153|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|10244-10271|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|10272-10310|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|10311-10341|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|10342-10363|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|10364-10411|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|10412-10431|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|10432-10470|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|10471-10498|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|10499-10550|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|10551-10603|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|10604-10643|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|10644-10667|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|10668-10731|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|10732-10751|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|10752-10772|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|10773-10789|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|10790-10805|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|10806-10822|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10823-10838|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10839-10854|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10906-10947|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10948-10980|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10981-11180|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|11339-11431|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|11352-11368|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|11369-11371|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|11372-11391|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|11392-11394|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|11395-11406|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|11432-11565|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|11566-11572|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|11604-11641|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|11642-11672|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|11673-11694|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|11695-11709|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|11710-11909|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11940-11943|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|12027-12050|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|12051-12056|def _call_auto_levels_compat_helper(|
|`_clip_auto_levels_entry_rgb`|fn|priv|12100-12127|def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)|
|`_apply_auto_levels_float`|fn|priv|12128-12242|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|12243-12403|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|12273-12306|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|12404-12405|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|12435-12481|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|12482-12510|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|12511-12512|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|12547-12554|def _f_lab(values)|
|`_f2xyz`|fn|priv|12555-12561|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|12597-12598|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|12632-12737|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|12738-12739|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|12774-12796|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|12797-12820|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|12821-12865|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12866-12867|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12897-12898|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12951-12952|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12994-12997|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|13055-13068|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|13069-13091|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|13092-13125|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|13126-13156|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|13157-13197|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|13198-13199|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|13256-13286|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|13287-13318|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|13309-13311|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|13319-13344|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|13345-13368|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|13369-13392|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|13393-13414|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_clip_auto_adjust_stage_rgb`|fn|priv|13415-13442|def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|13443-13449|def _apply_validated_auto_adjust_pipeline(|
|`_apply_auto_adjust_stage_float`|fn|priv|13572-13578|def _apply_auto_adjust_stage_float(|
|`_load_piexif_dependency`|fn|priv|13624-13641|def _load_piexif_dependency()|
|`_clip_postprocess_exit_rgb`|fn|priv|13642-13664|def _clip_postprocess_exit_rgb(np_module, image_rgb_float)|
|`_postprocess`|fn|priv|13665-13673|def _postprocess(|
|`_quantize_final_rgb_uint8`|fn|priv|13797-13823|def _quantize_final_rgb_uint8(np_module, image_rgb_float)|
|`_encode_jpg`|fn|priv|13824-13832|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|13891-13925|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|13926-13945|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|13946-13961|def _print_validated_run_parameters(|
|`run`|fn|pub|14139-14338|def run(args)|
