...
# dng2jpg.py | Python | 14308L | 452 symbols | 32 imports | 294 comments
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2472-2490)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2491-2522)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2523-2572)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2573-2621)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2622-2642)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2643-2673)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2674-2701)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2702-2723)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2724-2744)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2745-2770)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2771-2789)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2790-2835)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2836-2862)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2863-2962)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2963-3001)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L3002-3030)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L3031-3035)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L3065-3082)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L3083-3100)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L3101-3105)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3193-3210)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3211-3214)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3271-3291)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3292-3318)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3319-3342)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3343-3364)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3365-3388)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3389-3464)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3465-3481)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3482-3504)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3505-3529)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3530-3552)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3553-3578)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3579-3610)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3611-3707)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3708-3739)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3740-3812)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3813-3962)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3963-3981)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3982-4058)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4059-4115)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4116-4149)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4150-4173)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4174-4201)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4202-4233)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4234-4246)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4247-4276)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4277-4303)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4304-4334)
...
### fn `def _resolve_default_postprocess(` `priv` (L4335-4339)

### fn `def _parse_gamma_option(option_value)` `priv` (L4448-4486)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4487-4506)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4507-4558)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4559-4627)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4628-4674)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4675-4734)
...
### fn `def _format_gamma_number(value)` `priv` (L4686-4699)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4735-4777)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4778-4809)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4810-4839)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4840-4896)
...
### fn `def _parse_run_options(args)` `priv` (L4897-5096)
...
### fn `def _load_image_dependencies()` `priv` (L5564-5601)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5602-5632)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5633-5695)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5696-5790)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5740-5757)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5791-5822)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5823-5845)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5846-5847)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5878-5920)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5921-6059)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L6060-6066)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L6116-6130)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L6131-6148)
...
### fn `def _safe_pow2_ev(exponent, context)` `priv` (L6149-6186)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6187-6215)
...
### fn `def _clip_bracket_rgb_unit_interval(np_module, image_rgb_float)` `priv` (L6216-6239)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6240-6269)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6270-6273)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6299-6328)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6329-6375)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6376-6379)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6411-6450)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6451-6453)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6484-6486)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6513-6515)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6556-6560)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6596-6602)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6673-6695)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6696-6698)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6741-6744)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6779-6794)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6795-6802)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6890-6893)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6928-6959)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6960-6963)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6989-6992)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L7014-7022)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L7119-7126)

### fn `def _extract_bracket_images_float(` `priv` (L7212-7218)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7273-7298)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7299-7314)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7315-7330)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7331-7338)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7414-7417)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7465-7484)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7485-7514)
...
### fn `def _rescale_mertens_fusion_to_display_range(np_module, fusion_rgb_float)` `priv` (L7515-7536)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7537-7542)

### fn `def _estimate_opencv_camera_response(` `priv` (L7575-7579)
...
### fn `def _quantize_opencv_radiance_rgb_uint8(np_module, image_rgb_float)` `priv` (L7608-7630)
...
- @details Converts one camera-linear RGB float bracket to `uint8` using the repository byte-quantization helper. Scope is restricted to the OpenCV Debevec/Robertson radiance path where calibrator and merge APIs require `CV_8U` payloads. Complexity: O(H*W). Side effects: none.
- @param cv2_module {ModuleType} Imported OpenCV module.
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7631-7638)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7703-7722)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7723-7728)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L7808-7821)
...
### fn `def _run_opencv_merge_backend(` `priv` (L7822-7830)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L7927-7955)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L7956-8002)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L8003-8036)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L8037-8057)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L8058-8076)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L8077-8101)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L8102-8120)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L8121-8126)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L8179-8185)

### fn `def _hdrplus_align_layer(` `priv` (L8258-8265)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L8355-8442)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L8443-8467)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8468-8472)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8553-8559)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8608-8680)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8681-8686)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8782-8792)
...
### fn `def _collect_missing_external_executables(` `priv` (L8793-8795)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L8814-8843)
...
### fn `def _resolve_numpy_dependency()` `priv` (L8844-8863)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L8864-8904)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L8905-8923)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L8924-8951)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L8952-8979)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8980-9006)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L9007-9031)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L9032-9037)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L9067-9087)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L9088-9093)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L9152-9169)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L9170-9174)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L9204-9254)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L9255-9303)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L9304-9332)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L9333-9354)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L9355-9385)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L9386-9446)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L9447-9469)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9470-9494)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9495-9525)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9526-9531)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9650-9667)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9668-9685)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9686-9706)
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9707-9722)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9723-9775)
...
### fn `def _should_use_low_variance_auto_brightness_fallback(` `priv` (L9776-9780)

### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L9834-9879)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L9880-9885)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L9976-10003)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L10004-10042)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L10043-10073)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L10074-10095)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L10096-10143)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L10144-10163)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L10164-10202)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L10203-10230)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L10231-10282)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L10283-10335)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L10336-10375)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L10376-10399)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L10400-10463)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L10464-10483)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L10484-10504)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L10505-10521)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L10522-10537)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L10538-10554)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10555-10570)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10571-10586)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10638-10679)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10680-10712)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10713-10912)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L11071-11163)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L11084-11100)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L11101-11103)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L11104-11123)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L11124-11126)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L11127-11138)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L11164-11297)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L11298-11304)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L11336-11373)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L11374-11404)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L11405-11426)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L11427-11441)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L11442-11641)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11672-11675)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L11759-11782)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L11783-11788)

### fn `def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)` `priv` (L11832-11859)
...
### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L11860-11974)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L11975-12135)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L12005-12038)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L12136-12137)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L12167-12213)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L12214-12242)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L12243-12244)

### fn `def _f_lab(values)` `priv` (L12279-12286)
...
### fn `def _f2xyz(values)` `priv` (L12287-12293)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L12329-12330)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L12364-12469)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L12470-12471)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L12506-12528)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L12529-12552)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L12553-12597)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12598-12599)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12629-12630)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12683-12684)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12726-12729)
...
### fn `def _clamp01(np_module, values)` `priv` (L12787-12800)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L12801-12823)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L12824-12857)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L12858-12888)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L12889-12929)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L12930-12931)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L12988-13018)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L13019-13050)
...
### fn `def logistic(z_values)` (L13041-13043)
- @brief Execute sigmoidal contrast stage on display-referred RGB.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L13051-13076)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L13077-13100)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L13101-13124)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L13125-13146)
...
### fn `def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)` `priv` (L13147-13174)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L13175-13181)

### fn `def _apply_auto_adjust_stage_float(` `priv` (L13304-13310)
...
### fn `def _load_piexif_dependency()` `priv` (L13356-13373)
...
### fn `def _clip_postprocess_exit_rgb(np_module, image_rgb_float)` `priv` (L13374-13396)
...
### fn `def _postprocess(` `priv` (L13397-13405)

### fn `def _quantize_final_rgb_uint8(np_module, image_rgb_float)` `priv` (L13529-13555)
...
### fn `def _encode_jpg(` `priv` (L13556-13564)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L13623-13657)
...
### fn `def _is_supported_runtime_os()` `priv` (L13658-13677)
...
### fn `def _print_validated_run_parameters(` `priv` (L13678-13693)

### fn `def run(args)` (L13871-14070)
...
|`_normalize_source_gamma_label`|fn|priv|2472-2490|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2491-2522|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2523-2572|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2573-2621|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2622-2642|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2643-2673|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2674-2701|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2702-2723|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2724-2744|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2745-2770|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2771-2789|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2790-2835|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2836-2862|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2863-2962|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2963-3001|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|3002-3030|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|3031-3035|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|3065-3082|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|3083-3100|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|3101-3105|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3193-3210|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3211-3214|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3271-3291|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3292-3318|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3319-3342|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3343-3364|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3365-3388|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3389-3464|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3465-3481|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3482-3504|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3505-3529|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3530-3552|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3553-3578|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3579-3610|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3611-3707|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3708-3739|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3740-3812|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3813-3962|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3963-3981|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3982-4058|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|4059-4115|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4116-4149|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4150-4173|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4174-4201|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4202-4233|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4234-4246|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4247-4276|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4277-4303|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4304-4334|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4335-4339|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4448-4486|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4487-4506|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4507-4558|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4559-4627|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4628-4674|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4675-4734|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4686-4699|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4735-4777|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4778-4809|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4810-4839|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4840-4896|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4897-5096|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5564-5601|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5602-5632|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5633-5695|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5696-5790|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5740-5757|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5791-5822|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5823-5845|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5846-5847|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5878-5920|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5921-6059|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|6060-6066|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|6116-6130|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|6131-6148|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_safe_pow2_ev`|fn|priv|6149-6186|def _safe_pow2_ev(exponent, context)|
|`_build_exposure_multipliers`|fn|priv|6187-6215|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_clip_bracket_rgb_unit_interval`|fn|priv|6216-6239|def _clip_bracket_rgb_unit_interval(np_module, image_rgb_...|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6240-6269|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6270-6273|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6299-6328|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6329-6375|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6376-6379|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6411-6450|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6451-6453|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6484-6486|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6513-6515|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6556-6560|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6596-6602|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6673-6695|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6696-6698|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6741-6744|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6779-6794|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6795-6802|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6890-6893|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6928-6959|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6960-6963|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|6989-6992|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|7014-7022|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|7119-7126|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|7212-7218|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7273-7298|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7299-7314|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7315-7330|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7331-7338|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7414-7417|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7465-7484|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7485-7514|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_rescale_mertens_fusion_to_display_range`|fn|priv|7515-7536|def _rescale_mertens_fusion_to_display_range(np_module, f...|
|`_run_opencv_merge_mertens`|fn|priv|7537-7542|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|7575-7579|def _estimate_opencv_camera_response(|
|`_quantize_opencv_radiance_rgb_uint8`|fn|priv|7608-7630|def _quantize_opencv_radiance_rgb_uint8(np_module, image_...|
|`_run_opencv_merge_radiance`|fn|priv|7631-7638|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7703-7722|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7723-7728|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|7808-7821|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|7822-7830|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|7927-7955|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|7956-8002|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|8003-8036|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|8037-8057|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|8058-8076|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|8077-8101|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|8102-8120|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|8121-8126|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|8179-8185|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|8258-8265|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|8355-8442|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|8443-8467|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8468-8472|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8553-8559|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8608-8680|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8681-8686|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|8782-8792|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|8793-8795|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|8814-8843|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|8844-8863|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|8864-8904|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|8905-8923|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|8924-8951|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|8952-8979|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|8980-9006|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|9007-9031|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|9032-9037|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|9067-9087|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|9088-9093|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|9152-9169|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|9170-9174|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|9204-9254|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|9255-9303|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|9304-9332|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|9333-9354|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|9355-9385|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|9386-9446|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|9447-9469|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9470-9494|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9495-9525|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9526-9531|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9650-9667|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9668-9685|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9686-9706|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9707-9722|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9723-9775|def _analyze_luminance_key(np_module, luminance, eps)|
|`_should_use_low_variance_auto_brightness_fallback`|fn|priv|9776-9780|def _should_use_low_variance_auto_brightness_fallback(|
|`_choose_auto_key_value`|fn|priv|9834-9879|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|9880-9885|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|9976-10003|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|10004-10042|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|10043-10073|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|10074-10095|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|10096-10143|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|10144-10163|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|10164-10202|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|10203-10230|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|10231-10282|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|10283-10335|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|10336-10375|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|10376-10399|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|10400-10463|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|10464-10483|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|10484-10504|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|10505-10521|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|10522-10537|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|10538-10554|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10555-10570|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10571-10586|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10638-10679|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10680-10712|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10713-10912|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|11071-11163|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|11084-11100|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|11101-11103|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|11104-11123|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|11124-11126|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|11127-11138|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|11164-11297|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|11298-11304|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|11336-11373|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|11374-11404|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|11405-11426|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|11427-11441|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|11442-11641|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11672-11675|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|11759-11782|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|11783-11788|def _call_auto_levels_compat_helper(|
|`_clip_auto_levels_entry_rgb`|fn|priv|11832-11859|def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)|
|`_apply_auto_levels_float`|fn|priv|11860-11974|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|11975-12135|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|12005-12038|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|12136-12137|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|12167-12213|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|12214-12242|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|12243-12244|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|12279-12286|def _f_lab(values)|
|`_f2xyz`|fn|priv|12287-12293|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|12329-12330|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|12364-12469|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|12470-12471|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|12506-12528|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|12529-12552|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|12553-12597|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12598-12599|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12629-12630|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12683-12684|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12726-12729|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|12787-12800|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|12801-12823|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|12824-12857|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|12858-12888|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|12889-12929|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|12930-12931|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|12988-13018|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|13019-13050|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|13041-13043|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|13051-13076|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|13077-13100|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|13101-13124|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|13125-13146|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_clip_auto_adjust_stage_rgb`|fn|priv|13147-13174|def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|13175-13181|def _apply_validated_auto_adjust_pipeline(|
|`_apply_auto_adjust_stage_float`|fn|priv|13304-13310|def _apply_auto_adjust_stage_float(|
|`_load_piexif_dependency`|fn|priv|13356-13373|def _load_piexif_dependency()|
|`_clip_postprocess_exit_rgb`|fn|priv|13374-13396|def _clip_postprocess_exit_rgb(np_module, image_rgb_float)|
|`_postprocess`|fn|priv|13397-13405|def _postprocess(|
|`_quantize_final_rgb_uint8`|fn|priv|13529-13555|def _quantize_final_rgb_uint8(np_module, image_rgb_float)|
|`_encode_jpg`|fn|priv|13556-13564|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|13623-13657|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|13658-13677|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|13678-13693|def _print_validated_run_parameters(|
|`run`|fn|pub|13871-14070|def run(args)|
