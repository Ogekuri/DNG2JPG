...
# dng2jpg.py | Python | 9070L | 283 symbols | 24 imports | 194 comments
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L627-645)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L1176-1204)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1205-1250)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1251-1264)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1265-1296)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1297-1327)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1328-1347)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1348-1367)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1368-1390)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1391-1410)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1411-1430)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1431-1451)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1452-1476)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1477-1523)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1524-1537)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1538-1559)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1560-1581)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1582-1596)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1686-1705)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1706-1728)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1729-1747)
...
### fn `def _calculate_entropy_optimized_ev(cv2_module, np_module, luminance_float)` `priv` (L1748-1793)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L1794-1813)
...
### fn `def _calculate_detail_preservation_ev(cv2_module, np_module, luminance_float)` `priv` (L1814-1880)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L1881-1918)
...
### fn `def _evaluate_auto_zero_exposure(cv2_module, np_module, image_rgb_float)` `priv` (L1919-1952)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1953-1982)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1983-1988)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L2016-2043)
...
### fn `def _resolve_ev_zero(` `priv` (L2044-2053)

### fn `def _resolve_ev_value(` `priv` (L2117-2124)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2177-2197)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L2198-2236)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2237-2260)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2261-2284)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2285-2301)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2302-2324)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2325-2349)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2350-2372)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2373-2398)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2399-2430)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2431-2527)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2528-2559)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2560-2623)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2624-2773)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2774-2792)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2793-2869)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2870-2893)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2894-2923)
...
### fn `def _resolve_default_postprocess(` `priv` (L2924-2927)

### fn `def _parse_run_options(args)` `priv` (L2999-3198)
...
### fn `def _load_image_dependencies()` `priv` (L3820-3857)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3858-3888)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3889-3946)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3947-3978)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3979-4001)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4002-4003)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4034-4076)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4077-4210)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4211-4217)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4267-4281)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4282-4299)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L4300-4318)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4389-4414)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4415-4430)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4431-4438)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4502-4531)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4532-4555)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L4556-4577)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L4578-4585)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4629-4648)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4649-4655)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4715-4743)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4744-4790)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4791-4824)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4825-4845)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4846-4864)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4865-4889)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4890-4908)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4909-4914)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4967-4973)

### fn `def _hdrplus_align_layer(` `priv` (L5046-5053)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5143-5230)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5231-5255)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5256-5260)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5341-5347)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5396-5468)
...
### fn `def _run_hdr_plus_merge(` `priv` (L5469-5472)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5549-5559)
...
### fn `def _collect_missing_external_executables(` `priv` (L5560-5562)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5581-5606)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5607-5626)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5627-5658)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5659-5686)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5687-5710)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L5711-5716)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L5746-5766)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L5767-5784)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5785-5789)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5819-5865)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5866-5910)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5911-5936)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5937-5959)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5960-5984)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5985-6014)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6015-6020)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6097-6114)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6115-6132)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6133-6150)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6151-6190)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6191-6236)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6237-6242)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6276-6303)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6304-6342)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6343-6368)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6369-6390)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6391-6438)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6439-6458)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L6459-6497)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L6498-6525)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L6526-6577)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L6578-6630)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6631-6662)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6663-6686)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6687-6736)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6737-6756)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6757-6777)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6778-6794)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6795-6810)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6811-6827)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6828-6843)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6844-6859)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L6911-6946)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L6947-6979)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L6980-7179)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L7253-7258)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L7302-7401)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L7402-7420)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L7421-7422)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L7452-7498)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L7499-7527)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L7528-7529)

### fn `def _f_lab(values)` `priv` (L7562-7569)
...
### fn `def _f2xyz(values)` `priv` (L7570-7576)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L7612-7613)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L7647-7752)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L7753-7754)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L7789-7811)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L7812-7835)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L7836-7880)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L7881-7882)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L7912-7913)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L7966-7967)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L8009-8012)
...
### fn `def _clamp01(np_module, values)` `priv` (L8069-8082)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L8083-8105)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L8106-8139)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L8140-8170)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L8171-8211)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L8212-8213)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L8262-8284)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L8285-8309)
...
### fn `def logistic(z_values)` (L8300-8302)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L8310-8327)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L8328-8351)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L8352-8375)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L8376-8397)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L8398-8404)

### fn `def _load_piexif_dependency()` `priv` (L8513-8530)
...
### fn `def _encode_jpg(` `priv` (L8531-8542)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L8674-8702)
...
### fn `def _is_supported_runtime_os()` `priv` (L8703-8722)
...
|`AutoZeroEvaluation`|class|pub|627-645|class AutoZeroEvaluation|
...
|`_derive_supported_ev_values`|fn|priv|1176-1204|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|1205-1250|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1251-1264|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1265-1296|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1297-1327|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1328-1347|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1348-1367|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1368-1390|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1391-1410|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1411-1430|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1431-1451|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1452-1476|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1477-1523|def _parse_opencv_options(opencv_raw_values)|
|`_clamp_ev_to_supported`|fn|priv|1524-1537|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1538-1559|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1560-1581|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1582-1596|def _apply_auto_percentage_scaling(ev_value, percentage)|
...
|`_coerce_positive_luminance`|fn|priv|1686-1705|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|1706-1728|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|1729-1747|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|1748-1793|def _calculate_entropy_optimized_ev(cv2_module, np_module...|
|`_calculate_ettr_ev`|fn|priv|1794-1813|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|1814-1880|def _calculate_detail_preservation_ev(cv2_module, np_modu...|
|`_calculate_auto_zero_evaluations`|fn|priv|1881-1918|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_evaluate_auto_zero_exposure`|fn|priv|1919-1952|def _evaluate_auto_zero_exposure(cv2_module, np_module, i...|
|`_optimize_adaptive_ev_delta`|fn|priv|1953-1982|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1983-1988|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|2016-2043|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`