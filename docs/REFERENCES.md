...
# dng2jpg.py | Python | 8321L | 269 symbols | 23 imports | 180 comments
...
### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3573-3615)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3616-3749)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L3750-3756)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L3806-3820)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L3821-3838)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L3839-3857)
...
### fn `def _extract_bracket_images_float(raw_handle, np_module, multipliers, gamma_value)` `priv` (L3858-3894)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L3895-3920)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L3921-3936)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L3937-3944)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4008-4037)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4038-4061)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_uint8)` `priv` (L4062-4081)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L4082-4089)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4140-4159)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4160-4165)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4225-4253)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4254-4300)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4301-4334)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4335-4355)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4356-4374)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4375-4399)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4400-4418)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4419-4424)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4477-4483)

### fn `def _hdrplus_align_layer(` `priv` (L4556-4563)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L4653-4740)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L4741-4765)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L4766-4770)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L4851-4857)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L4906-4978)
...
### fn `def _run_hdr_plus_merge(` `priv` (L4979-4982)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5059-5069)
...
### fn `def _collect_missing_external_executables(` `priv` (L5070-5072)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5091-5115)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5116-5135)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5136-5167)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5168-5195)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5196-5219)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5220-5224)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5254-5300)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5301-5345)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5346-5371)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5372-5394)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5395-5419)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5420-5449)
...
### fn `def _apply_static_postprocess_float(np_module, image_rgb_float, postprocess_options)` `priv` (L5450-5489)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L5490-5507)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L5508-5525)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L5526-5543)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L5544-5583)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L5584-5629)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L5630-5635)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L5669-5696)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L5697-5735)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L5736-5761)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L5762-5783)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L5784-5831)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L5832-5851)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L5852-5890)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L5891-5918)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L5919-5970)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L5971-6023)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6024-6055)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6056-6079)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6080-6129)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6130-6149)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6150-6170)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6171-6187)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6188-6203)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6204-6220)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6221-6236)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6237-6252)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L6304-6339)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L6340-6372)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L6373-6572)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L6646-6651)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L6695-6794)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L6795-6813)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L6814-6815)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L6845-6891)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L6892-6920)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L6921-6922)

### fn `def _f_lab(values)` `priv` (L6955-6962)
...
### fn `def _f2xyz(values)` `priv` (L6963-6969)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L7005-7006)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L7040-7145)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L7146-7147)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L7182-7204)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L7205-7228)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L7229-7273)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L7274-7275)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L7305-7306)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L7359-7360)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L7402-7405)
...
### fn `def _clamp01(np_module, values)` `priv` (L7462-7475)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L7476-7498)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L7499-7532)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L7533-7563)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L7564-7604)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L7605-7606)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L7655-7677)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L7678-7702)
...
### fn `def logistic(z_values)` (L7693-7695)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L7703-7720)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L7721-7744)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L7745-7768)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L7769-7790)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L7791-7795)

### fn `def _load_piexif_dependency()` `priv` (L7852-7869)
...
### fn `def _encode_jpg(` `priv` (L7870-7880)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L7978-8006)
...
### fn `def _is_supported_runtime_os()` `priv` (L8007-8026)
...
|`_coerce_exif_int_like_value`|fn|priv|3573-3615|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|3616-3749|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|3750-3756|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|3806-3820|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|3821-3838|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|3839-3857|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_extract_bracket_images_float`|fn|priv|3858-3894|def _extract_bracket_images_float(raw_handle, np_module, ...|
|`_order_bracket_paths`|fn|priv|3895-3920|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|3921-3936|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|3937-3944|def _run_luminance_hdr_cli(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|4008-4037|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|4038-4061|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|4062-4081|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_run_opencv_merge_radiance`|fn|priv|4082-4089|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|4140-4159|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|4160-4165|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|4225-4253|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4254-4300|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4301-4334|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4335-4355|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4356-4374|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|4375-4399|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|4400-4418|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|4419-4424|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|4477-4483|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|4556-4563|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|4653-4740|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|4741-4765|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|4766-4770|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|4851-4857|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|4906-4978|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|4979-4982|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|5059-5069|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|5070-5072|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|5091-5115|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|5116-5135|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|5136-5167|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|5168-5195|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|5196-5219|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_materialize_bracket_tiffs_from_float`|fn|priv|5220-5224|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5254-5300|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|5301-5345|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|5346-5371|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|5372-5394|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|5395-5419|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|5420-5449|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|5450-5489|def _apply_static_postprocess_float(np_module, image_rgb_...|
|`_to_linear_srgb`|fn|priv|5490-5507|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|5508-5525|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|5526-5543|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|5544-5583|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|5584-5629|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|5630-5635|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|5669-5696|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|5697-5735|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|5736-5761|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|5762-5783|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|5784-5831|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|5832-5851|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|5852-5890|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|5891-5918|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|5919-5970|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|5971-6023|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|6024-6055|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|6056-6079|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|6080-6129|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|6130-6149|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|6150-6170|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|6171-6187|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|6188-6203|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|6204-6220|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|6221-6236|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|6237-6252|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|6304-6339|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|6340-6372|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|6373-6572|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_call_auto_levels_compat_helper`|fn|priv|6646-6651|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|6695-6794|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|6795-6813|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|6814-6815|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|6845-6891|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|6892-6920|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|6921-6922|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|6955-6962|def _f_lab(values)|
|`_f2xyz`|fn|priv|6963-6969|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|7005-7006|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|7040-7145|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|7146-7147|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|7182-7204|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|7205-7228|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|7229-7273|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|7274-7275|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|7305-7306|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|7359-7360|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|7402-7405|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|7462-7475|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|7476-7498|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|7499-7532|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|7533-7563|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|7564-7604|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|7605-7606|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|7655-7677|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|7678-7702|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|7693-7695|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|7703-7720|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|7721-7744|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|7745-7768|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|7769-7790|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|7791-7795|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|7852-7869|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|7870-7880|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|7978-8006|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|8007-8026|def _is_supported_runtime_os()|
|`run`|fn|pub|8027-8226|def run(args)|
