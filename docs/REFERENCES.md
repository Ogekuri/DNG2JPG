...
# dng2jpg.py | Python | 12153L | 381 symbols | 30 imports | 254 comments
...
- var `WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO = "ev-zero"` (L123)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE = "linear-base"` (L124)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L125)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L126)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L127)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L128)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L129)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L130)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L131)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L132)
- var `DEFAULT_REINHARD02_CONTRAST = 0.75` (L133)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L134)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.8` (L135)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L136)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.1` (L137)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L138)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.8` (L139)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L140)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.0` (L141)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L142)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L143)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.0` (L144)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L145)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.05` (L146)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L147)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L148)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.0` (L149)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L150)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.05` (L151)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L152)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L153)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L154)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.3` (L155)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L156)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L157)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_ROBERTSON_POST_GAMMA` (L158)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS` (L159)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_ROBERTSON_CONTRAST` (L160)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_ROBERTSON_SATURATION` (L161)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_ROBERTSON` (L162)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L163)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA` (L164)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L165)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L166)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L167)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L168)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L169)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L170)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L171)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L172)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L173)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L174)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L175)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L176)
- var `HDRPLUS_TILE_SIZE = 32` (L177)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L178)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L179)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L180)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L181)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L182)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L183)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L184)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L186)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L439-474)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L476-504)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L506-529)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L531-549)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L551-569)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L571-596)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L598-619)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L652-703)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L705-721)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L723-741)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L743-764)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L766-786)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L788-811)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L813-832)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L834-854)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L856-873)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L875-892)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L894-912)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L913-949)
...
### fn `def _border(left, middle, right)` `priv` (L933-935)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L936-939)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L950-966)
...
### fn `def _print_help_section(title)` `priv` (L967-981)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L982-1023)
...
### fn `def print_help(version)` (L1024-1223)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1485-1502)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1503-1548)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1549-1561)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1562-1587)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1588-1612)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1613-1632)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1633-1655)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1656-1675)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1676-1695)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1696-1716)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1717-1741)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1742-1763)
- @brief Resolve OpenCV tone-map gamma default from merge algorithm.
- @details Maps `Debevec`, `Robertson`, and `Mertens` to deterministic default gamma values used when `--opencv-tonemap-gamma` is omitted. Unknown values fall back to the repository default merge algorithm profile.
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1764-1815)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1816-1818)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1979-2038)
...
### fn `def _percentile(percentile_value)` `priv` (L2013-2023)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2039-2071)
...
### fn `def _normalize_white_balance_gains_rgb(np_module, camera_wb_rgb)` `priv` (L2072-2097)
- @brief Normalize one RGB white-balance gain triplet relative to green.
- @details Converts one camera white-balance RGB triplet to float64, divides all channels by the green coefficient, and returns gains preserving camera chromatic ratios with green anchored to `1.0`. Invalid or non-positive green coefficients resolve to unit gains. Complexity: O(1). Side effects: none.
...
### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2098-2121)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2122-2162)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2163-2220)
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L2221-2256)
- @brief Extract one linear normalized RGB base image from one RAW handle.
- @details Executes exactly one neutral linear `rawpy.postprocess` call with deterministic no-auto/no-camera-WB parameters, converts output to float, normalizes by sensor dynamic range `white_level - mean(black_level_per_channel)`, extracts camera WB metadata gains, normalizes gains relative to green, and applies those gains in float domain without explicit clipping. Complexity: O(H*W). Side effects: one RAW postprocess invocation.
- @param raw_handle {Any} Opened RAW handle from `rawpy.imread`.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2257-2275)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2276-2307)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2308-2357)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2358-2406)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2407-2427)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2428-2458)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2459-2486)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2487-2508)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2509-2528)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2529-2551)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2552-2570)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2571-2616)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2617-2636)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2637-2704)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2705-2742)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2743-2771)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2772-2776)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2806-2823)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2824-2841)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2842-2845)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2931-2951)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L2952-2978)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2979-3002)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3003-3024)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3025-3048)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3049-3124)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3125-3141)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3142-3164)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3165-3189)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3190-3212)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3213-3238)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3239-3270)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3271-3367)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3368-3399)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3400-3472)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3473-3622)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3623-3641)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3642-3718)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3719-3772)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L3773-3796)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L3797-3825)
- @brief Parse white-balance mode selector option value.
- @details Accepts case-insensitive white-balance selector names and normalizes them to canonical runtime mode names.
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L3826-3855)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L3856-3886)
...
### fn `def _resolve_default_postprocess(` `priv` (L3887-3890)

### fn `def _parse_gamma_option(option_value)` `priv` (L3971-4009)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4010-4029)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4030-4081)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4082-4150)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4151-4197)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4198-4257)
...
### fn `def _format_gamma_number(value)` `priv` (L4209-4222)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4258-4300)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4301-4332)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4333-4362)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4363-4415)
...
### fn `def _load_image_dependencies()` `priv` (L5061-5098)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5099-5129)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5130-5192)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5193-5287)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5237-5254)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5288-5319)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5320-5342)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5343-5344)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5375-5417)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5418-5551)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5552-5558)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5608-5622)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5623-5640)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L5641-5659)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L5660-5689)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L5690-5693)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L5715-5742)
...
### fn `def _build_xphoto_analysis_image_rgb_float(np_module, analysis_image_rgb_float)` `priv` (L5743-5768)
- @brief Build deterministic real-image xphoto analysis payload.
- @details Converts one analysis image to RGB float, preserves values above `1.0`, replaces non-finite values with `0`, removes negatives, and applies deterministic pyramid downsampling (`::2`) until maximum side is `<=1024`. This removes fixed proxy-size assumptions while keeping xphoto estimation stable and bounded in memory.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L5769-5801)
- @brief Build robust white-balance mask excluding near-black and near-saturated pixels.
- @details Builds a deterministic per-pixel mask using finite and non-negative RGB values, excludes near-black pixels (`max_channel<=1e-3`), excludes near-saturated pixels (`max_channel>=0.995`), and applies fallback tiers to guarantee at least one valid pixel for downstream statistics.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L5802-5806)

### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L5863-5867)
...
### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L5915-5918)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L5953-5984)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L5985-5988)

### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6014-6018)
...
### fn `def _extract_bracket_images_float(` `priv` (L6098-6102)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L6136-6161)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L6162-6177)
...
### fn `def _format_external_command_for_log(command)` `priv` (L6178-6193)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L6194-6201)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L6277-6280)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L6314-6333)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L6334-6359)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L6360-6365)

### fn `def _estimate_opencv_camera_response(` `priv` (L6395-6399)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L6428-6435)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L6499-6518)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L6519-6523)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L6592-6605)
...
### fn `def _run_opencv_merge_backend(` `priv` (L6606-6613)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L6701-6729)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L6730-6776)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L6777-6810)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L6811-6831)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L6832-6850)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L6851-6875)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L6876-6894)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L6895-6900)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L6953-6959)

### fn `def _hdrplus_align_layer(` `priv` (L7032-7039)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L7129-7216)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L7217-7241)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L7242-7246)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L7327-7333)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L7382-7454)
...
### fn `def _run_hdr_plus_merge(` `priv` (L7455-7459)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L7547-7557)
...
### fn `def _collect_missing_external_executables(` `priv` (L7558-7560)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L7579-7608)
...
- @details Imports `cv2` and `numpy` modules required by the auto-adjust pipeline, the OpenCV HDR backend, white-balance stage execution, and the automatic EV-zero evaluation, and returns `None` with deterministic error output when dependencies are missing.
...
### fn `def _resolve_numpy_dependency()` `priv` (L7609-7628)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L7629-7660)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L7661-7688)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7689-7715)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7716-7740)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L7741-7746)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L7776-7796)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L7797-7814)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L7815-7819)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L7849-7895)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L7896-7940)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L7941-7966)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L7967-7983)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L7984-8010)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L8011-8055)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L8056-8078)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L8079-8103)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L8104-8134)
...
### fn `def _apply_static_postprocess_float(` `priv` (L8135-8140)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L8257-8274)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L8275-8292)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L8293-8310)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L8311-8350)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L8351-8396)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L8397-8402)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L8436-8463)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L8464-8502)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L8503-8528)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L8529-8550)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L8551-8598)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L8599-8618)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L8619-8657)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L8658-8685)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L8686-8737)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L8738-8790)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L8791-8822)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L8823-8846)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L8847-8896)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L8897-8916)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L8917-8937)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L8938-8954)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L8955-8970)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L8971-8987)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L8988-9003)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L9004-9019)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L9071-9106)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L9107-9139)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L9140-9339)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L9413-9505)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L9426-9442)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L9443-9445)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L9446-9465)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L9466-9468)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L9469-9480)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L9506-9639)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L9640-9646)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L9678-9709)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L9710-9740)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L9741-9930)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L9931-9934)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L10018-10041)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L10042-10047)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L10091-10194)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L10195-10355)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L10225-10258)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L10356-10357)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L10387-10433)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L10434-10462)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L10463-10464)

### fn `def _f_lab(values)` `priv` (L10497-10504)
...
### fn `def _f2xyz(values)` `priv` (L10505-10511)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L10547-10548)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L10582-10687)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L10688-10689)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L10724-10746)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L10747-10770)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L10771-10815)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L10816-10817)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L10847-10848)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L10901-10902)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L10944-10947)
...
### fn `def _clamp01(np_module, values)` `priv` (L11005-11018)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L11019-11041)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L11042-11075)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L11076-11106)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L11107-11147)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L11148-11149)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L11198-11220)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L11221-11245)
...
### fn `def logistic(z_values)` (L11236-11238)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L11246-11263)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L11264-11287)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L11288-11311)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L11312-11333)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L11334-11340)

### fn `def _load_piexif_dependency()` `priv` (L11449-11466)
...
### fn `def _encode_jpg(` `priv` (L11467-11478)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L11612-11640)
...
### fn `def _is_supported_runtime_os()` `priv` (L11641-11660)
...
|`WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO`|var|pub|123||
|`WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE`|var|pub|124||
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|125||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|126||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|127||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|128||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|129||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|130||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|131||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|132||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|133||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|134||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|135||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|136||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|137||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|138||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|139||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|140||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|141||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|142||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|143||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|144||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|145||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|146||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|147||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|148||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|149||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|150||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|151||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|152||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|153||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|154||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|155||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|156||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|157||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|158||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|159||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|160||
|`DEFAULT_OPENCV_SATURATION`|var|pub|161||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|162||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|163||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|164||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|165||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|166||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|167||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|168||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|169||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|170||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|171||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|172||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|173||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|174||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|175||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|176||
|`HDRPLUS_TILE_SIZE`|var|pub|177||
|`HDRPLUS_TILE_STRIDE`|var|pub|178||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|179||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|180||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|181||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|182||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|183||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|184||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|186||
|`AutoAdjustOptions`|class|pub|439-474|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|476-504|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|506-529|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|531-549|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|551-569|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|571-596|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|598-619|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|621-650|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|652-703|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|705-721|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|723-741|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|743-764|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|766-786|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|788-811|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|813-832|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|834-854|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|856-873|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|875-892|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|894-912|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|913-949|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|933-935|def _border(left, middle, right)|
|`_line`|fn|priv|936-939|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|950-966|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|967-981|def _print_help_section(title)|
|`_print_help_option`|fn|priv|982-1023|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1024-1223|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1485-1502|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1503-1548|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1549-1561|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1562-1587|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1588-1612|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1613-1632|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1633-1655|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1656-1675|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1676-1695|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1696-1716|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1717-1741|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1742-1763|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1764-1815|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1816-1818|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1979-2038|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2013-2023|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2039-2071|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2072-2097|def _normalize_white_balance_gains_rgb(np_module, camera_...|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2098-2121|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2122-2162|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2163-2220|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2221-2256|def _extract_base_rgb_linear_float(raw_handle, np_module)|
|`_normalize_source_gamma_label`|fn|priv|2257-2275|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2276-2307|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2308-2357|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2358-2406|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2407-2427|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2428-2458|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2459-2486|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2487-2508|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2509-2528|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2529-2551|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2552-2570|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2571-2616|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2617-2636|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2637-2704|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2705-2742|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2743-2771|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2772-2776|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2806-2823|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2824-2841|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_joint_auto_ev_solution`|fn|priv|2842-2845|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|2931-2951|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|2952-2978|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|2979-3002|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3003-3024|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3025-3048|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3049-3124|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3125-3141|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3142-3164|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3165-3189|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3190-3212|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3213-3238|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3239-3270|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3271-3367|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3368-3399|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3400-3472|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3473-3622|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3623-3641|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3642-3718|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|3719-3772|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_parse_auto_adjust_option`|fn|priv|3773-3796|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_white_balance_mode_option`|fn|priv|3797-3825|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|3826-3855|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_hdr_merge_option`|fn|priv|3856-3886|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|3887-3890|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|3971-4009|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4010-4029|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4030-4081|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4082-4150|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4151-4197|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4198-4257|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4209-4222|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4258-4300|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4301-4332|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4333-4362|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4363-4415|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4416-4615|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5061-5098|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5099-5129|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5130-5192|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5193-5287|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5237-5254|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5288-5319|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5320-5342|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5343-5344|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5375-5417|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5418-5551|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5552-5558|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5608-5622|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5623-5640|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|5641-5659|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|5660-5689|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|5690-5693|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|5715-5742|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|5743-5768|def _build_xphoto_analysis_image_rgb_float(np_module, ana...|
|`_build_white_balance_robust_analysis_mask`|fn|priv|5769-5801|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|5802-5806|def _extract_white_balance_channel_gains_from_xphoto(|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|5863-5867|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|5915-5918|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|5953-5984|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|5985-5988|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|6014-6018|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|6098-6102|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|6136-6161|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|6162-6177|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|6178-6193|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|6194-6201|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|6277-6280|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|6314-6333|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|6334-6359|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|6360-6365|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|6395-6399|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|6428-6435|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|6499-6518|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|6519-6523|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|6592-6605|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|6606-6613|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|6701-6729|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|6730-6776|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|6777-6810|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|6811-6831|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|6832-6850|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|6851-6875|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|6876-6894|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|6895-6900|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|6953-6959|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|7032-7039|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|7129-7216|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|7217-7241|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|7242-7246|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|7327-7333|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|7382-7454|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|7455-7459|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|7547-7557|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|7558-7560|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|7579-7608|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|7609-7628|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|7629-7660|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|7661-7688|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|7689-7715|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|7716-7740|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|7741-7746|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|7776-7796|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|7797-7814|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|7815-7819|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|7849-7895|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|7896-7940|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|7941-7966|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|7967-7983|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|7984-8010|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|8011-8055|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|8056-8078|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|8079-8103|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|8104-8134|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|8135-8140|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|8257-8274|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|8275-8292|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|8293-8310|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|8311-8350|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|8351-8396|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|8397-8402|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|8436-8463|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|8464-8502|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|8503-8528|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|8529-8550|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|8551-8598|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|8599-8618|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|8619-8657|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|8658-8685|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|8686-8737|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|8738-8790|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|8791-8822|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|8823-8846|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|8847-8896|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|8897-8916|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|8917-8937|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|8938-8954|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|8955-8970|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|8971-8987|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|8988-9003|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|9004-9019|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|9071-9106|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|9107-9139|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|9140-9339|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|9413-9505|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|9426-9442|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|9443-9445|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|9446-9465|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|9466-9468|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|9469-9480|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|9506-9639|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|9640-9646|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|9678-9709|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|9710-9740|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_build_auto_levels_tone_curve_state`|fn|priv|9741-9930|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|9931-9934|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|10018-10041|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|10042-10047|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|10091-10194|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|10195-10355|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|10225-10258|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|10356-10357|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|10387-10433|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|10434-10462|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|10463-10464|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|10497-10504|def _f_lab(values)|
|`_f2xyz`|fn|priv|10505-10511|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|10547-10548|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|10582-10687|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|10688-10689|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|10724-10746|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|10747-10770|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|10771-10815|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|10816-10817|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|10847-10848|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|10901-10902|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|10944-10947|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|11005-11018|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|11019-11041|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|11042-11075|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|11076-11106|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|11107-11147|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|11148-11149|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|11198-11220|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|11221-11245|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|11236-11238|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|11246-11263|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|11264-11287|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|11288-11311|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|11312-11333|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|11334-11340|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|11449-11466|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|11467-11478|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|11612-11640|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|11641-11660|def _is_supported_runtime_os()|
|`run`|fn|pub|11661-11860|def run(args)|
