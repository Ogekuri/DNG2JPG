...
# dng2jpg.py | Python | 14515L | 456 symbols | 33 imports | 300 comments
...
- var `PROGRAM = "dng2jpg"` (L40)
- var `DESCRIPTION = (` (L41)
- var `DEFAULT_POST_GAMMA = 1.0` (L44)
- var `DEFAULT_POST_GAMMA_MODE = "numeric"` (L45)
- var `DEFAULT_POST_GAMMA_AUTO_TARGET_GRAY = 0.5` (L46)
- var `DEFAULT_POST_GAMMA_AUTO_LUMA_MIN = 0.01` (L47)
- var `DEFAULT_POST_GAMMA_AUTO_LUMA_MAX = 0.99` (L48)
- var `DEFAULT_POST_GAMMA_AUTO_LUT_SIZE = 256` (L49)
- var `DEFAULT_BRIGHTNESS = 1.0` (L50)
- var `DEFAULT_CONTRAST = 1.0` (L51)
- var `DEFAULT_SATURATION = 1.0` (L52)
- var `DEFAULT_JPG_COMPRESSION = 15` (L53)
- var `DEFAULT_AUTO_EV_SHADOW_CLIPPING = 20.0` (L54)
- var `DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING = 20.0` (L55)
- var `DEFAULT_AUTO_EV_STEP = 0.1` (L56)
- var `DEFAULT_AUTO_EV_MAX_DELTA = 64.0` (L57)
- var `DEFAULT_AUTO_EV_MAX_ITERATIONS = 1024` (L58)
- var `DEFAULT_AA_BLUR_SIGMA = 0.9` (L59)
- var `DEFAULT_AA_BLUR_THRESHOLD_PCT = 5.0` (L60)
- var `DEFAULT_AA_LEVEL_LOW_PCT = 0.1` (L61)
- var `DEFAULT_AA_LEVEL_HIGH_PCT = 99.9` (L62)
- var `DEFAULT_AA_ENABLE_LOCAL_CONTRAST = True` (L63)
- var `DEFAULT_AA_LOCAL_CONTRAST_STRENGTH = 0.20` (L64)
- var `DEFAULT_AA_CLAHE_CLIP_LIMIT = 1.6` (L65)
- var `DEFAULT_AA_CLAHE_TILE_GRID_SIZE = (8, 8)` (L66)
- var `DEFAULT_AA_SIGMOID_CONTRAST = 1.8` (L67)
- var `DEFAULT_AA_SIGMOID_MIDPOINT = 0.5` (L68)
- var `DEFAULT_AA_SATURATION_GAMMA = 0.8` (L69)
- var `DEFAULT_AA_HIGHPASS_BLUR_SIGMA = 2.0` (L70)
- var `DEFAULT_AB_KEY_VALUE = None` (L71)
- var `DEFAULT_AB_WHITE_POINT_PERCENTILE = 99.8` (L72)
- var `DEFAULT_AB_A_MIN = 0.045` (L73)
- var `DEFAULT_AB_A_MAX = 0.72` (L74)
- var `DEFAULT_AB_MAX_AUTO_BOOST_FACTOR = 1.25` (L75)
- var `DEFAULT_AB_ENABLE_LUMINANCE_PRESERVING_DESAT = True` (L76)
- var `DEFAULT_AB_EPS = 1e-6` (L77)
- var `DEFAULT_AB_LOW_KEY_VALUE = 0.09` (L78)
- var `DEFAULT_AB_NORMAL_KEY_VALUE = 0.18` (L79)
- var `DEFAULT_AB_HIGH_KEY_VALUE = 0.36` (L80)
- var `DEFAULT_AB_LOW_VARIANCE_SPREAD_THRESHOLD = 0.02` (L81)
- var `DEFAULT_AB_LOW_VARIANCE_MIN_SAMPLE_COUNT = 4` (L82)
- var `DEFAULT_AL_CLIP_PERCENT = 0.02` (L83)
- var `DEFAULT_AL_CLIP_OUT_OF_GAMUT = True` (L84)
- var `DEFAULT_AL_GAIN_THRESHOLD = 1.0` (L85)
- var `DEFAULT_AL_HISTCOMPR = 3` (L86)
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L114)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L115)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "linear"` (L116)
- var `DEFAULT_LUMINANCE_TMO = "mantiuk08"` (L117)
- var `DEFAULT_AUTO_ADJUST_ENABLED = True` (L118)
- var `HDR_MERGE_MODE_LUMINANCE = "Luminace-HDR"` (L119)
- var `HDR_MERGE_MODE_OPENCV_MERGE = "OpenCV-Merge"` (L120)
- var `HDR_MERGE_MODE_OPENCV_TONEMAP = "OpenCV-Tonemap"` (L121)
- var `HDR_MERGE_MODE_HDR_PLUS = "HDR-Plus"` (L122)
- var `WHITE_BALANCE_MODE_SIMPLE = "Simple"` (L123)
- var `WHITE_BALANCE_MODE_GRAYWORLD = "GrayworldWB"` (L124)
- var `WHITE_BALANCE_MODE_IA = "IA"` (L125)
- var `WHITE_BALANCE_MODE_COLOR_CONSTANCY = "ColorConstancy"` (L126)
- var `WHITE_BALANCE_MODE_TTL = "TTL"` (L127)
- var `AUTO_WHITE_BALANCE_MODE_DISABLE = "disable"` (L128)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR = "linear"` (L129)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_SRGB = "srgb"` (L130)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_SOURCE_AUTO = "source-auto"` (L131)
- var `RAW_WHITE_BALANCE_MODE_GREEN = "GREEN"` (L132)
- var `RAW_WHITE_BALANCE_MODE_MAX = "MAX"` (L133)
- var `RAW_WHITE_BALANCE_MODE_MIN = "MIN"` (L134)
- var `RAW_WHITE_BALANCE_MODE_MEAN = "MEAN"` (L135)
- var `DEFAULT_RAW_WHITE_BALANCE_MODE = RAW_WHITE_BALANCE_MODE_MEAN` (L136)
- var `DEFAULT_WHITE_BALANCE_XPHOTO_DOMAIN = WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR` (L137)
- var `XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE = 99.5` (L138)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START = 0.95` (L139)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH = 0.2` (L140)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L141)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L142)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L143)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L144)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L145)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L146)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L147)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L148)
- var `DEFAULT_REINHARD02_CONTRAST = 0.9` (L149)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L150)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.9` (L151)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L152)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L153)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L154)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.9` (L155)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L156)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.2` (L157)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L158)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L159)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.2` (L160)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L161)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.0` (L162)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L163)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L164)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.4` (L165)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L166)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.0` (L167)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L168)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L169)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L170)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.4` (L171)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L172)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L173)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_DEBEVEC_POST_GAMMA` (L174)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS` (L175)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_DEBEVEC_CONTRAST` (L176)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_DEBEVEC_SATURATION` (L177)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_DEBEVEC` (L178)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L179)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA` (L180)
- var `DEFAULT_OPENCV_TONEMAP_MAP = OPENCV_TONEMAP_MAP_REINHARD` (L181)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L182)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L183)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L184)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L185)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L186)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L187)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L188)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA = 1.0` (L189)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS = 1.0` (L190)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST = 1.4` (L191)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L192)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA = 1.0` (L193)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS = 1.0` (L194)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST = 1.0` (L195)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION = 1.0` (L196)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA = 0.9` (L197)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.0` (L198)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.3` (L199)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L200)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L201)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L202)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L203)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L204)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L205)
- var `HDRPLUS_TILE_SIZE = 32` (L206)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L207)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L208)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L209)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L210)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L211)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L212)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L213)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L215)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L476-511)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L513-541)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L543-566)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L568-586)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L588-606)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L608-633)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L635-656)
...
### class `class OpenCvTonemapOptions` `@dataclass(frozen=True)` (L658-687)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L689-773)
- @brief Hold deterministic post-merge correction configuration.
- @details Encapsulates shared static postprocess factors, JPEG compression, post-merge auto-levels, post-merge auto-adjust, pre-merge auto-brightness knobs, pre-merge auto-white-balance selectors, RAW white-balance normalization, merge-gamma request state, and optional OpenCV-Tonemap selector payload. Selector fields are limited to CLI-accepted or runtime-effective variants. Complexity: O(1). Side effects: none.
...
- fn `def auto_white_balance_mode(self) -> str | None` (L746-758)
  - @brief Expose optional `--auto-white-balance` mode with explicit naming.
  - @details Provides a semantically explicit alias for `white_balance_mode` so runtime orchestration can distinguish pre-bracket auto-white-balance control from RAW camera white-balance normalization. Complexity: O(1). Side effects: none.
  - @return {str|None} Canonical auto-white-balance mode or `None` when omitted.
  - @satisfies REQ-181, REQ-182
- fn `def auto_white_balance_xphoto_domain(self) -> str` (L760-773)
  - @brief Expose xphoto estimation-domain selector with explicit naming.
  - @details Provides a semantically explicit alias for `white_balance_xphoto_domain` so runtime orchestration can pass the selector only to xphoto gain estimation. Complexity: O(1). Side effects: none.
  - @return {str} Canonical auto-white-balance xphoto estimation-domain selector.
  - @satisfies REQ-210, REQ-212

### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L775-791)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L793-811)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L813-834)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L836-857)
- @brief Hold deterministic OpenCV HDR merge option values.
- @details Encapsulates OpenCV merge controls used by the `--hdr-merge=OpenCV-Merge` backend. Debevec and Robertson require one high-precision radiance adapter path without float-to-uint8 pre-merge quantization, Mertens executes exposure fusion on float brackets with OpenCV-equivalent output rescaling plus optional simple tonemap, and all external interfaces stay RGB float `[0,1]`. Complexity: O(1). Side effects: none.
...
- @return {None} Immutable dataclass container.
- @satisfies REQ-108, REQ-109, REQ-110, REQ-141, REQ-142, REQ-143, REQ-144, REQ-152, REQ-153, REQ-154, REQ-245

### class `class OpenCvRadiancePathAdapters` `@dataclass(frozen=True)` (L859-880)
- @brief Hold one selected OpenCV radiance adapter set.
- @details Encapsulates the only supported Debevec/Robertson radiance path as three separable adapters: input adaptation, response estimation, and merge execution. Unsupported runtimes are rejected before adapter-bundle creation, so `path_label` remains the supported execution label emitted in runtime diagnostics. Complexity: O(1). Side effects: none.
...
- @return {None} Immutable adapter bundle.
- @satisfies DES-011, REQ-153, REQ-245, REQ-246

### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L882-905)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L907-926)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L928-948)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L950-967)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L969-986)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L988-1006)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L1007-1043)
...
### fn `def _border(left, middle, right)` `priv` (L1027-1029)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L1030-1033)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L1044-1060)
...
### fn `def _print_help_section(title)` `priv` (L1061-1075)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L1076-1117)
...
### fn `def print_help(version)` (L1118-1317)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1594-1611)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1612-1657)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1658-1670)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1671-1698)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1699-1726)
...
### fn `def _is_explicit_auto_bracketing_selected(args)` `priv` (L1727-1748)
- @brief Detect explicit automatic bracketing-selector usage.
- @details Scans the raw CLI token vector and returns `True` only when the last `--bracketing=` selector token equals `auto`. This selector is semantically distinct from omitted `--bracketing`, which keeps implicit automatic delta resolution but does not authorize manual `--exposure` pairing. Complexity: O(N). Side effects: none.
- @param args {list[str]} Raw command argument vector.
- @return {bool} `True` when explicit `--bracketing=auto` is present.
- @satisfies CTN-003

### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1749-1771)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1772-1791)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1792-1811)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1812-1832)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1833-1857)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1858-1879)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1880-1932)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1933-1935)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2108-2179)
...
### fn `def _percentile(percentile_value)` `priv` (L2144-2154)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _normalize_percentile(stat_name, stat_value)` `priv` (L2165-2173)

### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2180-2212)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2213-2242)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2243-2246)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2293-2316)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2317-2357)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2358-2415)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2416-2419)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2467-2485)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2486-2517)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2518-2567)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2568-2616)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2617-2637)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2638-2668)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2669-2696)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2697-2718)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2719-2739)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2740-2765)
- @brief Convert one camera-linear RGB image to a BT.709-coefficient luminance proxy.
- @details Normalizes the input image to the repository RGB float contract and computes one deterministic luminance proxy in the linear gamma=`1` domain using BT.709 coefficients `(0.2126, 0.7152, 0.0722)`. The result is used only for exposure planning heuristics and is not asserted to be colorimetrically exact standard-RGB luminance. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2766-2784)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2785-2830)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2831-2857)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2858-2957)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2958-2996)
- @brief Compute the three automatic EV-zero candidate evaluations.
- @details Migrates `calcola_correzioni_ev(immagine_float)` from the external prototype into the current pipeline, adapts it to the repository camera-linear RGB float contract, computes a BT.709-coefficient luminance proxy, evaluates `ev_best`, `ev_ettr`, and `ev_detail`, and returns all three rounded candidates without applying selector quantization. Complexity: dominated by the EV sweeps in entropy/detail evaluation. Side effects: none.
- @param cv2_module {ModuleType} Imported OpenCV module.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3188-3206)
...
- @details Skips clipping-threshold iteration whenever automatic `ev_delta` is requested for OpenCV-Tonemap, emits deterministic skip diagnostics, and returns the fixed half-span `0.1` EV. Complexity: O(1). Side effects: stdout writes only.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3207-3210)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3267-3287)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3288-3314)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3315-3338)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3339-3360)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3361-3384)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3385-3460)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3461-3477)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3478-3500)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3501-3525)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3526-3548)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3549-3574)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3575-3606)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3607-3703)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3704-3735)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3736-3808)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3809-3958)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3959-3977)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3978-4054)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4055-4111)
- @brief Apply resolved merge gamma at the OpenCV-Tonemap display boundary.
- @details Executes the same transfer families as `_apply_merge_gamma_float` but intentionally avoids lower-bound clipping to preserve unbounded positive and negative float dynamic range for OpenCV-Tonemap backend execution. This helper is the explicit tone-mapped-to-display-RGB boundary for the OpenCV-Tonemap path. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4112-4145)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4146-4169)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4170-4197)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4198-4229)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4230-4242)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4243-4269)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4270-4300)
...
### fn `def _resolve_default_postprocess(` `priv` (L4301-4305)

### fn `def _parse_gamma_option(option_value)` `priv` (L4414-4452)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4453-4472)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4473-4524)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4525-4593)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4594-4640)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4641-4700)
...
### fn `def _format_gamma_number(value)` `priv` (L4652-4665)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4701-4743)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4744-4775)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4776-4805)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4806-4862)
- @brief Apply one resolved merge-output transfer at the display boundary.
- @details Executes backend-final transfer encoding on positive float-domain RGB values after backend normalization. The helper intentionally avoids upper clipping before and after transfer evaluation so highlight headroom is preserved until the shared downstream pipeline chooses its own bounds. This helper is the explicit camera-linear-to-display-RGB boundary for OpenCV Debevec/Robertson and HDR+, and the merge-gamma-conditioned input bridge for OpenCV Mertens. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _load_image_dependencies()` `priv` (L5531-5568)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5569-5599)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5600-5662)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5663-5757)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5707-5724)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5758-5789)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5790-5812)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5813-5814)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5845-5887)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5888-6026)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L6027-6033)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L6083-6097)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L6098-6115)
...
### fn `def _safe_pow2_ev(exponent, context)` `priv` (L6116-6153)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6154-6182)
...
### fn `def _clip_bracket_rgb_unit_interval(np_module, image_rgb_float)` `priv` (L6183-6206)
- @brief Apply the explicit bracket-contract clip on camera-linear RGB data.
- @details Converts one EV-scaled camera-linear RGB tensor to `float64` and clamps every sample into `[0,1]`. This helper is the explicit main-flow clipping boundary that materializes the shared bracket contract before backend dispatch. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6207-6236)
- @brief Build normalized HDR brackets from one camera-linear RGB base tensor.
- @details Broadcast-multiplies one camera-linear RGB base tensor by the ordered EV multiplier triplet `(ev_minus, ev_zero, ev_plus)`, routes each result through `_clip_bracket_rgb_unit_interval(...)`, and returns float32 bracket tensors in canonical downstream order. The input base tensor range is preserved before EV scaling to avoid pre-clipping. Complexity: `O(3*H*W)`. Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6237-6240)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6266-6295)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6296-6342)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6343-6346)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6378-6417)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6418-6420)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6451-6453)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6480-6482)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6523-6527)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6563-6569)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6640-6662)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6663-6665)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6708-6711)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6746-6761)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6762-6769)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6857-6860)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6895-6926)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6927-6930)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6956-6959)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L6981-6989)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L7086-7093)

### fn `def _extract_bracket_images_float(` `priv` (L7179-7185)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7240-7265)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7266-7281)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7282-7297)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7298-7305)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7381-7384)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7432-7451)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7452-7483)
- @brief Normalize OpenCV HDR tensor to unit range with deterministic bounds.
- @details Normalizes arbitrary OpenCV HDR or fusion output from either the high-precision Debevec/Robertson path or the Mertens path to one congruent RGB float contract. Negative and non-finite values are cleared via `np.maximum(0.0)` floor, and values above unit range are scaled down by global maximum; no final `[0,1]` clipping is applied because the floor-and-scale sequence guarantees the output is bounded within `[0,1]` deterministically. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _rescale_mertens_fusion_to_display_range(np_module, fusion_rgb_float)` `priv` (L7484-7505)
- @brief Apply the documented OpenCV Mertens `*255.0` rescale bridge.
- @details Multiplies raw `cv2.MergeMertens.process(...)` float output by `255.0` to reproduce OpenCV exposure-fusion brightness semantics before the optional simple tonemap and the shared backend normalization step. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7506-7511)

### fn `def _adapt_opencv_radiance_input_high_precision(np_module, image_rgb_float)` `priv` (L7544-7563)
- @brief Execute OpenCV Mertens exposure fusion path.
- @brief Adapt one radiance-path bracket to backend-local float32.
...
RGB float contract.
- @details Normalizes shape and finite samples without range clipping, preserves camera-linear radiometric precision in float32, and avoids any float-to-uint8 conversion before Debevec/Robertson merge execution. Complexity: O(H*W). Side effects: none.
- @param cv2_module {ModuleType} Imported OpenCV module.
- @param np_module {ModuleType} Imported numpy module.
...
- @return {object} Backend-local RGB float32 tensor for high-precision merge.
- @satisfies REQ-108, REQ-110, REQ-143, REQ-144, REQ-154, REQ-237, REQ-238
- @satisfies REQ-110, REQ-162, REQ-245

### fn `def _estimate_opencv_camera_response_high_precision(` `priv` (L7564-7568)

### fn `def _estimate_opencv_camera_response_uint8_legacy(` `priv` (L7589-7593)
- @brief Resolve optional response payload for high-precision radiance merge.
...
- @return {None} No response payload; the selected merger consumes `times` only.
- @satisfies REQ-153, REQ-245

### fn `def _estimate_opencv_camera_response(` `priv` (L7620-7625)
...
### fn `def _merge_opencv_radiance_high_precision(` `priv` (L7651-7656)
...
- @param exposure_times {object} OpenCV exposure-time vector.
- @param merge_algorithm {str} Canonical OpenCV merge algorithm token.
- @param response_estimator {object} Selected response-estimator adapter callable.
- @return {object} Adapter-defined response payload or `None`.
- @satisfies DES-011, REQ-153, REQ-245

### fn `def _merge_opencv_radiance_uint8_legacy(` `priv` (L7689-7694)
- @brief Execute high-precision Debevec/Robertson merge without uint8 adaptation.
- @details Dispatches directly to OpenCV `MergeDebevec` or
`MergeRobertson` using float32 brackets and `times` only. The selected path
omits calibrated response injection because the merge backend is probed and
executed in direct high-precision mode. Complexity: O(n*p). Side effects:
none.
- @param cv2_module {ModuleType} Imported OpenCV module.
- @param exposures_radiance_float32 {list[object]} Ordered backend-local RGB float32 bracket tensors.
- @param exposure_times {object} OpenCV exposure-time vector.
- @param merge_algorithm {str} Canonical OpenCV merge algorithm token.
- @param response {object|None} Unused optional response payload for signature stability.
- @return {object} OpenCV radiance float tensor before optional tonemap and normalization.
- @exception RuntimeError Raised when `merge_algorithm` is unsupported.
- @satisfies REQ-109, REQ-110, REQ-143, REQ-152, REQ-245

### fn `def _probe_opencv_high_precision_radiance_support(` `priv` (L7728-7731)
...
### fn `def _select_opencv_radiance_path_adapters(` `priv` (L7770-7773)
- @brief Probe high-precision Debevec/Robertson merge compatibility.
...
### fn `def _print_opencv_radiance_path_diagnostic(path_label)` `priv` (L7807-7821)
...
- @details Prints exactly one runtime line naming the supported Debevec/Robertson radiance execution path or the deterministic fail-fast rejection path. Complexity: O(1). Side effects: stdout write via `print_info`.
- @param cv2_module {ModuleType} Imported OpenCV module.
- @param np_module {ModuleType} Imported numpy module.
- @param merge_algorithm {str} Canonical OpenCV merge algorithm token.
...
### fn `def _quantize_opencv_radiance_rgb_uint8(np_module, image_rgb_float)` `priv` (L7822-7843)
- @brief Quantize one retained legacy radiance-path bracket at the OpenCV uint8 boundary.
- @details Converts one camera-linear RGB float bracket to `uint8` using the repository byte-quantization helper. Normal conversion no longer selects this helper; it is retained only for isolated compatibility scaffolding. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb_float {object} Camera-linear RGB float bracket tensor.
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7844-7851)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7912-7931)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7932-7937)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L8017-8030)
...
### fn `def _run_opencv_merge_backend(` `priv` (L8031-8039)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L8136-8164)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L8165-8211)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L8212-8245)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L8246-8266)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L8267-8285)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L8286-8310)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L8311-8329)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L8330-8335)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L8388-8394)

### fn `def _hdrplus_align_layer(` `priv` (L8467-8474)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L8564-8651)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L8652-8676)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8677-8681)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8762-8768)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8817-8889)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8890-8895)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8991-9001)
...
### fn `def _collect_missing_external_executables(` `priv` (L9002-9004)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L9023-9052)
...
### fn `def _resolve_numpy_dependency()` `priv` (L9053-9072)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L9073-9113)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L9114-9132)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L9133-9160)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L9161-9188)
- @brief Adapt postprocess entry payload to display-referred RGB float32.
- @details Preserves merge-backend float payload dynamic range by bypassing normalization/clipping for float-typed inputs and normalizes only non-float image encodings (`uint8`, `uint16`, or integer-like payloads) into the display-referred RGB working domain before postprocess stages execute.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L9189-9215)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L9216-9240)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L9241-9246)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L9276-9296)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L9297-9302)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L9361-9378)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L9379-9383)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L9413-9463)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L9464-9512)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L9513-9541)
- @brief Apply static post-gamma over RGB float tensor.
- @details Executes the numeric static gamma stage on finite display-referred RGB float data with sign-preserving magnitude power (`output = sign(input) * abs(input)^(1/gamma)`), preserves legacy `input^(1/gamma)` behavior for non-negative samples, avoids intermediate stage-local `[0,1]` clipping, and prevents `NaN`/`Inf` generation on signed backend outputs. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb_float {object} RGB float image tensor.
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L9542-9563)
- @brief Build one floating-point LUT for auto-gamma mapping.
- @details Generates one evenly sampled domain in `[0,1]` and evaluates `output = input^gamma` over that domain using float precision only. This helper is the explicit LUT discretization boundary for auto-gamma.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L9564-9594)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L9656-9678)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9679-9703)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9704-9734)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9735-9740)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9859-9876)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9877-9894)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9895-9915)
- @brief Compute one BT.709-coefficient luminance proxy from camera-linear RGB.
- @details Computes per-pixel luminance proxy using BT.709 coefficients with RGB channel order `0.2126*R + 0.7152*G + 0.0722*B`. The input tensor is the camera-linear pre-merge working image used by auto-brightness, so the coefficients serve as a deterministic planning proxy rather than a strict standard-RGB colorimetric claim.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9916-9931)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9932-9984)
...
### fn `def _should_use_low_variance_auto_brightness_fallback(` `priv` (L9985-9989)

### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L10043-10088)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L10089-10094)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L10185-10212)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L10213-10251)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L10252-10282)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L10283-10304)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L10305-10352)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L10353-10372)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L10373-10411)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L10412-10439)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L10440-10491)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L10492-10544)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L10545-10584)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L10585-10608)
- @brief Reconstruct display-referred RGB output from YCrCb float channels.
- @details Creates one float32 YCrCb tensor from one equalized luminance plane plus preserved Cr/Cb channels, converts it back to RGB with OpenCV color transforms only, and returns one clamped float64 display-referred RGB tensor for downstream blending in the auto-adjust pipeline.
- @param cv2_module {ModuleType} Imported cv2 module.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L10673-10692)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L10693-10713)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L10714-10730)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L10731-10746)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L10747-10763)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10764-10779)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10780-10795)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10847-10888)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10889-10921)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10922-11121)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L11280-11372)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L11293-11309)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L11310-11312)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L11313-11332)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L11333-11335)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L11336-11347)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L11373-11506)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L11507-11513)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L11545-11582)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L11583-11613)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L11614-11635)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L11636-11650)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L11651-11850)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11881-11884)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L11968-11991)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L11992-11997)

### fn `def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)` `priv` (L12041-12068)
...
pipeline.
- @details Sanitizes one display-referred RGB tensor to finite `float32` samples and clamps the result to `[0,1]` before RawTherapee-compatible histogram analysis and postprocess-local YCrCb/CIELab-like operations. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L12184-12344)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L12214-12247)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L12345-12346)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L12376-12428)
...
- @details Ports luminance method from attached source in RGB domain with clipped-channel chroma ratio scaling and masked reconstruction. Sanitizes non-finite RGB input samples to `0.0` before method-local computation. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L12429-12457)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L12458-12459)

### fn `def _f_lab(values)` `priv` (L12499-12506)
...
### fn `def _f2xyz(values)` `priv` (L12507-12513)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L12549-12550)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L12584-12699)
...
- @details Ports blend method from attached source with quadratic channel blend and desaturation phase driven by clipping metrics. Sanitizes non-finite RGB and `hlmax` inputs to `0.0` before method-local computation. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb {object} RGB float tensor on legacy code scale.
- @param maxval {float} Maximum legacy code-domain value.
- @param xyz_cam {object|None} Optional XYZ conversion matrix.
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L12700-12701)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L12736-12758)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L12759-12782)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L12783-12833)
- @brief Apply Color Propagation highlight reconstruction on RGB tensor.
- @details Approximates RawTherapee `Color` recovery in post-merge RGB space: detect clipped channel regions, estimate one local opposite-channel reference from `3x3` means, derive one border chrominance offset, and fill clipped samples deterministically. Sanitizes non-finite RGB input samples to `0.0` before method-local computation. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb {object} RGB float tensor on normalized scale.
- @param maxval {float} Maximum channel value.
- @return {object} Highlight-reconstructed RGB float tensor.
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12834-12835)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12865-12866)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12924-12925)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12967-12970)
...
### fn `def _clamp01(np_module, values)` `priv` (L13028-13041)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L13042-13064)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L13065-13098)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L13099-13129)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L13130-13170)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L13171-13172)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L13229-13259)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L13260-13291)
...
### fn `def logistic(z_values)` (L13282-13284)
- @brief Execute sigmoidal contrast stage on display-referred RGB.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L13292-13317)
- @brief Execute HSL saturation gamma stage on display-referred RGB.
- @details Converts display-referred RGB to HSL, applies saturation gamma transform, and converts back to RGB.
- @param np_module {ModuleType} Imported numpy module.
- @param rgb {object} Display-referred RGB float tensor in `[0.0, 1.0]`.
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L13318-13341)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L13342-13365)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L13366-13387)
...
### fn `def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)` `priv` (L13388-13415)
- @brief Apply the explicit auto-adjust clamp on display-referred stage data.
- @details Sanitizes one display-referred stage payload to finite `float64` samples and clamps the result to `[0,1]`. This helper is reused before stage-local statistics and after stage-local arithmetic so repeated auto-adjust clamp points remain explicit and centrally documented. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L13416-13422)

### fn `def _apply_auto_adjust_stage_float(` `priv` (L13545-13551)
...
### fn `def _load_piexif_dependency()` `priv` (L13597-13614)
...
### fn `def _clip_postprocess_exit_rgb(np_module, image_rgb_float)` `priv` (L13615-13637)
- @brief Apply the explicit `_postprocess` exit clip on display-referred RGB.
- @details Converts one display-referred RGB payload to `float32`, clamps it to `[0,1]`, and returns the bounded tensor consumed by final JPEG quantization. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb_float {object} Display-referred RGB float tensor.
- @return {object} Display-referred RGB float32 tensor bounded to `[0,1]`.
- @note Boundary classification: contract clipping.
...
### fn `def _postprocess(` `priv` (L13638-13644)

### fn `def _quantize_final_rgb_uint8(np_module, image_rgb_float)` `priv` (L13728-13754)
- @brief Apply the explicit final JPEG quantization boundary.
- @details Converts one display-referred RGB float tensor to bounded `float32`, then delegates to `_to_uint8_image_array(...)` for the final byte-domain quantization used by JPEG save and EXIF thumbnail refresh. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb_float {object} Display-referred RGB float tensor.
...
### fn `def _encode_jpg(` `priv` (L13755-13763)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L13822-13856)
...
### fn `def _is_supported_runtime_os()` `priv` (L13857-13876)
...
### fn `def _print_validated_run_parameters(` `priv` (L13877-13892)

### fn `def run(args)` (L14070-14269)
...
- @details Parses command options, emits structured validated parameter summary after file-path preconditions pass, validates dependencies, detects source DNG bits-per-color from RAW metadata, resolves `ev_zero` (static `0.0` default, static `--exposure=<value>`, or auto via `--exposure=auto`) and `ev_delta` (automatic when `--bracketing` is omitted or explicit `--bracketing=auto`, static for `--bracketing=<value>`), extracts one linear HDR base image using the selected RAW WB normalization mode, executes pre-bracket auto-brightness, executes pre-bracket auto-white-balance with internal enable-state validation, derives bracket payloads in canonical order, executes the selected HDR backend with float input/output interfaces, executes the post-merge `_postprocess(...)` pipeline without re-running auto-brightness or auto-white-balance, optionally emits persistent debug TIFF checkpoints for executed stages, writes the final JPG, and guarantees temporary-artifact cleanup through isolated temporary-directory lifecycle. Complexity: O(H*W) plus backend-specific merge cost. Side effects: filesystem I/O, stdout, optional subprocess execution, optional debug TIFF writes.
...
|---|---|---|---|---|
|`PROGRAM`|var|pub|40||
|`DESCRIPTION`|var|pub|41||
|`DEFAULT_POST_GAMMA`|var|pub|44||
|`DEFAULT_POST_GAMMA_MODE`|var|pub|45||
|`DEFAULT_POST_GAMMA_AUTO_TARGET_GRAY`|var|pub|46||
|`DEFAULT_POST_GAMMA_AUTO_LUMA_MIN`|var|pub|47||
|`DEFAULT_POST_GAMMA_AUTO_LUMA_MAX`|var|pub|48||
|`DEFAULT_POST_GAMMA_AUTO_LUT_SIZE`|var|pub|49||
|`DEFAULT_BRIGHTNESS`|var|pub|50||
|`DEFAULT_CONTRAST`|var|pub|51||
|`DEFAULT_SATURATION`|var|pub|52||
|`DEFAULT_JPG_COMPRESSION`|var|pub|53||
|`DEFAULT_AUTO_EV_SHADOW_CLIPPING`|var|pub|54||
|`DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING`|var|pub|55||
|`DEFAULT_AUTO_EV_STEP`|var|pub|56||
|`DEFAULT_AUTO_EV_MAX_DELTA`|var|pub|57||
|`DEFAULT_AUTO_EV_MAX_ITERATIONS`|var|pub|58||
|`DEFAULT_AA_BLUR_SIGMA`|var|pub|59||
|`DEFAULT_AA_BLUR_THRESHOLD_PCT`|var|pub|60||
|`DEFAULT_AA_LEVEL_LOW_PCT`|var|pub|61||
|`DEFAULT_AA_LEVEL_HIGH_PCT`|var|pub|62||
|`DEFAULT_AA_ENABLE_LOCAL_CONTRAST`|var|pub|63||
|`DEFAULT_AA_LOCAL_CONTRAST_STRENGTH`|var|pub|64||
|`DEFAULT_AA_CLAHE_CLIP_LIMIT`|var|pub|65||
|`DEFAULT_AA_CLAHE_TILE_GRID_SIZE`|var|pub|66||
|`DEFAULT_AA_SIGMOID_CONTRAST`|var|pub|67||
|`DEFAULT_AA_SIGMOID_MIDPOINT`|var|pub|68||
|`DEFAULT_AA_SATURATION_GAMMA`|var|pub|69||
|`DEFAULT_AA_HIGHPASS_BLUR_SIGMA`|var|pub|70||
|`DEFAULT_AB_KEY_VALUE`|var|pub|71||
|`DEFAULT_AB_WHITE_POINT_PERCENTILE`|var|pub|72||
|`DEFAULT_AB_A_MIN`|var|pub|73||
|`DEFAULT_AB_A_MAX`|var|pub|74||
|`DEFAULT_AB_MAX_AUTO_BOOST_FACTOR`|var|pub|75||
|`DEFAULT_AB_ENABLE_LUMINANCE_PRESERVING_DESAT`|var|pub|76||
|`DEFAULT_AB_EPS`|var|pub|77||
|`DEFAULT_AB_LOW_KEY_VALUE`|var|pub|78||
|`DEFAULT_AB_NORMAL_KEY_VALUE`|var|pub|79||
|`DEFAULT_AB_HIGH_KEY_VALUE`|var|pub|80||
|`DEFAULT_AB_LOW_VARIANCE_SPREAD_THRESHOLD`|var|pub|81||
|`DEFAULT_AB_LOW_VARIANCE_MIN_SAMPLE_COUNT`|var|pub|82||
|`DEFAULT_AL_CLIP_PERCENT`|var|pub|83||
|`DEFAULT_AL_CLIP_OUT_OF_GAMUT`|var|pub|84||
|`DEFAULT_AL_GAIN_THRESHOLD`|var|pub|85||
|`DEFAULT_AL_HISTCOMPR`|var|pub|86||
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|114||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|115||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|116||
|`DEFAULT_LUMINANCE_TMO`|var|pub|117||
|`DEFAULT_AUTO_ADJUST_ENABLED`|var|pub|118||
|`HDR_MERGE_MODE_LUMINANCE`|var|pub|119||
|`HDR_MERGE_MODE_OPENCV_MERGE`|var|pub|120||
|`HDR_MERGE_MODE_OPENCV_TONEMAP`|var|pub|121||
|`HDR_MERGE_MODE_HDR_PLUS`|var|pub|122||
|`WHITE_BALANCE_MODE_SIMPLE`|var|pub|123||
|`WHITE_BALANCE_MODE_GRAYWORLD`|var|pub|124||
|`WHITE_BALANCE_MODE_IA`|var|pub|125||
|`WHITE_BALANCE_MODE_COLOR_CONSTANCY`|var|pub|126||
|`WHITE_BALANCE_MODE_TTL`|var|pub|127||
|`AUTO_WHITE_BALANCE_MODE_DISABLE`|var|pub|128||
|`WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR`|var|pub|129||
|`WHITE_BALANCE_XPHOTO_DOMAIN_SRGB`|var|pub|130||
|`WHITE_BALANCE_XPHOTO_DOMAIN_SOURCE_AUTO`|var|pub|131||
|`RAW_WHITE_BALANCE_MODE_GREEN`|var|pub|132||
|`RAW_WHITE_BALANCE_MODE_MAX`|var|pub|133||
|`RAW_WHITE_BALANCE_MODE_MIN`|var|pub|134||
|`RAW_WHITE_BALANCE_MODE_MEAN`|var|pub|135||
|`DEFAULT_RAW_WHITE_BALANCE_MODE`|var|pub|136||
|`DEFAULT_WHITE_BALANCE_XPHOTO_DOMAIN`|var|pub|137||
|`XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE`|var|pub|138||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START`|var|pub|139||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH`|var|pub|140||
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|141||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|142||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|143||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|144||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|145||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|146||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|147||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|148||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|149||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|150||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|151||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|152||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|153||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|154||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|155||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|156||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|157||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|158||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|159||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|160||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|161||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|162||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|163||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|164||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|165||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|166||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|167||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|168||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|169||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|170||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|171||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|172||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|173||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|174||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|175||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|176||
|`DEFAULT_OPENCV_SATURATION`|var|pub|177||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|178||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|179||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|180||
|`DEFAULT_OPENCV_TONEMAP_MAP`|var|pub|181||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|182||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|183||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|184||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|185||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|186||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|187||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|188||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA`|var|pub|189||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS`|var|pub|190||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST`|var|pub|191||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|192||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA`|var|pub|193||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS`|var|pub|194||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST`|var|pub|195||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION`|var|pub|196||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA`|var|pub|197||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS`|var|pub|198||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST`|var|pub|199||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|200||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|201||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|202||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|203||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|204||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|205||
|`HDRPLUS_TILE_SIZE`|var|pub|206||
|`HDRPLUS_TILE_STRIDE`|var|pub|207||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|208||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|209||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|210||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|211||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|212||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|213||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|215||
|`AutoAdjustOptions`|class|pub|476-511|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|513-541|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|543-566|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|568-586|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|588-606|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|608-633|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|635-656|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|658-687|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|689-773|class PostprocessOptions|
|`PostprocessOptions.auto_white_balance_mode`|fn|pub|746-758|def auto_white_balance_mode(self) -> str | None|
|`PostprocessOptions.auto_white_balance_xphoto_domain`|fn|pub|760-773|def auto_white_balance_xphoto_domain(self) -> str|
|`DebugArtifactContext`|class|pub|775-791|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|793-811|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|813-834|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|836-857|class OpenCvMergeOptions|
|`OpenCvRadiancePathAdapters`|class|pub|859-880|class OpenCvRadiancePathAdapters|
|`HdrPlusOptions`|class|pub|882-905|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|907-926|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|928-948|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|950-967|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|969-986|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|988-1006|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|1007-1043|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|1027-1029|def _border(left, middle, right)|
|`_line`|fn|priv|1030-1033|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|1044-1060|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|1061-1075|def _print_help_section(title)|
|`_print_help_option`|fn|priv|1076-1117|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1118-1317|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1594-1611|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1612-1657|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1658-1670|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1671-1698|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1699-1726|def _parse_ev_center_option(ev_center_raw)|
|`_is_explicit_auto_bracketing_selected`|fn|priv|1727-1748|def _is_explicit_auto_bracketing_selected(args)|
|`_parse_percentage_option`|fn|priv|1749-1771|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1772-1791|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1792-1811|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1812-1832|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1833-1857|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1858-1879|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1880-1932|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1933-1935|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2108-2179|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2144-2154|def _percentile(percentile_value)|
|`_normalize_percentile`|fn|priv|2165-2173|def _normalize_percentile(stat_name, stat_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2180-2212|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2213-2242|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2243-2246|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2293-2316|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2317-2357|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2358-2415|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2416-2419|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2467-2485|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2486-2517|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2518-2567|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2568-2616|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2617-2637|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2638-2668|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2669-2696|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2697-2718|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2719-2739|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2740-2765|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2766-2784|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2785-2830|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2831-2857|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2858-2957|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2958-2996|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
...
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3188-3206|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3207-3210|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3267-3287|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3288-3314|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3315-3338|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3339-3360|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3361-3384|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3385-3460|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3461-3477|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3478-3500|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3501-3525|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3526-3548|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3549-3574|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3575-3606|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3607-3703|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3704-3735|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3736-3808|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3809-3958|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3959-3977|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3978-4054|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|4055-4111|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4112-4145|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4146-4169|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4170-4197|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4198-4229|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4230-4242|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4243-4269|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4270-4300|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4301-4305|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4414-4452|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4453-4472|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4473-4524|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4525-4593|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4594-4640|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4641-4700|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4652-4665|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4701-4743|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4744-4775|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4776-4805|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4806-4862|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4863-5062|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5531-5568|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5569-5599|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5600-5662|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5663-5757|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5707-5724|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5758-5789|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5790-5812|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5813-5814|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5845-5887|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5888-6026|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|6027-6033|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|6083-6097|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|6098-6115|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_safe_pow2_ev`|fn|priv|6116-6153|def _safe_pow2_ev(exponent, context)|
|`_build_exposure_multipliers`|fn|priv|6154-6182|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_clip_bracket_rgb_unit_interval`|fn|priv|6183-6206|def _clip_bracket_rgb_unit_interval(np_module, image_rgb_...|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6207-6236|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6237-6240|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6266-6295|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6296-6342|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6343-6346|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6378-6417|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6418-6420|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6451-6453|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6480-6482|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6523-6527|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6563-6569|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6640-6662|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6663-6665|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6708-6711|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6746-6761|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6762-6769|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6857-6860|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6895-6926|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6927-6930|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|6956-6959|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|6981-6989|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|7086-7093|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|7179-7185|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7240-7265|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7266-7281|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7282-7297|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7298-7305|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7381-7384|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7432-7451|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7452-7483|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_rescale_mertens_fusion_to_display_range`|fn|priv|7484-7505|def _rescale_mertens_fusion_to_display_range(np_module, f...|
|`_run_opencv_merge_mertens`|fn|priv|7506-7511|def _run_opencv_merge_mertens(|
|`_adapt_opencv_radiance_input_high_precision`|fn|priv|7544-7563|def _adapt_opencv_radiance_input_high_precision(np_module...|
|`_estimate_opencv_camera_response_high_precision`|fn|priv|7564-7568|def _estimate_opencv_camera_response_high_precision(|
|`_estimate_opencv_camera_response_uint8_legacy`|fn|priv|7589-7593|def _estimate_opencv_camera_response_uint8_legacy(|
|`_estimate_opencv_camera_response`|fn|priv|7620-7625|def _estimate_opencv_camera_response(|
|`_merge_opencv_radiance_high_precision`|fn|priv|7651-7656|def _merge_opencv_radiance_high_precision(|
|`_merge_opencv_radiance_uint8_legacy`|fn|priv|7689-7694|def _merge_opencv_radiance_uint8_legacy(|
|`_probe_opencv_high_precision_radiance_support`|fn|priv|7728-7731|def _probe_opencv_high_precision_radiance_support(|
|`_select_opencv_radiance_path_adapters`|fn|priv|7770-7773|def _select_opencv_radiance_path_adapters(|
|`_print_opencv_radiance_path_diagnostic`|fn|priv|7807-7821|def _print_opencv_radiance_path_diagnostic(path_label)|
|`_quantize_opencv_radiance_rgb_uint8`|fn|priv|7822-7843|def _quantize_opencv_radiance_rgb_uint8(np_module, image_...|
|`_run_opencv_merge_radiance`|fn|priv|7844-7851|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7912-7931|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7932-7937|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|8017-8030|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|8031-8039|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|8136-8164|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|8165-8211|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|8212-8245|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|8246-8266|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|8267-8285|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|8286-8310|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|8311-8329|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|8330-8335|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|8388-8394|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|8467-8474|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|8564-8651|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|8652-8676|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8677-8681|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8762-8768|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8817-8889|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8890-8895|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|8991-9001|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|9002-9004|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|9023-9052|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|9053-9072|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|9073-9113|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|9114-9132|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|9133-9160|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|9161-9188|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|9189-9215|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|9216-9240|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|9241-9246|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|9276-9296|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|9297-9302|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|9361-9378|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|9379-9383|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|9413-9463|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|9464-9512|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|9513-9541|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|9542-9563|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|9564-9594|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|9595-9655|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|9656-9678|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9679-9703|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9704-9734|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9735-9740|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9859-9876|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9877-9894|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9895-9915|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9916-9931|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9932-9984|def _analyze_luminance_key(np_module, luminance, eps)|
|`_should_use_low_variance_auto_brightness_fallback`|fn|priv|9985-9989|def _should_use_low_variance_auto_brightness_fallback(|
|`_choose_auto_key_value`|fn|priv|10043-10088|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|10089-10094|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|10185-10212|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|10213-10251|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|10252-10282|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|10283-10304|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|10305-10352|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|10353-10372|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|10373-10411|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|10412-10439|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|10440-10491|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|10492-10544|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|10545-10584|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|10585-10608|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|10609-10672|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|10673-10692|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|10693-10713|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|10714-10730|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|10731-10746|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|10747-10763|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10764-10779|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10780-10795|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10847-10888|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10889-10921|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10922-11121|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|11280-11372|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|11293-11309|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|11310-11312|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|11313-11332|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|11333-11335|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|11336-11347|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|11373-11506|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|11507-11513|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|11545-11582|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|11583-11613|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|11614-11635|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|11636-11650|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|11651-11850|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11881-11884|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|11968-11991|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|11992-11997|def _call_auto_levels_compat_helper(|
|`_clip_auto_levels_entry_rgb`|fn|priv|12041-12068|def _clip_auto_levels_entry_rgb(np_module, image_rgb_float)|
|`_apply_auto_levels_float`|fn|priv|12069-12183|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|12184-12344|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|12214-12247|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|12345-12346|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|12376-12428|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|12429-12457|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|12458-12459|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|12499-12506|def _f_lab(values)|
|`_f2xyz`|fn|priv|12507-12513|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|12549-12550|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|12584-12699|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|12700-12701|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|12736-12758|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|12759-12782|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|12783-12833|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12834-12835|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12865-12866|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12924-12925|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12967-12970|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|13028-13041|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|13042-13064|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|13065-13098|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|13099-13129|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|13130-13170|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|13171-13172|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|13229-13259|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|13260-13291|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|13282-13284|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|13292-13317|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|13318-13341|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|13342-13365|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|13366-13387|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_clip_auto_adjust_stage_rgb`|fn|priv|13388-13415|def _clip_auto_adjust_stage_rgb(np_module, stage_rgb)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|13416-13422|def _apply_validated_auto_adjust_pipeline(|
|`_apply_auto_adjust_stage_float`|fn|priv|13545-13551|def _apply_auto_adjust_stage_float(|
|`_load_piexif_dependency`|fn|priv|13597-13614|def _load_piexif_dependency()|
|`_clip_postprocess_exit_rgb`|fn|priv|13615-13637|def _clip_postprocess_exit_rgb(np_module, image_rgb_float)|
|`_postprocess`|fn|priv|13638-13644|def _postprocess(|
|`_quantize_final_rgb_uint8`|fn|priv|13728-13754|def _quantize_final_rgb_uint8(np_module, image_rgb_float)|
|`_encode_jpg`|fn|priv|13755-13763|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|13822-13856|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|13857-13876|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|13877-13892|def _print_validated_run_parameters(|
|`run`|fn|pub|14070-14269|def run(args)|
