...
# dng2jpg.py | Python | 11700L | 356 symbols | 29 imports | 242 comments
...
- var `DEFAULT_POST_GAMMA_MODE = "numeric"` (L42)
- var `DEFAULT_POST_GAMMA_AUTO_TARGET_GRAY = 0.5` (L43)
- var `DEFAULT_POST_GAMMA_AUTO_LUMA_MIN = 0.01` (L44)
- var `DEFAULT_POST_GAMMA_AUTO_LUMA_MAX = 0.99` (L45)
- var `DEFAULT_POST_GAMMA_AUTO_LUT_SIZE = 256` (L46)
- var `DEFAULT_BRIGHTNESS = 1.0` (L47)
- var `DEFAULT_CONTRAST = 1.0` (L48)
- var `DEFAULT_SATURATION = 1.0` (L49)
- var `DEFAULT_JPG_COMPRESSION = 15` (L50)
- var `DEFAULT_AUTO_EV_SHADOW_CLIPPING = 20.0` (L51)
- var `DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING = 20.0` (L52)
- var `DEFAULT_AUTO_EV_STEP = 0.1` (L53)
- var `DEFAULT_AA_BLUR_SIGMA = 0.9` (L54)
- var `DEFAULT_AA_BLUR_THRESHOLD_PCT = 5.0` (L55)
- var `DEFAULT_AA_LEVEL_LOW_PCT = 0.1` (L56)
- var `DEFAULT_AA_LEVEL_HIGH_PCT = 99.9` (L57)
- var `DEFAULT_AA_ENABLE_LOCAL_CONTRAST = True` (L58)
- var `DEFAULT_AA_LOCAL_CONTRAST_STRENGTH = 0.20` (L59)
- var `DEFAULT_AA_CLAHE_CLIP_LIMIT = 1.6` (L60)
- var `DEFAULT_AA_CLAHE_TILE_GRID_SIZE = (8, 8)` (L61)
- var `DEFAULT_AA_SIGMOID_CONTRAST = 1.8` (L62)
- var `DEFAULT_AA_SIGMOID_MIDPOINT = 0.5` (L63)
- var `DEFAULT_AA_SATURATION_GAMMA = 0.8` (L64)
- var `DEFAULT_AA_HIGHPASS_BLUR_SIGMA = 2.0` (L65)
- var `DEFAULT_AB_KEY_VALUE = None` (L66)
- var `DEFAULT_AB_WHITE_POINT_PERCENTILE = 99.8` (L67)
- var `DEFAULT_AB_A_MIN = 0.045` (L68)
- var `DEFAULT_AB_A_MAX = 0.72` (L69)
- var `DEFAULT_AB_MAX_AUTO_BOOST_FACTOR = 1.25` (L70)
- var `DEFAULT_AB_ENABLE_LUMINANCE_PRESERVING_DESAT = True` (L71)
- var `DEFAULT_AB_EPS = 1e-6` (L72)
- var `DEFAULT_AB_LOW_KEY_VALUE = 0.09` (L73)
- var `DEFAULT_AB_NORMAL_KEY_VALUE = 0.18` (L74)
- var `DEFAULT_AB_HIGH_KEY_VALUE = 0.36` (L75)
- var `DEFAULT_AL_CLIP_PERCENT = 0.02` (L76)
- var `DEFAULT_AL_CLIP_OUT_OF_GAMUT = True` (L77)
- var `DEFAULT_AL_GAIN_THRESHOLD = 1.0` (L78)
- var `DEFAULT_AL_HISTCOMPR = 3` (L79)
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L107)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L108)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "linear"` (L109)
...
- var `WHITE_BALANCE_MODE_IA = "IA"` (L117)
- var `WHITE_BALANCE_MODE_COLOR_CONSTANCY = "ColorConstancy"` (L118)
- var `WHITE_BALANCE_MODE_TTL = "TTL"` (L119)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L120)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L121)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L122)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L123)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L124)
- var `DEFAULT_REINHARD02_CONTRAST = 0.75` (L125)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L126)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.8` (L127)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L128)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.1` (L129)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L130)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.8` (L131)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L132)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.0` (L133)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L134)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L135)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.0` (L136)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L137)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.05` (L138)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L139)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L140)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.0` (L141)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L142)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.05` (L143)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L144)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L145)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L146)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.3` (L147)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L148)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L149)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_ROBERTSON_POST_GAMMA` (L150)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS` (L151)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_ROBERTSON_CONTRAST` (L152)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_ROBERTSON_SATURATION` (L153)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_ROBERTSON` (L154)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L155)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA` (L156)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L157)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L158)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L159)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L160)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L161)
- var `HDRPLUS_TILE_SIZE = 32` (L162)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L163)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L164)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L165)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L166)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L167)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L168)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L169)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L171)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L400-435)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L437-465)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L467-490)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L492-510)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L512-530)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L532-557)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L559-580)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L582-629)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L631-647)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L649-667)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L669-690)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L692-712)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L714-737)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L739-758)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L760-780)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L782-799)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L801-818)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L820-838)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L839-875)
...
### fn `def _border(left, middle, right)` `priv` (L859-861)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L862-865)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L876-892)
...
### fn `def _print_help_section(title)` `priv` (L893-907)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L908-949)
...
### fn `def print_help(version)` (L950-1149)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1361-1379)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1380-1392)
...
### fn `def _derive_supported_ev_values(` `priv` (L1393-1395)

### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1419-1464)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1465-1477)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1478-1503)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1504-1528)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1529-1548)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1549-1571)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1572-1591)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1592-1611)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1612-1632)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1633-1657)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1658-1679)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1680-1731)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1732-1791)
...
### fn `def _percentile(percentile_value)` `priv` (L1766-1776)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L1792-1820)
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L1821-1839)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L1840-1871)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L1872-1921)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L1922-1970)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L1971-1991)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L1992-2022)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2023-2050)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2051-2072)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2073-2092)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2093-2115)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2116-2134)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2135-2180)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2181-2200)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2201-2268)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2269-2306)
...
### fn `def _select_ev_zero_candidate(evaluations, safe_ev_zero_max)` `priv` (L2307-2336)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2337-2341)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2371-2388)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2389-2406)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2407-2413)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2512-2532)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L2533-2559)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2560-2583)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L2584-2605)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2606-2629)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L2630-2705)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2706-2722)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2723-2745)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2746-2770)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2771-2793)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2794-2819)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2820-2851)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2852-2948)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2949-2980)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2981-3053)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3054-3203)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3204-3222)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3223-3299)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L3300-3323)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L3324-3352)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L3353-3382)
...
### fn `def _resolve_default_postprocess(` `priv` (L3383-3386)

### fn `def _parse_gamma_option(option_value)` `priv` (L3467-3505)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L3506-3525)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L3526-3577)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L3578-3646)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L3647-3693)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L3694-3753)
...
### fn `def _format_gamma_number(value)` `priv` (L3705-3718)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L3754-3796)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L3797-3828)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3829-3881)
...
### fn `def _parse_run_options(args)` `priv` (L3882-4081)
...
### fn `def _load_image_dependencies()` `priv` (L4807-4844)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L4845-4875)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L4876-4938)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L4939-5033)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L4983-5000)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5034-5065)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5066-5088)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5089-5090)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5121-5163)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5164-5297)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5298-5304)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5354-5368)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5369-5386)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L5387-5405)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L5406-5434)
...
### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L5435-5462)
...
### fn `def _build_xphoto_analysis_proxy_rgb_float(np_module, analysis_image_rgb_float)` `priv` (L5463-5502)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L5503-5507)

### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L5556-5560)
...
### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L5608-5611)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L5639-5663)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L5664-5667)

### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L5693-5696)
...
### fn `def _extract_bracket_images_float(` `priv` (L5771-5775)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L5809-5834)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L5835-5850)
...
### fn `def _format_external_command_for_log(command)` `priv` (L5851-5866)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L5867-5874)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L5950-5953)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L5987-6006)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L6007-6032)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L6033-6038)

### fn `def _estimate_opencv_camera_response(` `priv` (L6068-6072)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L6101-6108)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L6172-6191)
...
### fn `def _run_opencv_merge_backend(` `priv` (L6192-6199)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L6287-6315)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L6316-6362)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L6363-6396)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L6397-6417)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L6418-6436)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L6437-6461)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L6462-6480)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L6481-6486)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L6539-6545)

### fn `def _hdrplus_align_layer(` `priv` (L6618-6625)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L6715-6802)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L6803-6827)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L6828-6832)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L6913-6919)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L6968-7040)
...
### fn `def _run_hdr_plus_merge(` `priv` (L7041-7045)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L7133-7143)
...
### fn `def _collect_missing_external_executables(` `priv` (L7144-7146)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L7165-7194)
...
### fn `def _resolve_numpy_dependency()` `priv` (L7195-7214)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L7215-7246)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L7247-7274)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7275-7301)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7302-7326)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L7327-7332)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L7362-7382)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L7383-7400)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L7401-7405)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L7435-7481)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L7482-7526)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L7527-7552)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L7553-7569)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L7570-7596)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L7597-7641)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L7642-7664)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L7665-7689)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L7690-7720)
...
### fn `def _apply_static_postprocess_float(` `priv` (L7721-7726)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L7843-7860)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L7861-7878)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L7879-7896)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L7897-7936)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L7937-7982)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L7983-7988)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L8022-8049)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L8050-8088)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L8089-8114)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L8115-8136)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L8137-8184)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L8185-8204)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L8205-8243)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L8244-8271)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L8272-8323)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L8324-8376)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L8377-8408)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L8409-8432)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L8433-8482)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L8483-8502)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L8503-8523)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L8524-8540)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L8541-8556)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L8557-8573)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L8574-8589)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L8590-8605)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L8657-8692)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L8693-8725)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L8726-8925)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L8999-9091)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L9012-9028)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L9029-9031)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L9032-9051)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L9052-9054)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L9055-9066)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L9092-9225)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L9226-9232)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L9264-9295)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L9296-9326)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L9327-9516)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L9517-9520)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L9604-9627)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L9628-9633)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L9677-9780)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L9781-9941)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L9811-9844)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L9942-9943)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L9973-10019)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L10020-10048)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L10049-10050)

### fn `def _f_lab(values)` `priv` (L10083-10090)
...
### fn `def _f2xyz(values)` `priv` (L10091-10097)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L10133-10134)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L10168-10273)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L10274-10275)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L10310-10332)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L10333-10356)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L10357-10401)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L10402-10403)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L10433-10434)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L10487-10488)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L10530-10533)
...
### fn `def _clamp01(np_module, values)` `priv` (L10591-10604)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L10605-10627)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L10628-10661)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L10662-10692)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L10693-10733)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L10734-10735)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L10784-10806)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L10807-10831)
...
### fn `def logistic(z_values)` (L10822-10824)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L10832-10849)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L10850-10873)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L10874-10897)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L10898-10919)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L10920-10926)

### fn `def _load_piexif_dependency()` `priv` (L11035-11052)
...
### fn `def _encode_jpg(` `priv` (L11053-11064)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L11198-11226)
...
### fn `def _is_supported_runtime_os()` `priv` (L11227-11246)
...
|`DEFAULT_POST_GAMMA_MODE`|var|pub|42||
|`DEFAULT_POST_GAMMA_AUTO_TARGET_GRAY`|var|pub|43||
|`DEFAULT_POST_GAMMA_AUTO_LUMA_MIN`|var|pub|44||
|`DEFAULT_POST_GAMMA_AUTO_LUMA_MAX`|var|pub|45||
|`DEFAULT_POST_GAMMA_AUTO_LUT_SIZE`|var|pub|46||
|`DEFAULT_BRIGHTNESS`|var|pub|47||
|`DEFAULT_CONTRAST`|var|pub|48||
|`DEFAULT_SATURATION`|var|pub|49||
|`DEFAULT_JPG_COMPRESSION`|var|pub|50||
|`DEFAULT_AUTO_EV_SHADOW_CLIPPING`|var|pub|51||
|`DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING`|var|pub|52||
|`DEFAULT_AUTO_EV_STEP`|var|pub|53||
|`DEFAULT_AA_BLUR_SIGMA`|var|pub|54||
|`DEFAULT_AA_BLUR_THRESHOLD_PCT`|var|pub|55||
|`DEFAULT_AA_LEVEL_LOW_PCT`|var|pub|56||
|`DEFAULT_AA_LEVEL_HIGH_PCT`|var|pub|57||
|`DEFAULT_AA_ENABLE_LOCAL_CONTRAST`|var|pub|58||
|`DEFAULT_AA_LOCAL_CONTRAST_STRENGTH`|var|pub|59||
|`DEFAULT_AA_CLAHE_CLIP_LIMIT`|var|pub|60||
|`DEFAULT_AA_CLAHE_TILE_GRID_SIZE`|var|pub|61||
|`DEFAULT_AA_SIGMOID_CONTRAST`|var|pub|62||
|`DEFAULT_AA_SIGMOID_MIDPOINT`|var|pub|63||
|`DEFAULT_AA_SATURATION_GAMMA`|var|pub|64||
|`DEFAULT_AA_HIGHPASS_BLUR_SIGMA`|var|pub|65||
|`DEFAULT_AB_KEY_VALUE`|var|pub|66||
|`DEFAULT_AB_WHITE_POINT_PERCENTILE`|var|pub|67||
|`DEFAULT_AB_A_MIN`|var|pub|68||
|`DEFAULT_AB_A_MAX`|var|pub|69||
|`DEFAULT_AB_MAX_AUTO_BOOST_FACTOR`|var|pub|70||
|`DEFAULT_AB_ENABLE_LUMINANCE_PRESERVING_DESAT`|var|pub|71||
|`DEFAULT_AB_EPS`|var|pub|72||
|`DEFAULT_AB_LOW_KEY_VALUE`|var|pub|73||
|`DEFAULT_AB_NORMAL_KEY_VALUE`|var|pub|74||
|`DEFAULT_AB_HIGH_KEY_VALUE`|var|pub|75||
|`DEFAULT_AL_CLIP_PERCENT`|var|pub|76||
|`DEFAULT_AL_CLIP_OUT_OF_GAMUT`|var|pub|77||
|`DEFAULT_AL_GAIN_THRESHOLD`|var|pub|78||
|`DEFAULT_AL_HISTCOMPR`|var|pub|79||
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|107||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|108||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|109||
...
|`WHITE_BALANCE_MODE_IA`|var|pub|117||
|`WHITE_BALANCE_MODE_COLOR_CONSTANCY`|var|pub|118||
|`WHITE_BALANCE_MODE_TTL`|var|pub|119||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|120||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|121||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|122||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|123||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|124||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|125||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|126||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|127||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|128||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|129||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|130||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|131||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|132||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|133||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|134||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|135||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|136||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|137||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|138||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|139||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|140||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|141||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|142||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|143||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|144||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|145||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|146||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|147||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|148||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|149||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|150||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|151||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|152||
|`DEFAULT_OPENCV_SATURATION`|var|pub|153||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|154||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|155||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|156||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|157||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|158||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|159||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|160||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|161||
|`HDRPLUS_TILE_SIZE`|var|pub|162||
|`HDRPLUS_TILE_STRIDE`|var|pub|163||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|164||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|165||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|166||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|167||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|168||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|169||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|171||
|`AutoAdjustOptions`|class|pub|400-435|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|437-465|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|467-490|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|492-510|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|512-530|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|532-557|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|559-580|class ExifGammaTags|
|`PostprocessOptions`|class|pub|582-629|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|631-647|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|649-667|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|669-690|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|692-712|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|714-737|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|739-758|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|760-780|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|782-799|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|801-818|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|820-838|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|839-875|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|859-861|def _border(left, middle, right)|
|`_line`|fn|priv|862-865|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|876-892|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|893-907|def _print_help_section(title)|
|`_print_help_option`|fn|priv|908-949|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|950-1149|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1361-1379|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1380-1392|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1393-1395|def _derive_supported_ev_values(|
|`_detect_dng_bits_per_color`|fn|priv|1419-1464|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1465-1477|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1478-1503|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1504-1528|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1529-1548|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1549-1571|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1572-1591|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1592-1611|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1612-1632|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1633-1657|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1658-1679|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1680-1731|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1732-1791|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1766-1776|def _percentile(percentile_value)|
|`_extract_base_rgb_linear_float`|fn|priv|1792-1820|def _extract_base_rgb_linear_float(raw_handle, np_module)|
|`_normalize_source_gamma_label`|fn|priv|1821-1839|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|1840-1871|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|1872-1921|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|1922-1970|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|1971-1991|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|1992-2022|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2023-2050|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2051-2072|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2073-2092|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2093-2115|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2116-2134|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2135-2180|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2181-2200|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2201-2268|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2269-2306|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2307-2336|def _select_ev_zero_candidate(evaluations, safe_ev_zero_max)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2337-2341|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2371-2388|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2389-2406|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_joint_auto_ev_solution`|fn|priv|2407-2413|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|2512-2532|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|2533-2559|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|2560-2583|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|2584-2605|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|2606-2629|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|2630-2705|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|2706-2722|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2723-2745|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2746-2770|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2771-2793|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2794-2819|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2820-2851|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2852-2948|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2949-2980|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2981-3053|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3054-3203|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3204-3222|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3223-3299|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|3300-3323|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_white_balance_mode_option`|fn|priv|3324-3352|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_hdr_merge_option`|fn|priv|3353-3382|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|3383-3386|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|3467-3505|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|3506-3525|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|3526-3577|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|3578-3646|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|3647-3693|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|3694-3753|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|3705-3718|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|3754-3796|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|3797-3828|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_apply_merge_gamma_float`|fn|priv|3829-3881|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|3882-4081|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|4807-4844|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|4845-4875|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|4876-4938|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|4939-5033|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|4983-5000|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5034-5065|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5066-5088|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5089-5090|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5121-5163|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5164-5297|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5298-5304|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5354-5368|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5369-5386|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|5387-5405|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|5406-5434|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_validate_white_balance_triplet_shape`|fn|priv|5435-5462|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_build_xphoto_analysis_proxy_rgb_float`|fn|priv|5463-5502|def _build_xphoto_analysis_proxy_rgb_float(np_module, ana...|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|5503-5507|def _extract_white_balance_channel_gains_from_xphoto(|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|5556-5560|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|5608-5611|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|5639-5663|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|5664-5667|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|5693-5696|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|5771-5775|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|5809-5834|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|5835-5850|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|5851-5866|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|5867-5874|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|5950-5953|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|5987-6006|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|6007-6032|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|6033-6038|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|6068-6072|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|6101-6108|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|6172-6191|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_merge_backend`|fn|priv|6192-6199|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|6287-6315|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|6316-6362|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|6363-6396|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|6397-6417|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|6418-6436|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|6437-6461|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|6462-6480|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|6481-6486|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|6539-6545|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|6618-6625|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|6715-6802|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|6803-6827|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|6828-6832|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|6913-6919|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|6968-7040|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|7041-7045|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|7133-7143|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|7144-7146|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|7165-7194|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|7195-7214|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|7215-7246|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|7247-7274|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|7275-7301|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|7302-7326|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|7327-7332|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|7362-7382|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|7383-7400|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|7401-7405|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|7435-7481|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|7482-7526|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|7527-7552|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|7553-7569|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|7570-7596|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|7597-7641|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|7642-7664|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|7665-7689|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|7690-7720|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|7721-7726|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|7843-7860|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|7861-7878|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|7879-7896|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|7897-7936|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|7937-7982|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|7983-7988|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|8022-8049|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|8050-8088|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|8089-8114|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|8115-8136|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|8137-8184|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|8185-8204|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|8205-8243|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|8244-8271|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|8272-8323|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|8324-8376|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|8377-8408|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|8409-8432|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|8433-8482|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|8483-8502|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|8503-8523|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|8524-8540|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|8541-8556|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|8557-8573|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|8574-8589|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|8590-8605|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|8657-8692|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|8693-8725|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|8726-8925|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|8999-9091|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|9012-9028|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|9029-9031|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|9032-9051|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|9052-9054|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|9055-9066|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|9092-9225|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|9226-9232|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|9264-9295|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|9296-9326|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_build_auto_levels_tone_curve_state`|fn|priv|9327-9516|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|9517-9520|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|9604-9627|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|9628-9633|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|9677-9780|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|9781-9941|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|9811-9844|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|9942-9943|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|9973-10019|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|10020-10048|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|10049-10050|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|10083-10090|def _f_lab(values)|
|`_f2xyz`|fn|priv|10091-10097|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|10133-10134|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|10168-10273|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|10274-10275|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|10310-10332|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|10333-10356|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|10357-10401|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|10402-10403|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|10433-10434|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|10487-10488|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|10530-10533|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|10591-10604|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|10605-10627|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|10628-10661|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|10662-10692|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|10693-10733|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|10734-10735|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|10784-10806|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|10807-10831|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|10822-10824|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|10832-10849|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|10850-10873|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|10874-10897|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|10898-10919|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|10920-10926|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|11035-11052|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|11053-11064|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|11198-11226|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|11227-11246|def _is_supported_runtime_os()|
|`run`|fn|pub|11247-11446|def run(args)|
