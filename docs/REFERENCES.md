...
# dng2jpg.py | Python | 13781L | 438 symbols | 32 imports | 283 comments
...
- var `DEFAULT_AL_CLIP_PERCENT = 0.02` (L80)
- var `DEFAULT_AL_CLIP_OUT_OF_GAMUT = True` (L81)
- var `DEFAULT_AL_GAIN_THRESHOLD = 1.0` (L82)
- var `DEFAULT_AL_HISTCOMPR = 3` (L83)
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L111)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L112)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "linear"` (L113)
- var `DEFAULT_LUMINANCE_TMO = "mantiuk08"` (L114)
- var `DEFAULT_AUTO_ADJUST_ENABLED = True` (L115)
- var `HDR_MERGE_MODE_LUMINANCE = "Luminace-HDR"` (L116)
- var `HDR_MERGE_MODE_OPENCV_MERGE = "OpenCV-Merge"` (L117)
- var `HDR_MERGE_MODE_OPENCV_TONEMAP = "OpenCV-Tonemap"` (L118)
- var `HDR_MERGE_MODE_HDR_PLUS = "HDR-Plus"` (L119)
- var `WHITE_BALANCE_MODE_SIMPLE = "Simple"` (L120)
- var `WHITE_BALANCE_MODE_GRAYWORLD = "GrayworldWB"` (L121)
- var `WHITE_BALANCE_MODE_IA = "IA"` (L122)
- var `WHITE_BALANCE_MODE_COLOR_CONSTANCY = "ColorConstancy"` (L123)
- var `WHITE_BALANCE_MODE_TTL = "TTL"` (L124)
- var `AUTO_WHITE_BALANCE_MODE_DISABLE = "disable"` (L125)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR = "linear"` (L126)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_SRGB = "srgb"` (L127)
- var `WHITE_BALANCE_XPHOTO_DOMAIN_SOURCE_AUTO = "source-auto"` (L128)
- var `RAW_WHITE_BALANCE_MODE_GREEN = "GREEN"` (L129)
- var `RAW_WHITE_BALANCE_MODE_MAX = "MAX"` (L130)
- var `RAW_WHITE_BALANCE_MODE_MIN = "MIN"` (L131)
- var `RAW_WHITE_BALANCE_MODE_MEAN = "MEAN"` (L132)
- var `DEFAULT_RAW_WHITE_BALANCE_MODE = RAW_WHITE_BALANCE_MODE_MEAN` (L133)
- var `DEFAULT_WHITE_BALANCE_XPHOTO_DOMAIN = WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR` (L134)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO = "ev-zero"` (L135)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE = "linear-base"` (L136)
- var `XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE = 99.5` (L137)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START = 0.95` (L138)
- var `XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH = 0.2` (L139)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L140)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L141)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L142)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L143)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L144)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L145)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L146)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L147)
- var `DEFAULT_REINHARD02_CONTRAST = 0.9` (L148)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L149)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.9` (L150)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L151)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L152)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L153)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.9` (L154)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L155)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.2` (L156)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L157)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L158)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.2` (L159)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L160)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.0` (L161)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L162)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L163)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.4` (L164)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L165)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.0` (L166)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L167)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L168)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L169)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.4` (L170)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L171)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L172)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_DEBEVEC_POST_GAMMA` (L173)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS` (L174)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_DEBEVEC_CONTRAST` (L175)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_DEBEVEC_SATURATION` (L176)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_DEBEVEC` (L177)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L178)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA` (L179)
- var `DEFAULT_OPENCV_TONEMAP_MAP = OPENCV_TONEMAP_MAP_REINHARD` (L180)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L181)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L182)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L183)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L184)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L185)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L186)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L187)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA = 1.0` (L188)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS = 1.0` (L189)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST = 1.4` (L190)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 0.6` (L191)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA = 1.0` (L192)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS = 1.0` (L193)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST = 1.0` (L194)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION = 1.0` (L195)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA = 0.9` (L196)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.2` (L197)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.4` (L198)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 0.5` (L199)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L200)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L201)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L202)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L203)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L204)
- var `HDRPLUS_TILE_SIZE = 32` (L205)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L206)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L207)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L208)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L209)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L210)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L211)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L212)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L214)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L479-514)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L516-544)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L546-569)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L571-589)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L591-609)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L611-636)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L638-659)
...
### class `class OpenCvTonemapOptions` `@dataclass(frozen=True)` (L661-690)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L692-790)
...
- fn `def auto_white_balance_mode(self) -> str | None` (L752-763)
...
- fn `def auto_white_balance_analysis_source(self) -> str` (L765-776)
...
- fn `def auto_white_balance_xphoto_domain(self) -> str` (L778-790)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L792-808)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L810-828)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L830-851)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L853-873)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L875-898)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L900-919)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L921-941)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L943-960)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L962-979)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L981-999)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L1000-1036)
...
### fn `def _border(left, middle, right)` `priv` (L1020-1022)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L1023-1026)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L1037-1053)
...
### fn `def _print_help_section(title)` `priv` (L1054-1068)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L1069-1110)
...
### fn `def print_help(version)` (L1111-1310)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1580-1597)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1598-1643)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1644-1656)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1657-1683)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1684-1710)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1711-1733)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1734-1753)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1754-1773)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1774-1794)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1795-1819)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1820-1841)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1842-1894)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1895-1897)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2070-2129)
...
### fn `def _percentile(percentile_value)` `priv` (L2104-2114)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2130-2162)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2163-2192)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2193-2196)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2243-2266)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2267-2307)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2308-2365)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2366-2369)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2416-2434)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2435-2466)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2467-2516)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2517-2565)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2566-2586)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2587-2617)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2618-2645)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2646-2667)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2668-2687)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2688-2710)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2711-2729)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2730-2775)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2776-2795)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2796-2863)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2864-2901)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2902-2930)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2931-2935)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2965-2982)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2983-3000)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L3001-3005)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3093-3110)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3111-3114)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3171-3191)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3192-3218)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3219-3242)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3243-3264)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3265-3288)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3289-3364)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3365-3381)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3382-3404)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3405-3429)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3430-3452)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3453-3478)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3479-3510)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3511-3607)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3608-3639)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3640-3712)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3713-3862)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3863-3881)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3882-3958)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3959-4012)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4013-4046)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4047-4070)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4071-4098)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4099-4130)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4131-4143)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4144-4173)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4174-4200)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4201-4231)
...
### fn `def _resolve_default_postprocess(` `priv` (L4232-4236)

### fn `def _parse_gamma_option(option_value)` `priv` (L4345-4383)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4384-4403)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4404-4455)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4456-4524)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4525-4571)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4572-4631)
...
### fn `def _format_gamma_number(value)` `priv` (L4583-4596)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4632-4674)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4675-4706)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4707-4736)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4737-4789)
...
### fn `def _load_image_dependencies()` `priv` (L5428-5465)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5466-5496)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5497-5559)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5560-5654)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5604-5621)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5655-5686)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5687-5709)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5710-5711)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5742-5784)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5785-5923)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5924-5930)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5980-5994)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5995-6012)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6013-6031)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6032-6061)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6062-6065)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6087-6116)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6117-6163)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6164-6167)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6199-6238)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6239-6241)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6272-6274)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6301-6303)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6344-6348)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6384-6390)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6461-6483)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6484-6486)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6529-6532)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6567-6582)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6583-6590)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6678-6681)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6716-6747)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6748-6751)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6777-6780)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L6802-6810)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6903-6910)

### fn `def _extract_bracket_images_float(` `priv` (L6996-7002)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7057-7082)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7083-7098)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7099-7114)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7115-7122)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7198-7201)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7235-7254)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7255-7280)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7281-7286)

### fn `def _estimate_opencv_camera_response(` `priv` (L7316-7320)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7349-7356)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7420-7439)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7440-7445)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L7524-7537)
...
### fn `def _run_opencv_merge_backend(` `priv` (L7538-7546)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L7643-7671)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L7672-7718)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L7719-7752)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L7753-7773)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L7774-7792)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L7793-7817)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L7818-7836)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L7837-7842)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L7895-7901)

### fn `def _hdrplus_align_layer(` `priv` (L7974-7981)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L8071-8158)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L8159-8183)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8184-8188)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8269-8275)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8324-8396)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8397-8402)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8498-8508)
...
### fn `def _collect_missing_external_executables(` `priv` (L8509-8511)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L8530-8559)
...
### fn `def _resolve_numpy_dependency()` `priv` (L8560-8579)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L8580-8620)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L8621-8639)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L8640-8667)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L8668-8695)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8696-8722)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8723-8747)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L8748-8753)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L8783-8803)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L8804-8809)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L8868-8885)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L8886-8890)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L8920-8970)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L8971-9019)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L9020-9045)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L9046-9062)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L9063-9093)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L9094-9154)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L9155-9177)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9178-9202)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9203-9233)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9234-9239)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9356-9373)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9374-9391)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9392-9409)
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9410-9425)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9426-9478)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L9479-9524)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L9525-9530)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L9604-9631)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L9632-9670)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L9671-9701)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L9702-9723)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L9724-9771)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L9772-9791)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L9792-9830)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L9831-9858)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L9859-9910)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L9911-9963)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L9964-10003)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L10004-10027)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L10028-10091)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L10092-10111)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L10112-10132)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L10133-10149)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L10150-10165)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L10166-10182)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10183-10198)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10199-10214)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10266-10307)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10308-10340)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10341-10540)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L10699-10791)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L10712-10728)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L10729-10731)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L10732-10751)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L10752-10754)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L10755-10766)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L10792-10925)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L10926-10932)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L10964-11001)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L11002-11032)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L11033-11054)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L11055-11069)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L11070-11269)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11300-11303)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L11387-11410)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L11411-11416)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L11460-11578)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L11579-11739)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L11609-11642)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L11740-11741)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L11771-11817)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L11818-11846)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L11847-11848)

### fn `def _f_lab(values)` `priv` (L11881-11888)
...
### fn `def _f2xyz(values)` `priv` (L11889-11895)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L11931-11932)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L11966-12071)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L12072-12073)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L12108-12130)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L12131-12154)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L12155-12199)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12200-12201)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12231-12232)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12285-12286)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12328-12331)
...
### fn `def _clamp01(np_module, values)` `priv` (L12387-12400)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L12401-12423)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L12424-12457)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L12458-12488)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L12489-12529)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L12530-12531)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L12588-12618)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L12619-12650)
...
### fn `def logistic(z_values)` (L12641-12643)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L12651-12676)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L12677-12700)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L12701-12724)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L12725-12746)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L12747-12753)

### fn `def _sanitize_auto_adjust_stage(stage_rgb)` `priv` (L12772-12783)
...
### fn `def _load_piexif_dependency()` `priv` (L12888-12905)
...
### fn `def _postprocess(` `priv` (L12906-12914)

### fn `def _encode_jpg(` `priv` (L13044-13052)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L13112-13140)
...
### fn `def _is_supported_runtime_os()` `priv` (L13141-13160)
...
### fn `def _print_validated_run_parameters(` `priv` (L13161-13176)

### fn `def run(args)` (L13354-13553)
...
|`DEFAULT_AL_CLIP_PERCENT`|var|pub|80||
|`DEFAULT_AL_CLIP_OUT_OF_GAMUT`|var|pub|81||
|`DEFAULT_AL_GAIN_THRESHOLD`|var|pub|82||
|`DEFAULT_AL_HISTCOMPR`|var|pub|83||
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|111||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|112||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|113||
|`DEFAULT_LUMINANCE_TMO`|var|pub|114||
|`DEFAULT_AUTO_ADJUST_ENABLED`|var|pub|115||
|`HDR_MERGE_MODE_LUMINANCE`|var|pub|116||
|`HDR_MERGE_MODE_OPENCV_MERGE`|var|pub|117||
|`HDR_MERGE_MODE_OPENCV_TONEMAP`|var|pub|118||
|`HDR_MERGE_MODE_HDR_PLUS`|var|pub|119||
|`WHITE_BALANCE_MODE_SIMPLE`|var|pub|120||
|`WHITE_BALANCE_MODE_GRAYWORLD`|var|pub|121||
|`WHITE_BALANCE_MODE_IA`|var|pub|122||
|`WHITE_BALANCE_MODE_COLOR_CONSTANCY`|var|pub|123||
|`WHITE_BALANCE_MODE_TTL`|var|pub|124||
|`AUTO_WHITE_BALANCE_MODE_DISABLE`|var|pub|125||
|`WHITE_BALANCE_XPHOTO_DOMAIN_LINEAR`|var|pub|126||
|`WHITE_BALANCE_XPHOTO_DOMAIN_SRGB`|var|pub|127||
|`WHITE_BALANCE_XPHOTO_DOMAIN_SOURCE_AUTO`|var|pub|128||
|`RAW_WHITE_BALANCE_MODE_GREEN`|var|pub|129||
|`RAW_WHITE_BALANCE_MODE_MAX`|var|pub|130||
|`RAW_WHITE_BALANCE_MODE_MIN`|var|pub|131||
|`RAW_WHITE_BALANCE_MODE_MEAN`|var|pub|132||
|`DEFAULT_RAW_WHITE_BALANCE_MODE`|var|pub|133||
|`DEFAULT_WHITE_BALANCE_XPHOTO_DOMAIN`|var|pub|134||
|`WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO`|var|pub|135||
|`WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE`|var|pub|136||
|`XPHOTO_ESTIMATION_PAYLOAD_SCALE_PERCENTILE`|var|pub|137||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_START`|var|pub|138||
|`XPHOTO_ESTIMATION_PAYLOAD_SOFT_KNEE_STRENGTH`|var|pub|139||
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|140||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|141||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|142||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|143||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|144||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|145||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|146||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|147||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|148||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|149||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|150||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|151||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|152||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|153||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|154||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|155||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|156||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|157||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|158||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|159||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|160||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|161||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|162||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|163||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|164||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|165||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|166||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|167||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|168||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|169||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|170||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|171||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|172||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|173||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|174||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|175||
|`DEFAULT_OPENCV_SATURATION`|var|pub|176||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|177||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|178||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|179||
|`DEFAULT_OPENCV_TONEMAP_MAP`|var|pub|180||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|181||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|182||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|183||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|184||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|185||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|186||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|187||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA`|var|pub|188||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS`|var|pub|189||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST`|var|pub|190||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|191||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA`|var|pub|192||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS`|var|pub|193||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST`|var|pub|194||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION`|var|pub|195||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA`|var|pub|196||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS`|var|pub|197||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST`|var|pub|198||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|199||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|200||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|201||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|202||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|203||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|204||
|`HDRPLUS_TILE_SIZE`|var|pub|205||
|`HDRPLUS_TILE_STRIDE`|var|pub|206||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|207||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|208||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|209||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|210||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|211||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|212||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|214||
|`AutoAdjustOptions`|class|pub|479-514|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|516-544|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|546-569|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|571-589|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|591-609|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|611-636|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|638-659|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|661-690|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|692-790|class PostprocessOptions|
|`PostprocessOptions.auto_white_balance_mode`|fn|pub|752-763|def auto_white_balance_mode(self) -> str | None|
|`PostprocessOptions.auto_white_balance_analysis_source`|fn|pub|765-776|def auto_white_balance_analysis_source(self) -> str|
|`PostprocessOptions.auto_white_balance_xphoto_domain`|fn|pub|778-790|def auto_white_balance_xphoto_domain(self) -> str|
|`DebugArtifactContext`|class|pub|792-808|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|810-828|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|830-851|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|853-873|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|875-898|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|900-919|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|921-941|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|943-960|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|962-979|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|981-999|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|1000-1036|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|1020-1022|def _border(left, middle, right)|
|`_line`|fn|priv|1023-1026|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|1037-1053|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|1054-1068|def _print_help_section(title)|
|`_print_help_option`|fn|priv|1069-1110|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1111-1310|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1580-1597|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1598-1643|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1644-1656|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1657-1683|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1684-1710|def _parse_ev_center_option(ev_center_raw)|
|`_parse_percentage_option`|fn|priv|1711-1733|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1734-1753|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1754-1773|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1774-1794|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1795-1819|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1820-1841|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1842-1894|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1895-1897|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2070-2129|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2104-2114|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2130-2162|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2163-2192|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2193-2196|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2243-2266|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2267-2307|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2308-2365|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2366-2369|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2416-2434|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2435-2466|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2467-2516|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2517-2565|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2566-2586|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2587-2617|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2618-2645|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2646-2667|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2668-2687|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2688-2710|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2711-2729|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2730-2775|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2776-2795|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2796-2863|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2864-2901|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2902-2930|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2931-2935|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2965-2982|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2983-3000|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|3001-3005|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3093-3110|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3111-3114|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3171-3191|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3192-3218|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3219-3242|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3243-3264|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3265-3288|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3289-3364|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3365-3381|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3382-3404|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3405-3429|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3430-3452|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3453-3478|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3479-3510|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3511-3607|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3608-3639|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3640-3712|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3713-3862|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3863-3881|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3882-3958|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|3959-4012|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4013-4046|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4047-4070|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4071-4098|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4099-4130|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4131-4143|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4144-4173|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4174-4200|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4201-4231|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4232-4236|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4345-4383|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4384-4403|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4404-4455|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4456-4524|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4525-4571|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4572-4631|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4583-4596|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4632-4674|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4675-4706|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4707-4736|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4737-4789|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4790-4989|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5428-5465|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5466-5496|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5497-5559|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5560-5654|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5604-5621|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5655-5686|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5687-5709|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5710-5711|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5742-5784|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5785-5923|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5924-5930|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5980-5994|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5995-6012|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|6013-6031|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6032-6061|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6062-6065|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6087-6116|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6117-6163|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6164-6167|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6199-6238|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6239-6241|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6272-6274|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6301-6303|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6344-6348|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6384-6390|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6461-6483|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6484-6486|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6529-6532|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6567-6582|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6583-6590|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6678-6681|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6716-6747|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6748-6751|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|6777-6780|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|6802-6810|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|6903-6910|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|6996-7002|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7057-7082|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7083-7098|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7099-7114|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7115-7122|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7198-7201|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7235-7254|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7255-7280|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|7281-7286|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|7316-7320|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|7349-7356|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7420-7439|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7440-7445|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|7524-7537|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|7538-7546|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|7643-7671|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|7672-7718|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|7719-7752|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|7753-7773|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|7774-7792|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|7793-7817|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|7818-7836|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|7837-7842|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|7895-7901|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|7974-7981|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|8071-8158|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|8159-8183|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8184-8188|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8269-8275|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8324-8396|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8397-8402|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|8498-8508|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|8509-8511|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|8530-8559|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|8560-8579|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|8580-8620|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|8621-8639|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|8640-8667|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|8668-8695|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|8696-8722|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|8723-8747|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|8748-8753|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|8783-8803|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|8804-8809|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|8868-8885|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|8886-8890|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|8920-8970|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|8971-9019|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|9020-9045|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|9046-9062|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|9063-9093|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|9094-9154|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|9155-9177|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9178-9202|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9203-9233|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9234-9239|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9356-9373|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9374-9391|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9392-9409|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9410-9425|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9426-9478|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|9479-9524|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|9525-9530|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|9604-9631|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|9632-9670|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|9671-9701|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|9702-9723|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|9724-9771|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|9772-9791|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|9792-9830|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|9831-9858|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|9859-9910|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|9911-9963|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|9964-10003|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|10004-10027|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|10028-10091|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|10092-10111|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|10112-10132|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|10133-10149|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|10150-10165|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|10166-10182|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10183-10198|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10199-10214|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10266-10307|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10308-10340|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10341-10540|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|10699-10791|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|10712-10728|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|10729-10731|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|10732-10751|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|10752-10754|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|10755-10766|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|10792-10925|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|10926-10932|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|10964-11001|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|11002-11032|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|11033-11054|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|11055-11069|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|11070-11269|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11300-11303|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|11387-11410|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|11411-11416|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|11460-11578|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|11579-11739|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|11609-11642|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|11740-11741|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|11771-11817|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|11818-11846|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|11847-11848|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|11881-11888|def _f_lab(values)|
|`_f2xyz`|fn|priv|11889-11895|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|11931-11932|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|11966-12071|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|12072-12073|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|12108-12130|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|12131-12154|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|12155-12199|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12200-12201|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12231-12232|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12285-12286|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12328-12331|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|12387-12400|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|12401-12423|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|12424-12457|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|12458-12488|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|12489-12529|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|12530-12531|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|12588-12618|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|12619-12650|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|12641-12643|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|12651-12676|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|12677-12700|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|12701-12724|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|12725-12746|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|12747-12753|def _apply_validated_auto_adjust_pipeline(|
|`_sanitize_auto_adjust_stage`|fn|priv|12772-12783|def _sanitize_auto_adjust_stage(stage_rgb)|
|`_load_piexif_dependency`|fn|priv|12888-12905|def _load_piexif_dependency()|
|`_postprocess`|fn|priv|12906-12914|def _postprocess(|
|`_encode_jpg`|fn|priv|13044-13052|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|13112-13140|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|13141-13160|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|13161-13176|def _print_validated_run_parameters(|
|`run`|fn|pub|13354-13553|def run(args)|
