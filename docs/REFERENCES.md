...
# dng2jpg.py | Python | 9653L | 298 symbols | 24 imports | 208 comments
...
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L93)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L94)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "srgb"` (L95)
- var `DEFAULT_LUMINANCE_TMO = "mantiuk08"` (L96)
- var `DEFAULT_AUTO_ADJUST_ENABLED = True` (L97)
- var `HDR_MERGE_MODE_LUMINANCE = "Luminace-HDR"` (L98)
- var `HDR_MERGE_MODE_OPENCV = "OpenCV"` (L99)
- var `HDR_MERGE_MODE_HDR_PLUS = "HDR-Plus"` (L100)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L101)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L102)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L103)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.25` (L104)
- var `DEFAULT_REINHARD02_CONTRAST = 0.85` (L105)
- var `DEFAULT_REINHARD02_SATURATION = 0.55` (L106)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L107)
- var `DEFAULT_OPENCV_POST_GAMMA = 1.0` (L108)
- var `DEFAULT_OPENCV_BRIGHTNESS = 1.0` (L109)
- var `DEFAULT_OPENCV_CONTRAST = 1.0` (L110)
- var `DEFAULT_OPENCV_SATURATION = 1.0` (L111)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_ROBERTSON` (L112)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L113)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = 2.2` (L114)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L115)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L116)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L117)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L118)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L119)
- var `HDRPLUS_TILE_SIZE = 32` (L120)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L121)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L122)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L123)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L124)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L125)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L126)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L127)
- var `EV_STEP = 0.25` (L129)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L130)
- var `DEFAULT_DNG_BITS_PER_COLOR = 14` (L131)
- var `SUPPORTED_EV_VALUES = tuple(` (L132)
- var `AUTO_EV_LOW_PERCENTILE = 0.1` (L138)
- var `AUTO_EV_HIGH_PERCENTILE = 99.9` (L139)
- var `AUTO_EV_MEDIAN_PERCENTILE = 50.0` (L140)
- var `AUTO_EV_TARGET_SHADOW = 0.05` (L141)
- var `AUTO_EV_TARGET_HIGHLIGHT = 0.90` (L142)
- var `AUTO_EV_MEDIAN_TARGET = 0.5` (L143)
- var `AUTO_EV_PLUS_CLIP_TARGET_FRACTION = 0.001` (L144)
- var `AUTO_EV_CENTER_CLIP_TARGET_FRACTION = 0.0` (L145)
- var `AUTO_EV_CLIP_EPS = 1e-9` (L146)
- var `AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD = 0.35` (L147)
- var `AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD = 0.65` (L148)
- var `AUTO_ZERO_TARGET_LOW_KEY = 0.35` (L149)
- var `AUTO_ZERO_TARGET_HIGH_KEY = 0.65` (L150)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L364-399)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L401-429)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L431-454)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L456-492)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L494-510)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L512-530)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L532-552)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L554-574)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L576-599)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L601-620)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L622-659)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L661-679)
...
### class `class AutoEvClippingRiskStats` `@dataclass(frozen=True)` (L681-707)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L708-744)
...
### fn `def _border(left, middle, right)` `priv` (L728-730)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L731-734)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L745-761)
...
### fn `def _print_help_section(title)` `priv` (L762-776)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L777-818)
...
### fn `def print_help(version)` (L819-1018)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1173-1191)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1192-1204)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L1205-1221)
...
### fn `def _derive_supported_signed_ev_zero_values(base_max_ev)` `priv` (L1222-1243)
...
### fn `def _derive_supported_ev_values(` `priv` (L1244-1247)

### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1288-1333)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1334-1347)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1348-1379)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1380-1410)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1411-1430)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1431-1453)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1454-1473)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1474-1493)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1494-1514)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1515-1539)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1540-1586)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1587-1600)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1601-1622)
...
### fn `def _floor_ev_to_supported_cap(ev_cap, ev_values)` `priv` (L1623-1642)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1643-1664)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1665-1679)
...
### fn `def _calculate_entropy_optimized_ev(cv2_module, np_module, luminance_float)` `priv` (L2083-2128)
...
### fn `def _calculate_detail_preservation_ev(cv2_module, np_module, luminance_float)` `priv` (L2149-2215)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2216-2253)
...
### fn `def _build_auto_ev_clipping_risk_stats(np_module, base_rgb_float)` `priv` (L2254-2308)
...
### fn `def _estimate_auto_ev_any_channel_clip_fraction(clipping_risk_stats, exposure_ev)` `priv` (L2309-2332)
...
### fn `def _build_joint_auto_ev_regularization_anchors(evaluations, safe_ev_zero_max)` `priv` (L2333-2355)
...
### fn `def _evaluate_joint_auto_ev_candidate(` `priv` (L2356-2363)

### fn `def _optimize_joint_ev_zero_and_delta(` `priv` (L2486-2492)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2555-2563)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2646-2666)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2667-2690)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2691-2714)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2715-2731)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2732-2754)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2755-2779)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2780-2802)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2803-2828)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2829-2860)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2861-2957)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2958-2989)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2990-3053)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L3324-3353)
...
### fn `def _resolve_default_postprocess(` `priv` (L3354-3357)

### fn `def _parse_run_options(args)` `priv` (L3429-3628)
...
### fn `def _load_image_dependencies()` `priv` (L4189-4226)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L4227-4257)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L4258-4320)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L4321-4415)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L4365-4382)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L4416-4447)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L4448-4470)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4471-4472)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4503-4545)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4546-4679)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4680-4686)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4736-4750)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4751-4768)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L4769-4787)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4788-4816)
...
### fn `def _extract_bracket_images_float(` `priv` (L4817-4821)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4855-4880)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4881-4896)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4897-4904)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L4968-4971)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L5005-5024)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L5025-5048)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L5049-5070)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L5071-5075)

### fn `def _run_opencv_merge_radiance(` `priv` (L5104-5111)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L5175-5194)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L5195-5201)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L5262-5290)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L5291-5337)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L5338-5371)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L5372-5392)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L5393-5411)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L5412-5436)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L5437-5455)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L5456-5461)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L5514-5520)

### fn `def _hdrplus_align_layer(` `priv` (L5593-5600)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5690-5777)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5778-5802)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5803-5807)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5888-5894)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5943-6015)
...
### fn `def _run_hdr_plus_merge(` `priv` (L6016-6019)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L6096-6106)
...
### fn `def _collect_missing_external_executables(` `priv` (L6107-6109)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L6128-6153)
...
### fn `def _resolve_numpy_dependency()` `priv` (L6154-6173)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L6174-6205)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L6206-6233)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L6234-6257)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L6258-6263)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L6293-6313)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L6314-6331)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L6332-6336)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L6366-6412)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L6413-6457)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L6458-6483)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L6484-6506)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L6507-6531)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L6532-6561)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6562-6567)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6644-6661)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6662-6679)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6680-6697)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6698-6737)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6738-6783)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6784-6789)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6823-6850)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6851-6889)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6890-6915)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6916-6937)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6938-6985)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6986-7005)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L7006-7044)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L7045-7072)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L7073-7124)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L7125-7177)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L7178-7209)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L7210-7233)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L7234-7283)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L7284-7303)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L7304-7324)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L7325-7341)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L7342-7357)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L7358-7374)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L7375-7390)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L7391-7406)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L7458-7493)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L7494-7526)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L7527-7726)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L7800-7805)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L7849-7948)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L7949-7967)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L7968-7969)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L7999-8045)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L8046-8074)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L8075-8076)

### fn `def _f_lab(values)` `priv` (L8109-8116)
...
### fn `def _f2xyz(values)` `priv` (L8117-8123)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L8159-8160)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L8194-8299)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L8300-8301)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L8336-8358)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L8359-8382)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L8383-8427)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L8428-8429)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L8459-8460)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L8513-8514)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L8556-8559)
...
### fn `def _clamp01(np_module, values)` `priv` (L8616-8629)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L8630-8652)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L8653-8686)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L8687-8717)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L8718-8758)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L8759-8760)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L8809-8831)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L8832-8856)
...
### fn `def logistic(z_values)` (L8847-8849)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L8857-8874)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L8875-8898)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L8899-8922)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L8923-8944)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L8945-8951)

### fn `def _load_piexif_dependency()` `priv` (L9060-9077)
...
### fn `def _encode_jpg(` `priv` (L9078-9089)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L9221-9249)
...
### fn `def _is_supported_runtime_os()` `priv` (L9250-9269)
...
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|93||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|94||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|95||
|`DEFAULT_LUMINANCE_TMO`|var|pub|96||
|`DEFAULT_AUTO_ADJUST_ENABLED`|var|pub|97||
|`HDR_MERGE_MODE_LUMINANCE`|var|pub|98||
|`HDR_MERGE_MODE_OPENCV`|var|pub|99||
|`HDR_MERGE_MODE_HDR_PLUS`|var|pub|100||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|101||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|102||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|103||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|104||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|105||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|106||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|107||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|108||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|109||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|110||
|`DEFAULT_OPENCV_SATURATION`|var|pub|111||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|112||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|113||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|114||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|115||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|116||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|117||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|118||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|119||
|`HDRPLUS_TILE_SIZE`|var|pub|120||
|`HDRPLUS_TILE_STRIDE`|var|pub|121||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|122||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|123||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|124||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|125||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|126||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|127||
|`EV_STEP`|var|pub|129||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|130||
|`DEFAULT_DNG_BITS_PER_COLOR`|var|pub|131||
|`SUPPORTED_EV_VALUES`|var|pub|132||
|`AUTO_EV_LOW_PERCENTILE`|var|pub|138||
|`AUTO_EV_HIGH_PERCENTILE`|var|pub|139||
|`AUTO_EV_MEDIAN_PERCENTILE`|var|pub|140||
|`AUTO_EV_TARGET_SHADOW`|var|pub|141||
|`AUTO_EV_TARGET_HIGHLIGHT`|var|pub|142||
|`AUTO_EV_MEDIAN_TARGET`|var|pub|143||
|`AUTO_EV_PLUS_CLIP_TARGET_FRACTION`|var|pub|144||
|`AUTO_EV_CENTER_CLIP_TARGET_FRACTION`|var|pub|145||
|`AUTO_EV_CLIP_EPS`|var|pub|146||
|`AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD`|var|pub|147||
|`AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD`|var|pub|148||
|`AUTO_ZERO_TARGET_LOW_KEY`|var|pub|149||
|`AUTO_ZERO_TARGET_HIGH_KEY`|var|pub|150||
|`AutoAdjustOptions`|class|pub|364-399|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|401-429|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|431-454|class AutoLevelsOptions|
|`PostprocessOptions`|class|pub|456-492|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|494-510|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|512-530|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|532-552|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|554-574|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|576-599|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|601-620|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|622-659|class JointAutoEvSolution|
|`AutoZeroEvaluation`|class|pub|661-679|class AutoZeroEvaluation|
|`AutoEvClippingRiskStats`|class|pub|681-707|class AutoEvClippingRiskStats|
|`_print_box_table`|fn|priv|708-744|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|728-730|def _border(left, middle, right)|
|`_line`|fn|priv|731-734|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|745-761|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|762-776|def _print_help_section(title)|
|`_print_help_option`|fn|priv|777-818|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|819-1018|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1173-1191|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1192-1204|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|1205-1221|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_signed_ev_zero_values`|fn|priv|1222-1243|def _derive_supported_signed_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1244-1247|def _derive_supported_ev_values(|
|`_detect_dng_bits_per_color`|fn|priv|1288-1333|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1334-1347|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1348-1379|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1380-1410|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1411-1430|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1431-1453|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1454-1473|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1474-1493|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1494-1514|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1515-1539|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1540-1586|def _parse_opencv_options(opencv_raw_values)|
|`_clamp_ev_to_supported`|fn|priv|1587-1600|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1601-1622|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_floor_ev_to_supported_cap`|fn|priv|1623-1642|def _floor_ev_to_supported_cap(ev_cap, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1643-1664|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1665-1679|def _apply_auto_percentage_scaling(ev_value, percentage)|
...
|`_calculate_entropy_optimized_ev`|fn|priv|2083-2128|def _calculate_entropy_optimized_ev(cv2_module, np_module...|
|`_calculate_ettr_ev`|fn|priv|2129-2148|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2149-2215|def _calculate_detail_preservation_ev(cv2_module, np_modu...|
|`_calculate_auto_zero_evaluations`|fn|priv|2216-2253|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_build_auto_ev_clipping_risk_stats`|fn|priv|2254-2308|def _build_auto_ev_clipping_risk_stats(np_module, base_rg...|
|`_estimate_auto_ev_any_channel_clip_fraction`|fn|priv|2309-2332|def _estimate_auto_ev_any_channel_clip_fraction(clipping_...|
|`_build_joint_auto_ev_regularization_anchors`|fn|priv|2333-2355|def _build_joint_auto_ev_regularization_anchors(evaluatio...|
|`_evaluate_joint_auto_ev_candidate`|fn|priv|2356-2363|def _evaluate_joint_auto_ev_candidate(|
|`_optimize_joint_ev_zero_and_delta`|fn|priv|2486-2492|def _optimize_joint_ev_zero_and_delta(|
|`_resolve_joint_auto_ev_solution`|fn|priv|2555-2563|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|2646-2666|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_positive_float_option`|fn|priv|2667-2690|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|2691-2714|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|2715-2731|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2732-2754|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2755-2779|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2780-2802|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2803-2828|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2829-2860|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2861-2957|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2958-2989|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2990-3053|def _parse_auto_levels_options(auto_levels_raw_values)|
...
|`_parse_hdr_merge_option`|fn|priv|3324-3353|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|3354-3357|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|3429-3628|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|4189-4226|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|4227-4257|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|4258-4320|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|4321-4415|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|4365-4382|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|4416-4447|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|4448-4470|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|4471-4472|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|4503-4545|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|4546-4679|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|4680-4686|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|4736-4750|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|4751-4768|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|4769-4787|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|4788-4816|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_extract_bracket_images_float`|fn|priv|4817-4821|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|4855-4880|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|4881-4896|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|4897-4904|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|4968-4971|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|5005-5024|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|5025-5048|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|5049-5070|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_estimate_opencv_camera_response`|fn|priv|5071-5075|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|5104-5111|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|5175-5194|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|5195-5201|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|5262-5290|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|5291-5337|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|5338-5371|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|5372-5392|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|5393-5411|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|5412-5436|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|5437-5455|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|5456-5461|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|5514-5520|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|5593-5600|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|5690-5777|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|5778-5802|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|5803-5807|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|5888-5894|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|5943-6015|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|6016-6019|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|6096-6106|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|6107-6109|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|6128-6153|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|6154-6173|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|6174-6205|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|6206-6233|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|6234-6257|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|6258-6263|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|6293-6313|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|6314-6331|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|6332-6336|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|6366-6412|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|6413-6457|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|6458-6483|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|6484-6506|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|6507-6531|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|6532-6561|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|6562-6567|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|6644-6661|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|6662-6679|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|6680-6697|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|6698-6737|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|6738-6783|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|6784-6789|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|6823-6850|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|6851-6889|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|6890-6915|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|6916-6937|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|6938-6985|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|6986-7005|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|7006-7044|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|7045-7072|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|7073-7124|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|7125-7177|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|7178-7209|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|7210-7233|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|7234-7283|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|7284-7303|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|7304-7324|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|7325-7341|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|7342-7357|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|7358-7374|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|7375-7390|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|7391-7406|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|7458-7493|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|7494-7526|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|7527-7726|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_call_auto_levels_compat_helper`|fn|priv|7800-7805|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|7849-7948|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|7949-7967|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|7968-7969|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|7999-8045|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|8046-8074|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|8075-8076|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|8109-8116|def _f_lab(values)|
|`_f2xyz`|fn|priv|8117-8123|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|8159-8160|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|8194-8299|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|8300-8301|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|8336-8358|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|8359-8382|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|8383-8427|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|8428-8429|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|8459-8460|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|8513-8514|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|8556-8559|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|8616-8629|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|8630-8652|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|8653-8686|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|8687-8717|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|8718-8758|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|8759-8760|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|8809-8831|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|8832-8856|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|8847-8849|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|8857-8874|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|8875-8898|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|8899-8922|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|8923-8944|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|8945-8951|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|9060-9077|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|9078-9089|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|9221-9249|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|9250-9269|def _is_supported_runtime_os()|
|`run`|fn|pub|9270-9469|def run(args)|
