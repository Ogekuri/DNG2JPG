...
# dng2jpg.py | Python | 7637L | 247 symbols | 23 imports | 163 comments
...
- var `DEFAULT_LUMINANCE_HDR_MODEL = "debevec"` (L76)
- var `DEFAULT_LUMINANCE_HDR_WEIGHT = "flat"` (L77)
- var `DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE = "srgb"` (L78)
- var `DEFAULT_LUMINANCE_TMO = "mantiuk08"` (L79)
- var `DEFAULT_AUTO_ADJUST_ENABLED = True` (L80)
- var `HDR_MERGE_MODE_LUMINANCE = "Luminace-HDR"` (L81)
- var `HDR_MERGE_MODE_OPENCV = "OpenCV"` (L82)
- var `HDR_MERGE_MODE_HDR_PLUS = "HDR-Plus"` (L83)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.25` (L84)
- var `DEFAULT_REINHARD02_CONTRAST = 0.85` (L85)
- var `DEFAULT_REINHARD02_SATURATION = 0.55` (L86)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L87)
- var `DEFAULT_OPENCV_POST_GAMMA = 1.1` (L88)
- var `DEFAULT_OPENCV_BRIGHTNESS = 1.05` (L89)
- var `DEFAULT_OPENCV_CONTRAST = 1.3` (L90)
- var `DEFAULT_OPENCV_SATURATION = 1.1` (L91)
- var `DEFAULT_OPENCV_DEBEVEC_WHITE_POINT_PERCENTILE = 99.5` (L92)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L93)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L94)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L95)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L96)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L97)
- var `HDRPLUS_TILE_SIZE = 32` (L98)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L99)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L100)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L101)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L102)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L103)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L104)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L105)
- var `EV_STEP = 0.25` (L107)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L108)
- var `DEFAULT_DNG_BITS_PER_COLOR = 14` (L109)
- var `SUPPORTED_EV_VALUES = tuple(` (L110)
- var `AUTO_EV_LOW_PERCENTILE = 0.1` (L116)
- var `AUTO_EV_HIGH_PERCENTILE = 99.9` (L117)
- var `AUTO_EV_MEDIAN_PERCENTILE = 50.0` (L118)
- var `AUTO_EV_TARGET_SHADOW = 0.05` (L119)
- var `AUTO_EV_TARGET_HIGHLIGHT = 0.90` (L120)
- var `AUTO_EV_MEDIAN_TARGET = 0.5` (L121)
- var `AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD = 0.35` (L122)
- var `AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD = 0.65` (L123)
- var `AUTO_ZERO_TARGET_LOW_KEY = 0.35` (L124)
- var `AUTO_ZERO_TARGET_HIGH_KEY = 0.65` (L125)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L327-362)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L364-392)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L394-417)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L419-453)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L455-475)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L477-492)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L494-517)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L519-538)
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L540-567)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L568-604)
...
### fn `def _border(left, middle, right)` `priv` (L588-590)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L591-594)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L605-621)
...
### fn `def print_help(version)` (L622-821)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L898-916)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L917-929)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L930-946)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L947-975)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L976-1021)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1022-1035)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1036-1067)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1068-1098)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1099-1118)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1119-1138)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1139-1161)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1162-1181)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1182-1201)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1202-1222)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1223-1236)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1237-1258)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1259-1280)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1281-1295)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1296-1355)
...
### fn `def _percentile(percentile_value)` `priv` (L1330-1340)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1356-1375)
...
### fn `def _derive_scene_key_preserving_median_target(p_median)` `priv` (L1376-1394)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L1395-1418)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1419-1448)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1449-1454)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1482-1509)
...
### fn `def _resolve_ev_zero(` `priv` (L1510-1517)

### fn `def _resolve_ev_value(` `priv` (L1568-1575)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1628-1648)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1649-1685)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1686-1709)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L1710-1733)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1734-1750)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1751-1773)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1774-1798)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1799-1821)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1822-1847)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L1848-1879)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L1880-1976)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L1977-2008)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2009-2072)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2073-2222)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2223-2241)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2242-2318)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2319-2342)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2343-2372)
...
### fn `def _resolve_default_postprocess(` `priv` (L2373-2375)

### fn `def _parse_run_options(args)` `priv` (L2428-2627)
...
### fn `def _load_image_dependencies()` `priv` (L3206-3243)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3244-3274)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3275-3332)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3333-3364)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3365-3387)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L3388-3389)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3418-3460)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3461-3594)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L3595-3600)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L3649-3663)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L3664-3680)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L3681-3699)
...
### fn `def _extract_bracket_images_float(raw_handle, np_module, multipliers, gamma_value)` `priv` (L3700-3736)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L3737-3762)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L3763-3778)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L3779-3786)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L3850-3877)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L3878-3912)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L3913-3918)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L3983-4011)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4012-4058)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4059-4092)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4093-4113)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4114-4132)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4133-4157)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4158-4176)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4177-4182)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4235-4241)

### fn `def _hdrplus_align_layer(` `priv` (L4314-4321)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L4411-4498)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L4499-4523)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L4524-4528)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L4609-4615)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L4664-4736)
...
### fn `def _run_hdr_plus_merge(` `priv` (L4737-4740)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L4817-4827)
...
### fn `def _collect_missing_external_executables(` `priv` (L4828-4830)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L4849-4873)
...
### fn `def _resolve_numpy_dependency()` `priv` (L4874-4893)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L4894-4925)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L4926-4953)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L4954-4977)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L4978-4982)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5012-5058)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5059-5103)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5104-5129)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5130-5152)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5153-5177)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5178-5207)
...
### fn `def _apply_static_postprocess_float(np_module, image_rgb_float, postprocess_options)` `priv` (L5208-5247)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L5248-5265)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L5266-5283)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L5284-5301)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L5302-5341)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L5342-5387)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L5388-5393)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L5427-5454)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L5455-5493)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L5494-5519)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L5520-5541)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L5542-5589)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L5590-5609)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L5610-5648)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L5649-5676)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L5677-5728)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L5729-5781)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L5782-5813)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L5814-5837)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L5838-5887)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L5888-5907)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L5908-5928)
...
### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L5929-5962)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L5963-5990)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L5991-6190)
...
### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L6245-6326)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6327-6345)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6346-6391)
...
### fn `def _hlrecovery_cielab_uint16(` `priv` (L6392-6393)

### fn `def _f_lab(values)` `priv` (L6426-6433)
...
### fn `def _f2xyz(values)` `priv` (L6434-6440)

### fn `def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax, maxval=65535.0)` `priv` (L6476-6578)
...
### fn `def _dilate_mask_uint16(np_module, mask)` `priv` (L6579-6601)
...
### fn `def _box_mean_3x3_uint16(np_module, image_2d)` `priv` (L6602-6625)
...
### fn `def _hlrecovery_color_propagation_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6626-6670)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L6671-6672)

### fn `def _apply_auto_brightness_rgb_float(` `priv` (L6725-6728)
...
### fn `def _clamp01(np_module, values)` `priv` (L6785-6798)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L6799-6821)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L6822-6855)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L6856-6886)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L6887-6927)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L6928-6929)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L6978-7000)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L7001-7025)
...
### fn `def logistic(z_values)` (L7016-7018)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L7026-7043)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L7044-7067)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L7068-7091)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L7092-7113)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L7114-7118)

### fn `def _load_piexif_dependency()` `priv` (L7175-7192)
...
### fn `def _encode_jpg(` `priv` (L7193-7203)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L7297-7325)
...
### fn `def _is_supported_runtime_os()` `priv` (L7326-7345)
...
|`DEFAULT_LUMINANCE_HDR_MODEL`|var|pub|76||
|`DEFAULT_LUMINANCE_HDR_WEIGHT`|var|pub|77||
|`DEFAULT_LUMINANCE_HDR_RESPONSE_CURVE`|var|pub|78||
|`DEFAULT_LUMINANCE_TMO`|var|pub|79||
|`DEFAULT_AUTO_ADJUST_ENABLED`|var|pub|80||
|`HDR_MERGE_MODE_LUMINANCE`|var|pub|81||
|`HDR_MERGE_MODE_OPENCV`|var|pub|82||
|`HDR_MERGE_MODE_HDR_PLUS`|var|pub|83||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|84||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|85||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|86||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|87||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|88||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|89||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|90||
|`DEFAULT_OPENCV_SATURATION`|var|pub|91||
|`DEFAULT_OPENCV_DEBEVEC_WHITE_POINT_PERCENTILE`|var|pub|92||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|93||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|94||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|95||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|96||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|97||
|`HDRPLUS_TILE_SIZE`|var|pub|98||
|`HDRPLUS_TILE_STRIDE`|var|pub|99||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|100||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|101||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|102||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|103||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|104||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|105||
|`EV_STEP`|var|pub|107||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|108||
|`DEFAULT_DNG_BITS_PER_COLOR`|var|pub|109||
|`SUPPORTED_EV_VALUES`|var|pub|110||
|`AUTO_EV_LOW_PERCENTILE`|var|pub|116||
|`AUTO_EV_HIGH_PERCENTILE`|var|pub|117||
|`AUTO_EV_MEDIAN_PERCENTILE`|var|pub|118||
|`AUTO_EV_TARGET_SHADOW`|var|pub|119||
|`AUTO_EV_TARGET_HIGHLIGHT`|var|pub|120||
|`AUTO_EV_MEDIAN_TARGET`|var|pub|121||
|`AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD`|var|pub|122||
|`AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD`|var|pub|123||
|`AUTO_ZERO_TARGET_LOW_KEY`|var|pub|124||
|`AUTO_ZERO_TARGET_HIGH_KEY`|var|pub|125||
|`AutoAdjustOptions`|class|pub|327-362|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|364-392|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|394-417|class AutoLevelsOptions|
|`PostprocessOptions`|class|pub|419-453|class PostprocessOptions|
|`LuminanceOptions`|class|pub|455-475|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|477-492|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|494-517|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|519-538|class HdrPlusTemporalRuntimeOptions|
|`AutoEvInputs`|class|pub|540-567|class AutoEvInputs|
|`_print_box_table`|fn|priv|568-604|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|588-590|def _border(left, middle, right)|
|`_line`|fn|priv|591-594|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|605-621|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|622-821|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|898-916|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|917-929|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|930-946|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|947-975|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|976-1021|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1022-1035|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1036-1067|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1068-1098|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1099-1118|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1119-1138|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1139-1161|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1162-1181|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1182-1201|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1202-1222|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_clamp_ev_to_supported`|fn|priv|1223-1236|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1237-1258|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1259-1280|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1281-1295|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1296-1355|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1330-1340|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|1356-1375|def _coerce_positive_luminance(value, fallback)|
|`_derive_scene_key_preserving_median_target`|fn|priv|1376-1394|def _derive_scene_key_preserving_median_target(p_median)|
|`_optimize_auto_zero`|fn|priv|1395-1418|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|1419-1448|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1449-1454|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1482-1509|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1510-1517|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1568-1575|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1628-1648|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1649-1685|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1686-1709|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|1710-1733|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1734-1750|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1751-1773|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1774-1798|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1799-1821|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1822-1847|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|1848-1879|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|1880-1976|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|1977-2008|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2009-2072|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2073-2222|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|2223-2241|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|2242-2318|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|2319-2342|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_hdr_merge_option`|fn|priv|2343-2372|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|2373-2375|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|2428-2627|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3206-3243|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3244-3274|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|3275-3332|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|3333-3364|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|3365-3387|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|3388-3389|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|3418-3460|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|3461-3594|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|3595-3600|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|3649-3663|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|3664-3680|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|3681-3699|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_extract_bracket_images_float`|fn|priv|3700-3736|def _extract_bracket_images_float(raw_handle, np_module, ...|
|`_order_bracket_paths`|fn|priv|3737-3762|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|3763-3778|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|3779-3786|def _run_luminance_hdr_cli(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|3850-3877|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|3878-3912|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|3913-3918|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|3983-4011|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4012-4058|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4059-4092|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4093-4113|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4114-4132|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|4133-4157|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|4158-4176|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|4177-4182|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|4235-4241|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|4314-4321|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|4411-4498|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|4499-4523|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|4524-4528|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|4609-4615|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|4664-4736|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|4737-4740|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|4817-4827|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|4828-4830|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|4849-4873|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|4874-4893|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|4894-4925|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|4926-4953|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|4954-4977|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_materialize_bracket_tiffs_from_float`|fn|priv|4978-4982|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5012-5058|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|5059-5103|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|5104-5129|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|5130-5152|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|5153-5177|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|5178-5207|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|5208-5247|def _apply_static_postprocess_float(np_module, image_rgb_...|
|`_to_linear_srgb`|fn|priv|5248-5265|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|5266-5283|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|5284-5301|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|5302-5341|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|5342-5387|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|5388-5393|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|5427-5454|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|5455-5493|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|5494-5519|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|5520-5541|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|5542-5589|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|5590-5609|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|5610-5648|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|5649-5676|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|5677-5728|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|5729-5781|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|5782-5813|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|5814-5837|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|5838-5887|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|5888-5907|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|5908-5928|def _rt_igamma2(np_module, values)|
|`_build_autoexp_histogram_rgb_float`|fn|priv|5929-5962|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|5963-5990|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|5991-6190|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_apply_auto_levels_float`|fn|priv|6245-6326|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|6327-6345|def _clip_auto_levels_out_of_gamut_uint16(np_module, imag...|
|`_hlrecovery_luminance_uint16`|fn|priv|6346-6391|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_uint16`|fn|priv|6392-6393|def _hlrecovery_cielab_uint16(|
|`_f_lab`|fn|priv|6426-6433|def _f_lab(values)|
|`_f2xyz`|fn|priv|6434-6440|def _f2xyz(values)|
|`_hlrecovery_blend_uint16`|fn|priv|6476-6578|def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax,...|
|`_dilate_mask_uint16`|fn|priv|6579-6601|def _dilate_mask_uint16(np_module, mask)|
|`_box_mean_3x3_uint16`|fn|priv|6602-6625|def _box_mean_3x3_uint16(np_module, image_2d)|
|`_hlrecovery_color_propagation_uint16`|fn|priv|6626-6670|def _hlrecovery_color_propagation_uint16(np_module, image...|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|6671-6672|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|6725-6728|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|6785-6798|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|6799-6821|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|6822-6855|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|6856-6886|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|6887-6927|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|6928-6929|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|6978-7000|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|7001-7025|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|7016-7018|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|7026-7043|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|7044-7067|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|7068-7091|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|7092-7113|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|7114-7118|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|7175-7192|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|7193-7203|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|7297-7325|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|7326-7345|def _is_supported_runtime_os()|
|`run`|fn|pub|7346-7545|def run(args)|
