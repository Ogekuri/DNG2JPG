...
# dng2jpg.py | Python | 9966L | 281 symbols | 24 imports | 200 comments
...
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L140)
- var `DEFAULT_DNG_BITS_PER_COLOR = 14` (L141)
- var `SUPPORTED_EV_VALUES = tuple(` (L142)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L510-528)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L530-550)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L552-572)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L574-597)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L599-618)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L651-687)
...
### fn `def _border(left, middle, right)` `priv` (L671-673)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L674-677)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L688-704)
...
### fn `def _print_help_section(title)` `priv` (L705-719)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L720-761)
...
### fn `def print_help(version)` (L762-961)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1120-1138)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1139-1151)
...
### fn `def _derive_supported_ev_values(` `priv` (L1152-1155)

### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1196-1241)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1242-1255)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1256-1287)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1288-1318)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1319-1338)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1339-1358)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1359-1378)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1379-1399)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1400-1424)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1425-1471)
...
### fn `def _quantize_ev_to_resolution(ev_value, resolution)` `priv` (L1472-1488)
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module, rawpy_module)` `priv` (L1489-1523)
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L1524-1542)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L1543-1574)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L1575-1624)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L1625-1673)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L1674-1694)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L1695-1725)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L1726-1753)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L1754-1775)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1776-1798)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1799-1817)
...
### fn `def _compute_histogram_ev_corrections(np_module, cv2_module, base_rgb_float)` `priv` (L1818-1935)
...
### fn `def _smoothstep(x, edge0, edge1)` `priv` (L1903-1907)
- @brief Compute EV corrections from three histogram analysis methods.
...
### fn `def _analyze_auto_ev_bracket_quality(` `priv` (L1936-1940)

### fn `def _resolve_auto_ev_bracket_amplitude(` `priv` (L2018-2023)
...
### fn `def _resolve_auto_ev_histogram_solution(` `priv` (L2104-2105)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2183-2203)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2204-2227)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2228-2251)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2252-2268)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2269-2291)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2292-2316)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2317-2339)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2340-2365)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2366-2397)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2398-2494)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2495-2526)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2527-2599)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2600-2749)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2750-2768)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2769-2845)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2846-2869)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2870-2899)
...
### fn `def _resolve_default_postprocess(` `priv` (L2900-2903)

### fn `def _parse_run_options(args)` `priv` (L2975-3174)
...
### fn `def _load_image_dependencies()` `priv` (L3719-3756)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3757-3787)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L3788-3850)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3851-3945)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L3895-3912)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3946-3977)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3978-4000)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4001-4002)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4033-4075)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4076-4209)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4210-4216)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4266-4280)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4281-4298)
...
### fn `def _build_exposure_multipliers(ev_minus, ev_zero, ev_plus)` `priv` (L4299-4318)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4319-4347)
...
### fn `def _extract_bracket_images_float(` `priv` (L4348-4353)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4388-4413)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4414-4429)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4430-4437)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L4501-4504)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4538-4557)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4558-4581)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L4582-4603)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L4604-4608)

### fn `def _run_opencv_merge_radiance(` `priv` (L4637-4644)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4708-4727)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4728-4734)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4795-4823)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4824-4870)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4871-4904)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4905-4925)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4926-4944)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4945-4969)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4970-4988)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4989-4994)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L5047-5053)

### fn `def _hdrplus_align_layer(` `priv` (L5126-5133)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5223-5310)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5311-5335)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5336-5340)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5421-5427)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5476-5548)
...
### fn `def _run_hdr_plus_merge(` `priv` (L5549-5552)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5629-5639)
...
### fn `def _collect_missing_external_executables(` `priv` (L5640-5642)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5661-5686)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5687-5706)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5707-5738)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5739-5766)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5767-5790)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L5791-5796)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L5826-5846)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L5847-5864)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5865-5869)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5899-5945)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5946-5990)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5991-6016)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L6017-6039)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L6040-6064)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L6065-6094)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6095-6100)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6177-6194)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6195-6212)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6213-6230)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6231-6270)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6271-6316)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6317-6322)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6356-6383)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6384-6422)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6423-6448)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6449-6470)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6471-6518)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6519-6538)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L6539-6577)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L6578-6605)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L6606-6657)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L6658-6710)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6711-6742)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6743-6766)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6767-6816)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6817-6836)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6837-6857)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6858-6874)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6875-6890)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6891-6907)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6908-6923)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6924-6939)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L6991-7026)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L7027-7059)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L7060-7259)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L7333-7425)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L7346-7362)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L7363-7365)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L7366-7385)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L7386-7388)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L7389-7400)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L7426-7559)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L7560-7566)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L7598-7629)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L7630-7660)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L7661-7850)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L7851-7854)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L7938-7961)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L7962-7967)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L8011-8117)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L8118-8278)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L8148-8181)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L8279-8280)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L8310-8356)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L8357-8385)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L8386-8387)

### fn `def _f_lab(values)` `priv` (L8420-8427)
...
### fn `def _f2xyz(values)` `priv` (L8428-8434)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L8470-8471)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L8505-8610)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L8611-8612)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L8647-8669)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L8670-8693)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L8694-8738)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L8739-8740)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L8770-8771)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L8824-8825)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L8867-8870)
...
### fn `def _clamp01(np_module, values)` `priv` (L8927-8940)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L8941-8963)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L8964-8997)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L8998-9028)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L9029-9069)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L9070-9071)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L9120-9142)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L9143-9167)
...
### fn `def logistic(z_values)` (L9158-9160)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L9168-9185)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L9186-9209)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L9210-9233)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L9234-9255)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L9256-9262)

### fn `def _load_piexif_dependency()` `priv` (L9371-9388)
...
### fn `def _encode_jpg(` `priv` (L9389-9400)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L9532-9560)
...
### fn `def _is_supported_runtime_os()` `priv` (L9561-9580)
...
|`EV_STEP`|var|pub|134||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|140||
|`DEFAULT_DNG_BITS_PER_COLOR`|var|pub|141||
|`SUPPORTED_EV_VALUES`|var|pub|142||
...
|`SourceGammaInfo`|class|pub|510-528|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|530-550|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|552-572|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|574-597|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|599-618|class HdrPlusTemporalRuntimeOptions|
|`AutoEvHistogramSolution`|class|pub|620-650|class AutoEvHistogramSolution|
|`_print_box_table`|fn|priv|651-687|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|671-673|def _border(left, middle, right)|
|`_line`|fn|priv|674-677|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|688-704|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|705-719|def _print_help_section(title)|
|`_print_help_option`|fn|priv|720-761|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|762-961|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1120-1138|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1139-1151|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1152-1155|def _derive_supported_ev_values(|
|`_detect_dng_bits_per_color`|fn|priv|1196-1241|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1242-1255|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1256-1287|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1288-1318|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1319-1338|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_brightness_option`|fn|priv|1339-1358|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1359-1378|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1379-1399|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1400-1424|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1425-1471|def _parse_opencv_options(opencv_raw_values)|
|`_quantize_ev_to_resolution`|fn|priv|1472-1488|def _quantize_ev_to_resolution(ev_value, resolution)|
|`_extract_base_rgb_linear_float`|fn|priv|1489-1523|def _extract_base_rgb_linear_float(raw_handle, np_module,...|
|`_normalize_source_gamma_label`|fn|priv|1524-1542|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|1543-1574|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|1575-1624|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|1625-1673|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|1674-1694|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|1695-1725|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|1726-1753|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|1754-1775|def _describe_source_gamma_info(source_gamma_info)|
|`_calculate_bt709_luminance`|fn|priv|1776-1798|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|1799-1817|def _smoothstep(np_module, values, edge0, edge1)|
|`_compute_histogram_ev_corrections`|fn|priv|1818-1935|def _compute_histogram_ev_corrections(np_module, cv2_modu...|
|`_smoothstep`|fn|priv|1903-1907|def _smoothstep(x, edge0, edge1)|
|`_analyze_auto_ev_bracket_quality`|fn|priv|1936-1940|def _analyze_auto_ev_bracket_quality(|
|`_resolve_auto_ev_bracket_amplitude`|fn|priv|2018-2023|def _resolve_auto_ev_bracket_amplitude(|
|`_resolve_auto_ev_histogram_solution`|fn|priv|2104-2105|def _resolve_auto_ev_histogram_solution(|
|`_parse_luminance_text_option`|fn|priv|2183-2203|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_positive_float_option`|fn|priv|2204-2227|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|2228-2251|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|2252-2268|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2269-2291|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2292-2316|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2317-2339|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2340-2365|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2366-2397|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2398-2494|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2495-2526|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2527-2599|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2600-2749|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|2750-2768|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|2769-2845|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|2846-2869|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_hdr_merge_option`|fn|priv|2870-2899|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|2900-2903|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|2975-3174|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3719-3756|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3757-3787|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|3788-3850|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|3851-3945|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|3895-3912|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|3946-3977|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|3978-4000|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|4001-4002|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|4033-4075|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|4076-4209|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|4210-4216|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|4266-4280|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|4281-4298|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|4299-4318|def _build_exposure_multipliers(ev_minus, ev_zero, ev_plus)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|4319-4347|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_extract_bracket_images_float`|fn|priv|4348-4353|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|4388-4413|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|4414-4429|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|4430-4437|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|4501-4504|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|4538-4557|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|4558-4581|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|4582-4603|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_estimate_opencv_camera_response`|fn|priv|4604-4608|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|4637-4644|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|4708-4727|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|4728-4734|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|4795-4823|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4824-4870|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4871-4904|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4905-4925|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4926-4944|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|4945-4969|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|4970-4988|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|4989-4994|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|5047-5053|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|5126-5133|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|5223-5310|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|5311-5335|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|5336-5340|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|5421-5427|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|5476-5548|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|5549-5552|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|5629-5639|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|5640-5642|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|5661-5686|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|5687-5706|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|5707-5738|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|5739-5766|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|5767-5790|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|5791-5796|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|5826-5846|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|5847-5864|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|5865-5869|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5899-5945|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|5946-5990|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|5991-6016|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|6017-6039|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|6040-6064|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|6065-6094|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|6095-6100|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|6177-6194|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|6195-6212|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|6213-6230|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|6231-6270|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|6271-6316|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|6317-6322|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|6356-6383|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|6384-6422|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|6423-6448|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|6449-6470|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|6471-6518|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|6519-6538|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|6539-6577|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|6578-6605|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|6606-6657|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|6658-6710|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|6711-6742|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|6743-6766|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|6767-6816|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|6817-6836|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|6837-6857|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|6858-6874|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|6875-6890|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|6891-6907|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|6908-6923|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|6924-6939|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|6991-7026|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|7027-7059|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|7060-7259|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|7333-7425|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|7346-7362|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|7363-7365|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|7366-7385|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|7386-7388|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|7389-7400|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|7426-7559|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|7560-7566|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|7598-7629|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|7630-7660|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_build_auto_levels_tone_curve_state`|fn|priv|7661-7850|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|7851-7854|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|7938-7961|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|7962-7967|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|8011-8117|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|8118-8278|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|8148-8181|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|8279-8280|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|8310-8356|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|8357-8385|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|8386-8387|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|8420-8427|def _f_lab(values)|
|`_f2xyz`|fn|priv|8428-8434|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|8470-8471|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|8505-8610|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|8611-8612|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|8647-8669|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|8670-8693|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|8694-8738|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|8739-8740|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|8770-8771|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|8824-8825|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|8867-8870|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|8927-8940|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|8941-8963|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|8964-8997|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|8998-9028|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|9029-9069|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|9070-9071|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|9120-9142|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|9143-9167|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|9158-9160|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|9168-9185|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|9186-9209|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|9210-9233|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|9234-9255|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|9256-9262|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|9371-9388|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|9389-9400|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|9532-9560|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|9561-9580|def _is_supported_runtime_os()|
|`run`|fn|pub|9581-9780|def run(args)|
