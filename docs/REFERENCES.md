...
# dng2jpg.py | Python | 7451L | 239 symbols | 23 imports | 154 comments
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L495-517)
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L519-546)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L547-583)
...
### fn `def _border(left, middle, right)` `priv` (L567-569)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L570-573)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L584-600)
...
### fn `def print_help(version)` (L601-800)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L877-895)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L896-908)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L909-925)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L926-954)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L955-1000)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1001-1014)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1015-1046)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1047-1077)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1078-1097)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1098-1117)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1118-1140)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1141-1160)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1161-1180)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1181-1201)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1202-1215)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1216-1237)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1238-1259)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1260-1274)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1275-1334)
...
### fn `def _percentile(percentile_value)` `priv` (L1309-1319)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1335-1354)
...
### fn `def _derive_scene_key_preserving_median_target(p_median)` `priv` (L1355-1373)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L1374-1397)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1398-1427)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1428-1433)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1461-1488)
...
### fn `def _resolve_ev_zero(` `priv` (L1489-1496)

### fn `def _resolve_ev_value(` `priv` (L1547-1554)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1607-1627)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1628-1664)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1665-1688)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L1689-1712)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1713-1729)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1730-1752)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1753-1777)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1778-1800)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1801-1826)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L1827-1858)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L1859-1955)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L1956-1987)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L1988-2051)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2052-2201)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2322-2352)
...
### fn `def _resolve_default_postprocess(` `priv` (L2353-2355)

### fn `def _parse_run_options(args)` `priv` (L2408-2607)
...
### fn `def _load_image_dependencies()` `priv` (L3192-3229)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3230-3260)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3261-3318)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3319-3350)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3351-3373)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L3374-3375)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3404-3446)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3447-3580)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L3581-3586)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L3635-3649)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L3650-3666)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L3667-3685)
...
### fn `def _extract_bracket_images_float(raw_handle, np_module, multipliers, gamma_value)` `priv` (L3686-3722)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L3723-3748)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L3749-3764)
...
### fn `def _run_enfuse(bracket_images_float, temp_dir, imageio_module, np_module)` `priv` (L3765-3802)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L3803-3810)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L3874-3901)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L3902-3936)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L3937-3942)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4007-4035)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4036-4082)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_uint16, hdrplus_options)` `priv` (L4083-4115)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4116-4136)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4137-4155)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4156-4180)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4181-4199)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4200-4205)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4258-4264)

### fn `def _hdrplus_align_layer(` `priv` (L4337-4344)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L4434-4521)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L4522-4526)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L4599-4605)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L4654-4724)
...
### fn `def _run_hdr_plus_merge(` `priv` (L4725-4728)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L4808-4820)
...
### fn `def _resolve_imagemagick_command()` `priv` (L4821-4838)
...
### fn `def _collect_missing_external_executables(` `priv` (L4839-4844)

### fn `def _resolve_auto_adjust_opencv_dependencies()` `priv` (L4872-4896)
...
### fn `def _resolve_numpy_dependency()` `priv` (L4897-4916)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L4917-4948)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L4949-4976)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L4977-5000)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5001-5005)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5035-5081)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5082-5126)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5127-5152)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5153-5175)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5176-5200)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5201-5230)
...
### fn `def _apply_static_postprocess_float(np_module, image_rgb_float, postprocess_options)` `priv` (L5231-5270)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L5271-5288)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L5289-5306)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L5307-5324)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L5325-5364)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L5365-5410)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L5411-5416)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L5450-5477)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L5478-5516)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L5517-5565)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L5566-5585)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L5586-5606)
...
### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L5607-5640)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L5641-5668)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L5669-5868)
...
### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L5923-6004)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6005-6023)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6024-6069)
...
### fn `def _hlrecovery_cielab_uint16(` `priv` (L6070-6071)

### fn `def _f_lab(values)` `priv` (L6104-6111)
...
### fn `def _f2xyz(values)` `priv` (L6112-6118)

### fn `def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax, maxval=65535.0)` `priv` (L6154-6256)
...
### fn `def _dilate_mask_uint16(np_module, mask)` `priv` (L6257-6279)
...
### fn `def _box_mean_3x3_uint16(np_module, image_2d)` `priv` (L6280-6303)
...
### fn `def _hlrecovery_color_propagation_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L6304-6348)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L6349-6350)

### fn `def _apply_auto_brightness_rgb_float(` `priv` (L6403-6406)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L6463-6469)
...
### fn `def _clamp01(np_module, values)` `priv` (L6552-6565)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L6566-6588)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L6589-6622)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L6623-6653)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L6654-6694)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L6695-6696)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L6745-6767)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L6768-6792)
...
### fn `def logistic(z_values)` (L6783-6785)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L6793-6810)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L6811-6834)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L6835-6858)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L6859-6880)
...
### fn `def _apply_validated_auto_adjust_pipeline_opencv(` `priv` (L6881-6885)

### fn `def _load_piexif_dependency()` `priv` (L6942-6959)
...
### fn `def _encode_jpg(` `priv` (L6960-6971)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L7092-7120)
...
### fn `def _is_supported_runtime_os()` `priv` (L7121-7140)
...
|`HdrPlusOptions`|class|pub|495-517|class HdrPlusOptions|
|`AutoEvInputs`|class|pub|519-546|class AutoEvInputs|
|`_print_box_table`|fn|priv|547-583|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|567-569|def _border(left, middle, right)|
|`_line`|fn|priv|570-573|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|584-600|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|601-800|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|877-895|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|896-908|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|909-925|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|926-954|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|955-1000|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1001-1014|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1015-1046|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1047-1077|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1078-1097|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1098-1117|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1118-1140|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1141-1160|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1161-1180|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1181-1201|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_clamp_ev_to_supported`|fn|priv|1202-1215|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1216-1237|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1238-1259|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1260-1274|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1275-1334|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1309-1319|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|1335-1354|def _coerce_positive_luminance(value, fallback)|
|`_derive_scene_key_preserving_median_target`|fn|priv|1355-1373|def _derive_scene_key_preserving_median_target(p_median)|
|`_optimize_auto_zero`|fn|priv|1374-1397|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|1398-1427|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1428-1433|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1461-1488|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1489-1496|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1547-1554|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1607-1627|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1628-1664|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1665-1688|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|1689-1712|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1713-1729|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1730-1752|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1753-1777|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1778-1800|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1801-1826|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|1827-1858|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|1859-1955|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|1956-1987|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|1988-2051|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2052-2201|def _parse_auto_adjust_options(auto_adjust_raw_values)|
...
|`_parse_hdr_merge_option`|fn|priv|2322-2352|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|2353-2355|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|2408-2607|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3192-3229|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3230-3260|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|3261-3318|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|3319-3350|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|3351-3373|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|3374-3375|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|3404-3446|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|3447-3580|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|3581-3586|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|3635-3649|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|3650-3666|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|3667-3685|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_extract_bracket_images_float`|fn|priv|3686-3722|def _extract_bracket_images_float(raw_handle, np_module, ...|
|`_order_bracket_paths`|fn|priv|3723-3748|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|3749-3764|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_enfuse`|fn|priv|3765-3802|def _run_enfuse(bracket_images_float, temp_dir, imageio_m...|
|`_run_luminance_hdr_cli`|fn|priv|3803-3810|def _run_luminance_hdr_cli(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|3874-3901|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|3902-3936|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|3937-3942|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|4007-4035|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4036-4082|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4083-4115|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4116-4136|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4137-4155|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|4156-4180|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|4181-4199|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|4200-4205|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|4258-4264|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|4337-4344|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|4434-4521|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_compute_temporal_weights`|fn|priv|4522-4526|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|4599-4605|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|4654-4724|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|4725-4728|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|4808-4820|def _convert_compression_to_quality(jpg_compression)|
|`_resolve_imagemagick_command`|fn|priv|4821-4838|def _resolve_imagemagick_command()|
|`_collect_missing_external_executables`|fn|priv|4839-4844|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_opencv_dependencies`|fn|priv|4872-4896|def _resolve_auto_adjust_opencv_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|4897-4916|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|4917-4948|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|4949-4976|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|4977-5000|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_materialize_bracket_tiffs_from_float`|fn|priv|5001-5005|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5035-5081|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|5082-5126|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|5127-5152|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|5153-5175|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|5176-5200|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|5201-5230|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|5231-5270|def _apply_static_postprocess_float(np_module, image_rgb_...|
|`_to_linear_srgb`|fn|priv|5271-5288|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|5289-5306|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|5307-5324|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|5325-5364|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|5365-5410|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|5411-5416|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|5450-5477|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|5478-5516|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_apply_clahe_luma_rgb_float`|fn|priv|5517-5565|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|5566-5585|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|5586-5606|def _rt_igamma2(np_module, values)|
|`_build_autoexp_histogram_rgb_float`|fn|priv|5607-5640|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|5641-5668|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|5669-5868|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_apply_auto_levels_float`|fn|priv|5923-6004|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|6005-6023|def _clip_auto_levels_out_of_gamut_uint16(np_module, imag...|
|`_hlrecovery_luminance_uint16`|fn|priv|6024-6069|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_uint16`|fn|priv|6070-6071|def _hlrecovery_cielab_uint16(|
|`_f_lab`|fn|priv|6104-6111|def _f_lab(values)|
|`_f2xyz`|fn|priv|6112-6118|def _f2xyz(values)|
|`_hlrecovery_blend_uint16`|fn|priv|6154-6256|def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax,...|
|`_dilate_mask_uint16`|fn|priv|6257-6279|def _dilate_mask_uint16(np_module, mask)|
|`_box_mean_3x3_uint16`|fn|priv|6280-6303|def _box_mean_3x3_uint16(np_module, image_2d)|
|`_hlrecovery_color_propagation_uint16`|fn|priv|6304-6348|def _hlrecovery_color_propagation_uint16(np_module, image...|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|6349-6350|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|6403-6406|def _apply_auto_brightness_rgb_float(|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|6463-6469|def _apply_validated_auto_adjust_pipeline(|
|`_clamp01`|fn|priv|6552-6565|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|6566-6588|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|6589-6622|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|6623-6653|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|6654-6694|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|6695-6696|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|6745-6767|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|6768-6792|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|6783-6785|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|6793-6810|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|6811-6834|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|6835-6858|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|6859-6880|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline_opencv`|fn|priv|6881-6885|def _apply_validated_auto_adjust_pipeline_opencv(|
|`_load_piexif_dependency`|fn|priv|6942-6959|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|6960-6971|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|7092-7120|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|7121-7140|def _is_supported_runtime_os()|
|`run`|fn|pub|7141-7340|def run(args)|
