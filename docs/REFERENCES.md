...
# dng2jpg.py | Python | 8312L | 269 symbols | 23 imports | 180 comments
...
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L98)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L99)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L100)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.25` (L101)
- var `DEFAULT_REINHARD02_CONTRAST = 0.85` (L102)
- var `DEFAULT_REINHARD02_SATURATION = 0.55` (L103)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L104)
- var `DEFAULT_OPENCV_POST_GAMMA = 1.0` (L105)
- var `DEFAULT_OPENCV_BRIGHTNESS = 1.0` (L106)
- var `DEFAULT_OPENCV_CONTRAST = 1.0` (L107)
- var `DEFAULT_OPENCV_SATURATION = 1.0` (L108)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_ROBERTSON` (L109)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L110)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = 1.0` (L111)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L112)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L113)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L114)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L115)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L116)
- var `HDRPLUS_TILE_SIZE = 32` (L117)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L118)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L119)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L120)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L121)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L122)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L123)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L124)
- var `EV_STEP = 0.25` (L126)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L127)
- var `DEFAULT_DNG_BITS_PER_COLOR = 14` (L128)
- var `SUPPORTED_EV_VALUES = tuple(` (L129)
- var `AUTO_EV_LOW_PERCENTILE = 0.1` (L135)
- var `AUTO_EV_HIGH_PERCENTILE = 99.9` (L136)
- var `AUTO_EV_MEDIAN_PERCENTILE = 50.0` (L137)
- var `AUTO_EV_TARGET_SHADOW = 0.05` (L138)
- var `AUTO_EV_TARGET_HIGHLIGHT = 0.90` (L139)
- var `AUTO_EV_MEDIAN_TARGET = 0.5` (L140)
- var `AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD = 0.35` (L141)
- var `AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD = 0.65` (L142)
- var `AUTO_ZERO_TARGET_LOW_KEY = 0.35` (L143)
- var `AUTO_ZERO_TARGET_HIGH_KEY = 0.65` (L144)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L356-391)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L393-421)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L423-446)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L448-482)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L484-504)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L506-525)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L527-550)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L552-571)
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L573-600)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L601-637)
...
### fn `def _border(left, middle, right)` `priv` (L621-623)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L624-627)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L638-654)
...
### fn `def print_help(version)` (L655-854)
- @brief Print help text for the `dng2jpg` command.
- @details Documents required positional arguments, required mutually exclusive exposure selectors (`--ev` or `--auto-ev`), optional RAW gamma controls, optional `--ev-zero` and `--auto-zero` selectors, shared postprocessing controls, backend selection including OpenCV algorithm and tone-map knobs, HDR+ controls, and luminance-hdr-cli tone-mapping options.
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L949-967)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L968-980)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L981-997)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L998-1026)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1027-1072)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1073-1086)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1087-1118)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1119-1149)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1150-1169)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1170-1189)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1190-1212)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1213-1232)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1233-1252)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1253-1273)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1274-1298)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1299-1345)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1346-1359)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1360-1381)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1382-1403)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1404-1418)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1419-1478)
...
### fn `def _percentile(percentile_value)` `priv` (L1453-1463)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1479-1498)
...
### fn `def _derive_scene_key_preserving_median_target(p_median)` `priv` (L1499-1517)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L1518-1541)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1542-1571)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1572-1577)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1605-1632)
...
### fn `def _resolve_ev_zero(` `priv` (L1633-1640)

### fn `def _resolve_ev_value(` `priv` (L1691-1698)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1751-1771)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1772-1808)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1809-1832)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L1833-1856)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1857-1873)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1874-1896)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1897-1921)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1922-1944)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1945-1970)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L1971-2002)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2003-2099)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2100-2131)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2132-2195)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2196-2345)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2346-2364)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2365-2441)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2442-2465)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2466-2495)
...
### fn `def _resolve_default_postprocess(` `priv` (L2496-2498)

### fn `def _parse_run_options(args)` `priv` (L2551-2750)
...
### fn `def _load_image_dependencies()` `priv` (L3359-3396)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3397-3427)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3428-3485)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3486-3517)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3518-3540)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L3541-3542)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3571-3613)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3614-3747)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L3748-3753)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L3802-3816)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L3817-3833)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L3834-3852)
...
### fn `def _extract_bracket_images_float(raw_handle, np_module, multipliers, gamma_value)` `priv` (L3853-3889)
...
### fn `def _order_bracket_paths(bracket_paths)` `priv` (L3890-3915)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L3916-3931)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L3932-3939)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4003-4032)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4033-4056)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_uint8)` `priv` (L4057-4076)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L4077-4084)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4135-4154)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4155-4160)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4220-4248)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4249-4295)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4296-4329)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4330-4350)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4351-4369)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4370-4394)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4395-4413)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4414-4419)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4472-4478)

### fn `def _hdrplus_align_layer(` `priv` (L4551-4558)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L4648-4735)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L4736-4760)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L4761-4765)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L4846-4852)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L4901-4973)
...
### fn `def _run_hdr_plus_merge(` `priv` (L4974-4977)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5054-5064)
...
### fn `def _collect_missing_external_executables(` `priv` (L5065-5067)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5086-5110)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5111-5130)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5131-5162)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5163-5190)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5191-5214)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5215-5219)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5249-5295)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5296-5340)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5341-5366)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5367-5389)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5390-5414)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5415-5444)
...
### fn `def _apply_static_postprocess_float(np_module, image_rgb_float, postprocess_options)` `priv` (L5445-5484)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L5485-5502)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L5503-5520)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L5521-5538)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L5539-5578)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L5579-5624)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L5625-5630)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L5664-5691)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L5692-5730)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L5731-5756)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L5757-5778)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L5779-5826)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L5827-5846)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L5847-5885)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L5886-5913)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L5914-5965)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L5966-6018)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6019-6050)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6051-6074)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6075-6124)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6125-6144)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6145-6165)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6166-6182)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6183-6198)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6199-6215)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6216-6231)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6232-6247)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L6299-6334)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L6335-6367)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L6368-6567)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L6641-6646)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L6690-6789)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L6790-6808)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L6809-6810)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L6840-6886)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L6887-6915)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L6916-6917)

### fn `def _f_lab(values)` `priv` (L6950-6957)
...
### fn `def _f2xyz(values)` `priv` (L6958-6964)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L7000-7001)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L7035-7140)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L7141-7142)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L7177-7199)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L7200-7223)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L7224-7268)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L7269-7270)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L7300-7301)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L7354-7355)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L7397-7400)
...
### fn `def _clamp01(np_module, values)` `priv` (L7457-7470)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L7471-7493)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L7494-7527)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L7528-7558)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L7559-7599)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L7600-7601)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L7650-7672)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L7673-7697)
...
### fn `def logistic(z_values)` (L7688-7690)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L7698-7715)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L7716-7739)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L7740-7763)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L7764-7785)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L7786-7790)

### fn `def _load_piexif_dependency()` `priv` (L7847-7864)
...
### fn `def _encode_jpg(` `priv` (L7865-7875)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L7969-7997)
...
### fn `def _is_supported_runtime_os()` `priv` (L7998-8017)
...
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|98||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|99||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|100||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|101||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|102||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|103||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|104||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|105||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|106||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|107||
|`DEFAULT_OPENCV_SATURATION`|var|pub|108||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|109||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|110||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|111||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|112||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|113||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|114||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|115||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|116||
|`HDRPLUS_TILE_SIZE`|var|pub|117||
|`HDRPLUS_TILE_STRIDE`|var|pub|118||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|119||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|120||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|121||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|122||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|123||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|124||
|`EV_STEP`|var|pub|126||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|127||
|`DEFAULT_DNG_BITS_PER_COLOR`|var|pub|128||
|`SUPPORTED_EV_VALUES`|var|pub|129||
|`AUTO_EV_LOW_PERCENTILE`|var|pub|135||
|`AUTO_EV_HIGH_PERCENTILE`|var|pub|136||
|`AUTO_EV_MEDIAN_PERCENTILE`|var|pub|137||
|`AUTO_EV_TARGET_SHADOW`|var|pub|138||
|`AUTO_EV_TARGET_HIGHLIGHT`|var|pub|139||
|`AUTO_EV_MEDIAN_TARGET`|var|pub|140||
|`AUTO_ZERO_SCENE_KEY_LOW_THRESHOLD`|var|pub|141||
|`AUTO_ZERO_SCENE_KEY_HIGH_THRESHOLD`|var|pub|142||
|`AUTO_ZERO_TARGET_LOW_KEY`|var|pub|143||
|`AUTO_ZERO_TARGET_HIGH_KEY`|var|pub|144||
|`AutoAdjustOptions`|class|pub|356-391|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|393-421|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|423-446|class AutoLevelsOptions|
|`PostprocessOptions`|class|pub|448-482|class PostprocessOptions|
|`LuminanceOptions`|class|pub|484-504|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|506-525|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|527-550|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|552-571|class HdrPlusTemporalRuntimeOptions|
|`AutoEvInputs`|class|pub|573-600|class AutoEvInputs|
|`_print_box_table`|fn|priv|601-637|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|621-623|def _border(left, middle, right)|
|`_line`|fn|priv|624-627|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|638-654|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|655-854|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|949-967|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|968-980|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|981-997|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|998-1026|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|1027-1072|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1073-1086|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1087-1118|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1119-1149|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1150-1169|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1170-1189|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1190-1212|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1213-1232|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1233-1252|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1253-1273|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1274-1298|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1299-1345|def _parse_opencv_options(opencv_raw_values)|
|`_clamp_ev_to_supported`|fn|priv|1346-1359|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1360-1381|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1382-1403|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1404-1418|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1419-1478|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1453-1463|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|1479-1498|def _coerce_positive_luminance(value, fallback)|
|`_derive_scene_key_preserving_median_target`|fn|priv|1499-1517|def _derive_scene_key_preserving_median_target(p_median)|
|`_optimize_auto_zero`|fn|priv|1518-1541|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|1542-1571|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1572-1577|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1605-1632|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1633-1640|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1691-1698|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1751-1771|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1772-1808|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1809-1832|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|1833-1856|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1857-1873|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1874-1896|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1897-1921|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1922-1944|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1945-1970|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|1971-2002|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2003-2099|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2100-2131|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2132-2195|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2196-2345|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|2346-2364|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|2365-2441|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|2442-2465|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_hdr_merge_option`|fn|priv|2466-2495|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|2496-2498|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|2551-2750|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3359-3396|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3397-3427|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|3428-3485|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|3486-3517|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|3518-3540|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|3541-3542|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|3571-3613|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|3614-3747|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|3748-3753|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|3802-3816|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|3817-3833|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|3834-3852|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_extract_bracket_images_float`|fn|priv|3853-3889|def _extract_bracket_images_float(raw_handle, np_module, ...|
|`_order_bracket_paths`|fn|priv|3890-3915|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|3916-3931|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|3932-3939|def _run_luminance_hdr_cli(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|4003-4032|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|4033-4056|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|4057-4076|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_run_opencv_merge_radiance`|fn|priv|4077-4084|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|4135-4154|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|4155-4160|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|4220-4248|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4249-4295|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4296-4329|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4330-4350|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4351-4369|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|4370-4394|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|4395-4413|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|4414-4419|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|4472-4478|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|4551-4558|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|4648-4735|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|4736-4760|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|4761-4765|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|4846-4852|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|4901-4973|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|4974-4977|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|5054-5064|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|5065-5067|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|5086-5110|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|5111-5130|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|5131-5162|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|5163-5190|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|5191-5214|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_materialize_bracket_tiffs_from_float`|fn|priv|5215-5219|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5249-5295|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|5296-5340|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|5341-5366|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|5367-5389|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|5390-5414|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|5415-5444|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|5445-5484|def _apply_static_postprocess_float(np_module, image_rgb_...|
|`_to_linear_srgb`|fn|priv|5485-5502|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|5503-5520|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|5521-5538|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|5539-5578|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|5579-5624|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|5625-5630|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|5664-5691|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|5692-5730|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|5731-5756|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|5757-5778|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|5779-5826|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|5827-5846|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|5847-5885|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|5886-5913|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|5914-5965|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|5966-6018|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|6019-6050|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|6051-6074|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|6075-6124|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|6125-6144|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|6145-6165|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|6166-6182|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|6183-6198|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|6199-6215|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|6216-6231|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|6232-6247|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|6299-6334|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|6335-6367|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|6368-6567|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_call_auto_levels_compat_helper`|fn|priv|6641-6646|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|6690-6789|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|6790-6808|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|6809-6810|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|6840-6886|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|6887-6915|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|6916-6917|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|6950-6957|def _f_lab(values)|
|`_f2xyz`|fn|priv|6958-6964|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|7000-7001|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|7035-7140|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|7141-7142|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|7177-7199|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|7200-7223|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|7224-7268|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|7269-7270|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|7300-7301|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|7354-7355|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|7397-7400|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|7457-7470|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|7471-7493|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|7494-7527|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|7528-7558|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|7559-7599|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|7600-7601|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|7650-7672|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|7673-7697|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|7688-7690|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|7698-7715|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|7716-7739|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|7740-7763|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|7764-7785|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|7786-7790|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|7847-7864|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|7865-7875|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|7969-7997|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|7998-8017|def _is_supported_runtime_os()|
|`run`|fn|pub|8018-8217|def run(args)|
