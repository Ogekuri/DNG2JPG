...
# dng2jpg.py | Python | 12941L | 407 symbols | 32 imports | 270 comments
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1674-1696)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1697-1716)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1717-1736)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1737-1757)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1758-1782)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1783-1804)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1805-1857)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1858-1860)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2031-2090)
...
### fn `def _percentile(percentile_value)` `priv` (L2065-2075)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2091-2123)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2124-2153)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2154-2157)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2204-2227)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2228-2268)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2269-2326)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2327-2330)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2377-2395)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2396-2427)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2428-2477)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2478-2526)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2527-2547)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2548-2578)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2579-2606)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2607-2628)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2629-2648)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2649-2671)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2672-2690)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2691-2736)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2737-2756)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2757-2824)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2825-2862)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2863-2891)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2892-2896)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2926-2943)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2944-2961)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2962-2965)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3051-3071)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3072-3098)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3099-3122)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3123-3144)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3145-3168)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3169-3244)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3245-3261)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3262-3284)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3285-3309)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3310-3332)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3333-3358)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3359-3390)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3391-3487)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3488-3519)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3520-3592)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3593-3742)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3743-3761)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3762-3838)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3839-3892)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L3893-3926)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L3927-3950)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L3951-3978)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L3979-4010)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4011-4023)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4024-4053)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4054-4080)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4081-4111)
...
### fn `def _resolve_default_postprocess(` `priv` (L4112-4115)

### fn `def _parse_gamma_option(option_value)` `priv` (L4196-4234)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4235-4254)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4255-4306)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4307-4375)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4376-4422)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4423-4482)
...
### fn `def _format_gamma_number(value)` `priv` (L4434-4447)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4483-4525)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4526-4557)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4558-4587)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4588-4640)
...
### fn `def _load_image_dependencies()` `priv` (L5298-5335)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5336-5366)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5367-5429)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5430-5524)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5474-5491)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5525-5556)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5557-5579)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5580-5581)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5612-5654)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5655-5788)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5789-5795)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5845-5859)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5860-5877)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L
def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1717-1736|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1737-1757|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1758-1782|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1783-1804|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1805-1857|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1858-1860|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2031-2090|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2065-2075|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2091-2123|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2124-2153|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2154-2157|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2204-2227|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2228-2268|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2269-2326|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2327-2330|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2377-2395|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2396-2427|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2428-2477|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2478-2526|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2527-2547|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2548-2578|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2579-2606|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2607-2628|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2629-2648|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2649-2671|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2672-2690|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2691-2736|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2737-2756|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2757-2824|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2825-2862|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2863-2891|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2892-2896|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2926-2943|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2944-2961|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_joint_auto_ev_solution`|fn|priv|2962-2965|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3051-3071|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3072-3098|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3099-3122|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3123-3144|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3145-3168|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3169-3244|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3245-3261|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3262-3284|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3285-3309|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3310-3332|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3333-3358|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3359-3390|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3391-3487|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3488-3519|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3520-3592|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3593-3742|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3743-3761|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3762-3838|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|3839-3892|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|3893-3926|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|3927-3950|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|3951-3978|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|3979-4010|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4011-4023|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4024-4053|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|