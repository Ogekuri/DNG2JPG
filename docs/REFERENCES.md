...
# dng2jpg.py | Python | 13606L | 430 symbols | 32 imports | 278 comments
...
- var `DEFAULT_WHITE_BALANCE_XPHOTO_DOMAIN = WHITE_BALANCE_XPHOTO_DOMAIN_SOURCE_AUTO` (L134)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO = "ev-zero"` (L135)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE = "linear-base"` (L136)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L137)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L138)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L139)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L140)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L141)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L142)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L143)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L144)
- var `DEFAULT_REINHARD02_CONTRAST = 0.9` (L145)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L146)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.9` (L147)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L148)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.2` (L149)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L150)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.9` (L151)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L152)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.2` (L153)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L154)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L155)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.2` (L156)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L157)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.0` (L158)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L159)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L160)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.4` (L161)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L162)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.0` (L163)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L164)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L165)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L166)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.4` (L167)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L168)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L169)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_DEBEVEC_POST_GAMMA` (L170)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS` (L171)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_DEBEVEC_CONTRAST` (L172)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_DEBEVEC_SATURATION` (L173)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_DEBEVEC` (L174)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L175)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA` (L176)
- var `DEFAULT_OPENCV_TONEMAP_MAP = OPENCV_TONEMAP_MAP_REINHARD` (L177)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L178)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L179)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L180)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L181)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L182)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L183)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L184)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA = 1.0` (L185)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS = 1.0` (L186)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST = 1.4` (L187)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 0.6` (L188)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA = 1.0` (L189)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS = 1.0` (L190)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST = 1.0` (L191)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION = 1.0` (L192)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA = 0.9` (L193)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.2` (L194)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.4` (L195)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 0.5` (L196)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L197)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L198)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L199)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L200)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L201)
- var `HDRPLUS_TILE_SIZE = 32` (L202)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L203)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L204)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L205)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L206)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L207)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L208)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L209)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L211)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L689-787)
...
- fn `def auto_white_balance_mode(self) -> str | None` (L749-760)
...
- fn `def auto_white_balance_analysis_source(self) -> str` (L762-773)
...
- fn `def auto_white_balance_xphoto_domain(self) -> str` (L775-787)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L789-805)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L807-825)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L827-848)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L850-870)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L872-895)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L897-916)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L918-938)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L940-957)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L959-976)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L978-996)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L997-1033)
...
### fn `def _border(left, middle, right)` `priv` (L1017-1019)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L1020-1023)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L1034-1050)
...
### fn `def _print_help_section(title)` `priv` (L1051-1065)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L1066-1107)
...
### fn `def print_help(version)` (L1108-1307)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1577-1594)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1595-1640)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1641-1653)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1654-1680)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1681-1707)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1708-1730)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1731-1750)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1751-1770)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1771-1791)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1792-1816)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1817-1838)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1839-1891)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1892-1894)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2067-2126)
...
### fn `def _percentile(percentile_value)` `priv` (L2101-2111)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2127-2159)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2160-2189)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2190-2193)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2240-2263)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2264-2304)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2305-2362)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2363-2366)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2413-2431)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2432-2463)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2464-2513)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2514-2562)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2563-2583)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2584-2614)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2615-2642)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2643-2664)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2665-2684)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2685-2707)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2708-2726)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2727-2772)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2773-2792)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2793-2860)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2861-2898)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2899-2927)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2928-2932)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2962-2979)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2980-2997)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L2998-3002)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3090-3107)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3108-3111)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3168-3188)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3189-3215)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3216-3239)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3240-3261)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3262-3285)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3286-3361)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3362-3378)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3379-3401)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3402-3426)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3427-3449)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3450-3475)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3476-3507)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3508-3604)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3605-3636)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3637-3709)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3710-3859)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3860-3878)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3879-3955)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3956-4009)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4010-4043)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4044-4067)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4068-4095)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4096-4127)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4128-4140)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4141-4170)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4171-4197)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4198-4228)
...
### fn `def _resolve_default_postprocess(` `priv` (L4229-4233)

### fn `def _parse_gamma_option(option_value)` `priv` (L4342-4380)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4381-4400)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4401-4452)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4453-4521)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4522-4568)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4569-4628)
...
### fn `def _format_gamma_number(value)` `priv` (L4580-4593)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4629-4671)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4672-4703)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4704-4733)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4734-4786)
...
### fn `def _parse_run_options(args)` `priv` (L4787-4986)
...
### fn `def _load_image_dependencies()` `priv` (L5425-5462)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5463-5493)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5494-5556)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5557-5651)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5601-5618)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5652-5683)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5684-5706)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5707-5708)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5739-5781)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5782-5920)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5921-5927)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5977-5991)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5992-6009)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6010-6028)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6029-6058)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6059-6062)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6084-6113)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6114-6160)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6161-6164)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6196-6235)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6236-6242)

### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6322-6324)
...
### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6367-6370)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6405-6420)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6421-6428)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6503-6506)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6541-6572)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6573-6576)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6602-6605)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L6627-6635)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6728-6735)

### fn `def _extract_bracket_images_float(` `priv` (L6821-6827)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L6882-6907)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L6908-6923)
...
### fn `def _format_external_command_for_log(command)` `priv` (L6924-6939)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L6940-6947)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7023-7026)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7060-7079)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7080-7105)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7106-7111)

### fn `def _estimate_opencv_camera_response(` `priv` (L7141-7145)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7174-7181)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7245-7264)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7265-7270)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L7349-7362)
...
### fn `def _run_opencv_merge_backend(` `priv` (L7363-7371)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L7468-7496)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L7497-7543)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L7544-7577)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L7578-7598)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L7599-7617)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L7618-7642)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L7643-7661)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L7662-7667)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L7720-7726)

### fn `def _hdrplus_align_layer(` `priv` (L7799-7806)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L7896-7983)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L7984-8008)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8009-8013)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8094-8100)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8149-8221)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8222-8227)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8323-8333)
...
### fn `def _collect_missing_external_executables(` `priv` (L8334-8336)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L8355-8384)
...
### fn `def _resolve_numpy_dependency()` `priv` (L8385-8404)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L8405-8445)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L8446-8464)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L8465-8492)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L8493-8520)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8521-8547)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8548-8572)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L8573-8578)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L8608-8628)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L8629-8634)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L8693-8710)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L8711-8715)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L8745-8795)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L8796-8844)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L8845-8870)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L8871-8887)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L8888-8918)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L8919-8979)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L8980-9002)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9003-9027)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9028-9058)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9059-9064)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9181-9198)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9199-9216)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9217-9234)
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9235-9250)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9251-9303)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L9304-9349)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L9350-9355)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L9429-9456)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L9457-9495)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L9496-9526)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L9527-9548)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L9549-9596)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L9597-9616)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L9617-9655)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L9656-9683)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L9684-9735)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L9736-9788)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L9789-9828)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L9829-9852)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L9853-9916)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L9917-9936)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L9937-9957)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L9958-9974)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L9975-9990)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L9991-10007)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10008-10023)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10024-10039)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10091-10132)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10133-10165)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10166-10365)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L10524-10616)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L10537-10553)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L10554-10556)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L10557-10576)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L10577-10579)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L10580-10591)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L10617-10750)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L10751-10757)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L10789-10826)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L10827-10857)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L10858-10879)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L10880-10894)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L10895-11094)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11125-11128)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L11212-11235)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L11236-11241)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L11285-11403)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L11404-11564)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L11434-11467)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L11565-11566)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L11596-11642)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L11643-11671)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L11672-11673)

### fn `def _f_lab(values)` `priv` (L11706-11713)
...
### fn `def _f2xyz(values)` `priv` (L11714-11720)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L11756-11757)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L11791-11896)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L11897-11898)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L11933-11955)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L11956-11979)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L11980-12024)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12025-12026)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12056-12057)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12110-12111)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12153-12156)
...
### fn `def _clamp01(np_module, values)` `priv` (L12212-12225)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L12226-12248)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L12249-12282)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L12283-12313)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L12314-12354)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L12355-12356)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L12413-12443)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L12444-12475)
...
### fn `def logistic(z_values)` (L12466-12468)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L12476-12501)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L12502-12525)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L12526-12549)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L12550-12571)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L12572-12578)

### fn `def _sanitize_auto_adjust_stage(stage_rgb)` `priv` (L12597-12608)
...
### fn `def _load_piexif_dependency()` `priv` (L12713-12730)
...
### fn `def _postprocess(` `priv` (L12731-12739)

### fn `def _encode_jpg(` `priv` (L12869-12877)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L12937-12965)
...
### fn `def _is_supported_runtime_os()` `priv` (L12966-12985)
...
### fn `def _print_validated_run_parameters(` `priv` (L12986-13001)

### fn `def run(args)` (L13179-13378)
...
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|137||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|138||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|139||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|140||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|141||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|142||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|143||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|144||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|145||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|146||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|147||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|148||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|149||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|150||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|151||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|152||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|153||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|154||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|155||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|156||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|157||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|158||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|159||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|160||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|161||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|162||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|163||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|164||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|165||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|166||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|167||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|168||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|169||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|170||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|171||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|172||
|`DEFAULT_OPENCV_SATURATION`|var|pub|173||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|174||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|175||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|176||
|`DEFAULT_OPENCV_TONEMAP_MAP`|var|pub|177||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|178||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|179||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|180||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|181||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|182||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|183||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|184||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA`|var|pub|185||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS`|var|pub|186||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST`|var|pub|187||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|188||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA`|var|pub|189||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS`|var|pub|190||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST`|var|pub|191||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION`|var|pub|192||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA`|var|pub|193||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS`|var|pub|194||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST`|var|pub|195||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|196||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|197||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|198||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|199||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|200||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|201||
|`HDRPLUS_TILE_SIZE`|var|pub|202||
|`HDRPLUS_TILE_STRIDE`|var|pub|203||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|204||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|205||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|206||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|207||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|208||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|209||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|211||
...
|`PostprocessOptions`|class|pub|689-787|class PostprocessOptions|
|`PostprocessOptions.auto_white_balance_mode`|fn|pub|749-760|def auto_white_balance_mode(self) -> str | None|
|`PostprocessOptions.auto_white_balance_analysis_source`|fn|pub|762-773|def auto_white_balance_analysis_source(self) -> str|
|`PostprocessOptions.auto_white_balance_xphoto_domain`|fn|pub|775-787|def auto_white_balance_xphoto_domain(self) -> str|
|`DebugArtifactContext`|class|pub|789-805|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|807-825|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|827-848|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|850-870|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|872-895|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|897-916|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|918-938|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|940-957|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|959-976|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|978-996|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|997-1033|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|1017-1019|def _border(left, middle, right)|
|`_line`|fn|priv|1020-1023|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|1034-1050|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|1051-1065|def _print_help_section(title)|
|`_print_help_option`|fn|priv|1066-1107|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1108-1307|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1577-1594|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1595-1640|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1641-1653|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1654-1680|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1681-1707|def _parse_ev_center_option(ev_center_raw)|
|`_parse_percentage_option`|fn|priv|1708-1730|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1731-1750|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1751-1770|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1771-1791|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1792-1816|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1817-1838|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1839-1891|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1892-1894|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2067-2126|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2101-2111|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2127-2159|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2160-2189|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2190-2193|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2240-2263|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2264-2304|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2305-2362|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2363-2366|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2413-2431|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2432-2463|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2464-2513|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2514-2562|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2563-2583|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2584-2614|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2615-2642|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2643-2664|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2665-2684|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2685-2707|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2708-2726|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2727-2772|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2773-2792|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2793-2860|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2861-2898|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2899-2927|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2928-2932|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2962-2979|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2980-2997|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|2998-3002|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3090-3107|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3108-3111|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3168-3188|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3189-3215|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3216-3239|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3240-3261|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3262-3285|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3286-3361|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3362-3378|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3379-3401|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3402-3426|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3427-3449|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3450-3475|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3476-3507|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3508-3604|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3605-3636|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3637-3709|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3710-3859|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3860-3878|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3879-3955|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|3956-4009|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4010-4043|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4044-4067|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4068-4095|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4096-4127|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4128-4140|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4141-4170|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4171-4197|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4198-4228|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4229-4233|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4342-4380|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4381-4400|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4401-4452|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4453-4521|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4522-4568|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4569-4628|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4580-4593|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4629-4671|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4672-4703|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4704-4733|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4734-4786|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4787-4986|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5425-5462|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5463-5493|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5494-5556|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5557-5651|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5601-5618|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5652-5683|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5684-5706|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5707-5708|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5739-5781|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5782-5920|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5921-5927|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5977-5991|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5992-6009|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|6010-6028|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6029-6058|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6059-6062|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6084-6113|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6114-6160|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6161-6164|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6196-6235|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6236-6242|def _extract_white_balance_channel_gains_from_xphoto(|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6322-6324|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6367-6370|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6405-6420|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6421-6428|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6503-6506|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6541-6572|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6573-6576|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|6602-6605|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|6627-6635|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|6728-6735|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|6821-6827|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|6882-6907|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|6908-6923|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|6924-6939|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|6940-6947|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7023-7026|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7060-7079|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7080-7105|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|7106-7111|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|7141-7145|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|7174-7181|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7245-7264|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7265-7270|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|7349-7362|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|7363-7371|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|7468-7496|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|7497-7543|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|7544-7577|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|7578-7598|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|7599-7617|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|7618-7642|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|7643-7661|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|7662-7667|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|7720-7726|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|7799-7806|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|7896-7983|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|7984-8008|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8009-8013|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8094-8100|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8149-8221|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8222-8227|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|8323-8333|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|8334-8336|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|8355-8384|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|8385-8404|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|8405-8445|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|8446-8464|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|8465-8492|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|8493-8520|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|8521-8547|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|8548-8572|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|8573-8578|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|8608-8628|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|8629-8634|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|8693-8710|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|8711-8715|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|8745-8795|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|8796-8844|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|8845-8870|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|8871-8887|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|8888-8918|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|8919-8979|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|8980-9002|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9003-9027|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9028-9058|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9059-9064|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9181-9198|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9199-9216|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9217-9234|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9235-9250|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9251-9303|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|9304-9349|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|9350-9355|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|9429-9456|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|9457-9495|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|9496-9526|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|9527-9548|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|9549-9596|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|9597-9616|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|9617-9655|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|9656-9683|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|9684-9735|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|9736-9788|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|9789-9828|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|9829-9852|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|9853-9916|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|9917-9936|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|9937-9957|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|9958-9974|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|9975-9990|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|9991-10007|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10008-10023|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10024-10039|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10091-10132|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10133-10165|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10166-10365|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|10524-10616|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|10537-10553|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|10554-10556|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|10557-10576|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|10577-10579|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|10580-10591|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|10617-10750|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|10751-10757|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|10789-10826|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|10827-10857|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|10858-10879|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|10880-10894|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|10895-11094|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11125-11128|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|11212-11235|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|11236-11241|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|11285-11403|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|11404-11564|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|11434-11467|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|11565-11566|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|11596-11642|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|11643-11671|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|11672-11673|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|11706-11713|def _f_lab(values)|
|`_f2xyz`|fn|priv|11714-11720|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|11756-11757|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|11791-11896|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|11897-11898|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|11933-11955|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|11956-11979|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|11980-12024|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12025-12026|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12056-12057|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12110-12111|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12153-12156|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|12212-12225|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|12226-12248|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|12249-12282|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|12283-12313|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|12314-12354|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|12355-12356|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|12413-12443|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|12444-12475|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|12466-12468|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|12476-12501|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|12502-12525|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|12526-12549|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|12550-12571|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|12572-12578|def _apply_validated_auto_adjust_pipeline(|
|`_sanitize_auto_adjust_stage`|fn|priv|12597-12608|def _sanitize_auto_adjust_stage(stage_rgb)|
|`_load_piexif_dependency`|fn|priv|12713-12730|def _load_piexif_dependency()|
|`_postprocess`|fn|priv|12731-12739|def _postprocess(|
|`_encode_jpg`|fn|priv|12869-12877|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|12937-12965|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|12966-12985|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|12986-13001|def _print_validated_run_parameters(|
|`run`|fn|pub|13179-13378|def run(args)|
