...
- @details Encapsulates one deterministic Debevec/Robertson radiance path as three separable adapters: input adaptation, response estimation, and merge execution. The selected `path_label` is emitted unchanged in runtime diagnostics so downstream agents can distinguish high-precision execution from the legacy uint8 fallback.
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1607-1624)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1625-1670)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1671-1683)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1684-1711)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1712-1739)
...
### fn `def _is_forced_static_auto_bracketing_selected(args)` `priv` (L1740-1761)
...
### fn `def _print_forced_static_auto_bracketing_diagnostics(ev_delta)` `priv` (L1762-1778)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1779-1801)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1802-1821)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1822-1841)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1842-1862)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1863-1887)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1888-1909)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1910-1962)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1963-1965)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2138-2209)
...
### fn `def _percentile(percentile_value)` `priv` (L2174-2184)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _normalize_percentile(stat_name, stat_value)` `priv` (L2195-2203)

### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2210-2242)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2243-2272)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2273-2276)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2323-2346)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2347-2387)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2388-2445)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2446-2449)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2497-2515)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2516-2547)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2548-2597)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2598-2646)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2647-2667)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2668-2698)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2699-2726)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2727-2748)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2749-2769)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2770-2795)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2796-2814)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2815-2860)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2861-2887)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2888-2987)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2988-3026)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L3027-3055)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L3056-3060)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L3090-3107)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L3108-3125)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L3126-3130)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3218-3235)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3236-3239)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3296-3316)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3317-3343)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3344-3367)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3368-3389)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3390-3413)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3414-3489)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3490-3506)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3507-3529)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3530-3554)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3555-3577)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3578-3603)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3604-3635)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3636-3732)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3733-3764)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3765-3837)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3838-3987)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3988-4006)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L4007-4083)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4084-4140)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L4141-4174)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4175-4198)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4199-4226)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4227-4258)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4259-4271)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4272-4301)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4302-4328)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4329-4359)
...
### fn `def _resolve_default_postprocess(` `priv` (L4360-4364)

### fn `def _parse_gamma_option(option_value)` `priv` (L4473-4511)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4512-4531)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4532-4583)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4584-4652)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4653-4699)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4700-4759)
...
### fn `def _format_gamma_number(value)` `priv` (L4711-4724)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4760-4802)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4803-4834)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4835-4864)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4865-4921)
...
### fn `def _parse_run_options(args)` `priv` (L4922-5121)
...
### fn `def _load_image_dependencies()` `priv` (L5589-5626)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5627-5657)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5658-5720)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5721-5815)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5765-5782)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5816-5847)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5848-5870)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5871-5872)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5903-5945)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5946-6084)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L6085-6091)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L6141-6155)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L6156-6173)
...
### fn `def _safe_pow2_ev(exponent, context)` `priv` (L6174-6211)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6212-6240)
...
### fn `def _clip_bracket_rgb_unit_interval(np_module, image_rgb_float)` `priv` (L6241-6264)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6265-6294)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6295-6298)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6324-6353)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6354-6400)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6401-6404)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6436-6475)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6476-6478)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6509-6511)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6538-6540)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6581-6585)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6621-6627)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6698-6720)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6721-6723)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6766-6769)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6804-6819)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6820-6827)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6915-6918)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6953-6984)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6985-6988)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L7014-7017)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L7039-7047)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L7144-7151)

### fn `def _extract_bracket_images_float(` `priv` (L7237-7243)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7298-7323)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7324-7339)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7340-7355)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7356-7363)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7439-7442)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7490-7509)
...
### fn `def _rescale_mertens_fusion_to_display_range(np_module, fusion_rgb_float)` `priv` (L7542-7563)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7564-7569)

### fn `def _adapt_opencv_radiance_input_high_precision(np_module, image_rgb_float)` `priv` (L7602-7621)
...
### fn `def _estimate_opencv_camera_response_high_precision(` `priv` (L7622-7626)

### fn `def _estimate_opencv_camera_response_uint8_legacy(` `priv` (L7646-7650)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L7677-7682)
...
### fn `def _merge_opencv_radiance_high_precision(` `priv` (L7707-7712)
...
### fn `def _merge_opencv_radiance_uint8_legacy(` `priv` (L7745-7750)
...
### fn `def _probe_opencv_high_precision_radiance_support(` `priv` (L7782-7785)
...
### fn `def _select_opencv_radiance_path_adapters(` `priv` (L7823-7826)
...
### fn `def _print_opencv_radiance_path_diagnostic(path_label)` `priv` (L7862-7876)
...
- @details Prints exactly one runtime line naming the selected Debevec/Robertson radiance path so downstream logs can distinguish high-precision execution from the uint8 legacy fallback. Complexity: O(1). Side effects: stdout write via `print_info`.
- @param cv2_module {ModuleType} Imported OpenCV module.
- @param np_module {ModuleType} Imported numpy module.
- @param merge_algorithm {str} Canonical OpenCV merge algorithm token.
...
### fn `def _quantize_opencv_radiance_rgb_uint8(np_module, image_rgb_float)` `priv` (L7877-7899)
- @brief Quantize one legacy radiance-path bracket at the OpenCV uint8 boundary.
- @details Converts one camera-linear RGB float bracket to `uint8` using the repository byte-quantization helper. Scope is restricted to the OpenCV Debevec/Robertson uint8 legacy fallback where calibrator and merge APIs require `CV_8U` payloads. Complexity: O(H*W). Side effects: none.
- @param np_module {ModuleType} Imported numpy module.
- @param image_rgb_float {object} Camera-linear RGB float bracket tensor.
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7900-7907)

### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7969-7988)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7989-7994)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L8074-8087)
...
### fn `def _run_opencv_merge_backend(` `priv` (L8088-8096)
...
|`_validate_supported_bits_per_color`|fn|priv|1607-1624|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1625-1670|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1671-1683|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1684-1711|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1712-1739|def _parse_ev_center_option(ev_center_raw)|
|`_is_forced_static_auto_bracketing_selected`|fn|priv|1740-1761|def _is_forced_static_auto_bracketing_selected(args)|
|`_print_forced_static_auto_bracketing_diagnostics`|fn|priv|1762-1778|def _print_forced_static_auto_bracketing_diagnostics(ev_d...|
|`_parse_percentage_option`|fn|priv|1779-1801|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1802-1821|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1822-1841|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1842-1862|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1863-1887|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1888-1909|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1910-1962|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1963-1965|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2138-2209|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2174-2184|def _percentile(percentile_value)|
|`_normalize_percentile`|fn|priv|2195-2203|def _normalize_percentile(stat_name, stat_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2210-2242|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2243-2272|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2273-2276|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2323-2346|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2347-2387|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2388-2445|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2446-2449|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2497-2515|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2516-2547|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2548-2597|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2598-2646|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2647-2667|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2668-2698|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2699-2726|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2727-2748|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2749-2769|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2770-2795|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2796-2814|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2815-2860|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2861-2887|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2888-2987|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2988-3026|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|3027-3055|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|3056-3060|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|3090-3107|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|3108-3125|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|3126-3130|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3218-3235|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3236-3239|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3296-3316|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3317-3343|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3344-3367|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3368-3389|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3390-3413|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3414-3489|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3490-3506|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3507-3529|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3530-3554|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3555-3577|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3578-3603|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3604-3635|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3636-3732|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3733-3764|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3765-3837|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3838-3987|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3988-4006|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|4007-4083|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|4084-4140|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_resolve_opencv_tonemap_gamma_inverse`|fn|priv|4141-4174|def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_...|
|`_parse_auto_adjust_option`|fn|priv|4175-4198|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|4199-4226|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_auto_white_balance_mode_option`|fn|priv|4227-4258|def _parse_auto_white_balance_mode_option(auto_white_bala...|
|`_parse_white_balance_mode_option`|fn|priv|4259-4271|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|4272-4301|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_white_balance_xphoto_domain_option`|fn|priv|4302-4328|def _parse_white_balance_xphoto_domain_option(xphoto_doma...|
|`_parse_hdr_merge_option`|fn|priv|4329-4359|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|4360-4364|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4473-4511|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4512-4531|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4532-4583|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4584-4652|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4653-4699|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4700-4759|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4711-4724|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4760-4802|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4803-4834|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4835-4864|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4865-4921|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4922-5121|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5589-5626|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5627-5657|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5658-5720|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5721-5815|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5765-5782|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5816-5847|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5848-5870|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5871-5872|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5903-5945|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5946-6084|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|6085-6091|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|6141-6155|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|6156-6173|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_safe_pow2_ev`|fn|priv|6174-6211|def _safe_pow2_ev(exponent, context)|
|`_build_exposure_multipliers`|fn|priv|6212-6240|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_clip_bracket_rgb_unit_interval`|fn|priv|6241-6264|def _clip_bracket_rgb_unit_interval(np_module, image_rgb_...|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6265-6294|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6295-6298|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6324-6353|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6354-6400|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6401-6404|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6436-6475|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6476-6478|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6509-6511|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6538-6540|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6581-6585|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6621-6627|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6698-6720|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6721-6723|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6766-6769|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6804-6819|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6820-6827|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6915-6918|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6953-6984|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6985-6988|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|7014-7017|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|7039-7047|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|7144-7151|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|7237-7243|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7298-7323|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7324-7339|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7340-7355|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7356-7363|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7439-7442|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7490-7509|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7510-7541|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_rescale_mertens_fusion_to_display_range`|fn|priv|7542-7563|def _rescale_mertens_fusion_to_display_range(np_module, f...|
|`_run_opencv_merge_mertens`|fn|priv|7564-7569|def _run_opencv_merge_mertens(|
|`_adapt_opencv_radiance_input_high_precision`|fn|priv|7602-7621|def _adapt_opencv_radiance_input_high_precision(np_module...|
|`_estimate_opencv_camera_response_high_precision`|fn|priv|7622-7626|def _estimate_opencv_camera_response_high_precision(|
|`_estimate_opencv_camera_response_uint8_legacy`|fn|priv|7646-7650|def _estimate_opencv_camera_response_uint8_legacy(|
|`_estimate_opencv_camera_response`|fn|priv|7677-7682|def _estimate_opencv_camera_response(|
|`_merge_opencv_radiance_high_precision`|fn|priv|7707-7712|def _merge_opencv_radiance_high_precision(|
|`_merge_opencv_radiance_uint8_legacy`|fn|priv|7745-7750|def _merge_opencv_radiance_uint8_legacy(|
|`_probe_opencv_high_precision_radiance_support`|fn|priv|7782-7785|def _probe_opencv_high_precision_radiance_support(|
|`_select_opencv_radiance_path_adapters`|fn|priv|7823-7826|def _select_opencv_radiance_path_adapters(|
|`_print_opencv_radiance_path_diagnostic`|fn|priv|7862-7876|def _print_opencv_radiance_path_diagnostic(path_label)|
|`_quantize_opencv_radiance_rgb_uint8`|fn|priv|7877-7899|def _quantize_opencv_radiance_rgb_uint8(np_module, image_...|
|`_run_opencv_merge_radiance`|fn|priv|7900-7907|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7969-7988|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7989-7994|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|8074-8087|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|8088-8096|def _run_opencv_merge_backend(|
