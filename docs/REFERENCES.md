...
# dng2jpg.py | Python | 9827L | 282 symbols | 24 imports | 201 comments
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L1521-1549)
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L1550-1568)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L1569-1600)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L1601-1650)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L1651-1699)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L1700-1720)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L1721-1751)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L1752-1779)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L1780-1801)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1802-1824)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1825-1843)
...
### fn `def _is_auto_ev_candidate_clipped(np_module, image_rgb_float, exposure_ev, params)` `priv` (L1844-1902)
...
### fn `def _fraction(mask)` `priv` (L1876-1878)
- @brief Classify one automatic EV candidate as safe or clipped.
...
### fn `def _compute_auto_ev_bracketing_solution(np_module, base_rgb_float, base_max_ev, params)` `priv` (L1903-2003)
...
### fn `def _resolve_auto_ev_bracketing_solution(np_module, base_rgb_float, base_max_ev)` `priv` (L2004-2050)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2051-2071)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2072-2095)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2096-2119)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2120-2136)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2137-2159)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2160-2184)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2185-2207)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2208-2233)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2234-2265)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2266-2362)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2363-2394)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2395-2467)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2468-2617)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2618-2636)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2637-2713)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2714-2737)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2738-2767)
...
### fn `def _resolve_default_postprocess(` `priv` (L2768-2771)

### fn `def _parse_run_options(args)` `priv` (L2843-3042)
...
### fn `def _load_image_dependencies()` `priv` (L3587-3624)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3625-3655)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L3656-3718)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L3719-3813)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L3763-3780)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L3814-3845)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L3846-3868)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L3869-3870)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3901-3943)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3944-4077)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4078-4084)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4134-4148)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4149-4166)
...
### fn `def _build_exposure_multipliers(ev_minus, ev_zero, ev_plus)` `priv` (L4167-4186)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4187-4215)
...
### fn `def _extract_bracket_images_float(` `priv` (L4216-4220)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4254-4279)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4280-4295)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4296-4303)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L4367-4370)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4404-4423)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4424-4447)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L4448-4469)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L4470-4474)

### fn `def _run_opencv_merge_radiance(` `priv` (L4503-4510)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4574-4593)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4594-4600)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4661-4689)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4690-4736)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4737-4770)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4771-4791)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4792-4810)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L4811-4835)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L4836-4854)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L4855-4860)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L4913-4919)

### fn `def _hdrplus_align_layer(` `priv` (L4992-4999)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5089-5176)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5177-5201)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5202-5206)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5287-5293)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5342-5414)
...
### fn `def _run_hdr_plus_merge(` `priv` (L5415-5418)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5495-5505)
...
### fn `def _collect_missing_external_executables(` `priv` (L5506-5508)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5527-5552)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5553-5572)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5573-5604)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5605-5632)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5633-5656)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L5657-5662)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L5692-5712)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L5713-5730)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5731-5735)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5765-5811)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L5812-5856)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L5857-5882)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L5883-5905)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L5906-5930)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L5931-5960)
...
### fn `def _apply_static_postprocess_float(` `priv` (L5961-5966)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6043-6060)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6061-6078)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6079-6096)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6097-6136)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6137-6182)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6183-6188)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6222-6249)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6250-6288)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6289-6314)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6315-6336)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6337-6384)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6385-6404)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L6405-6443)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L6444-6471)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L6472-6523)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L6524-6576)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6577-6608)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6609-6632)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6633-6682)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6683-6702)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6703-6723)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6724-6740)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6741-6756)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6757-6773)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6774-6789)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6790-6805)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L6857-6892)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L6893-6925)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L6926-7125)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L7199-7291)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L7212-7228)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L7229-7231)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L7232-7251)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L7252-7254)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L7255-7266)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L7292-7425)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L7426-7432)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L7464-7495)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L7496-7526)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L7527-7716)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L7717-7720)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L7804-7827)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L7828-7833)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L7877-7983)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L7984-8144)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L8014-8047)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L8145-8146)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L8176-8222)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L8223-8251)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L8252-8253)

### fn `def _f_lab(values)` `priv` (L8286-8293)
...
### fn `def _f2xyz(values)` `priv` (L8294-8300)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L8336-8337)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L8371-8476)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L8477-8478)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L8513-8535)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L8536-8559)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L8560-8604)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L8605-8606)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L8636-8637)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L8690-8691)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L8733-8736)
...
### fn `def _clamp01(np_module, values)` `priv` (L8793-8806)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L8807-8829)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L8830-8863)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L8864-8894)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L8895-8935)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L8936-8937)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L8986-9008)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L9009-9033)
...
### fn `def logistic(z_values)` (L9024-9026)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L9034-9051)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L9052-9075)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L9076-9099)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L9100-9121)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L9122-9128)

### fn `def _load_piexif_dependency()` `priv` (L9237-9254)
...
### fn `def _encode_jpg(` `priv` (L9255-9266)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L9398-9426)
...
### fn `def _is_supported_runtime_os()` `priv` (L9427-9446)
...
|`_extract_base_rgb_linear_float`|fn|priv|1521-1549|def _extract_base_rgb_linear_float(raw_handle, np_module)|
|`_normalize_source_gamma_label`|fn|priv|1550-1568|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|1569-1600|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|1601-1650|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|1651-1699|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|1700-1720|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|1721-1751|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|1752-1779|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|1780-1801|def _describe_source_gamma_info(source_gamma_info)|
|`_calculate_bt709_luminance`|fn|priv|1802-1824|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|1825-1843|def _smoothstep(np_module, values, edge0, edge1)|
|`_is_auto_ev_candidate_clipped`|fn|priv|1844-1902|def _is_auto_ev_candidate_clipped(np_module, image_rgb_fl...|
|`_fraction`|fn|priv|1876-1878|def _fraction(mask)|
|`_compute_auto_ev_bracketing_solution`|fn|priv|1903-2003|def _compute_auto_ev_bracketing_solution(np_module, base_...|
|`_resolve_auto_ev_bracketing_solution`|fn|priv|2004-2050|def _resolve_auto_ev_bracketing_solution(np_module, base_...|
|`_parse_luminance_text_option`|fn|priv|2051-2071|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_positive_float_option`|fn|priv|2072-2095|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|2096-2119|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|2120-2136|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2137-2159|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2160-2184|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2185-2207|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2208-2233|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2234-2265|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2266-2362|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2363-2394|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|