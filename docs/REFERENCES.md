...
# dng2jpg.py | Python | 13859L | 441 symbols | 32 imports | 284 comments
...
### fn `def _load_image_dependencies()` `priv` (L5430-5467)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5468-5498)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5499-5561)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5562-5656)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5606-5623)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5657-5688)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5689-5711)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5712-5713)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5744-5786)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5787-5925)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5926-5932)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5982-5996)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5997-6014)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L6015-6033)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L6034-6063)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6064-6067)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6089-6118)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6119-6165)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6166-6169)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6201-6240)
...
### fn `def _resolve_xphoto_estimation_payload_scale(` `priv` (L6241-6243)

### fn `def _rescale_xphoto_estimation_payload_rgb_float(` `priv` (L6274-6276)
...
### fn `def _compress_xphoto_estimation_payload_highlights_soft_knee(` `priv` (L6303-6305)
...
### fn `def _quantize_xphoto_estimation_payload_rgb(` `priv` (L6346-6350)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6386-6392)
...
### fn `def _probe_xphoto_uint16_payload_support(np_module, wb_algorithm)` `priv` (L6463-6485)
...
### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6486-6488)

### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6531-6534)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6569-6584)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6585-6592)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6680-6683)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6718-6749)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6750-6753)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6779-6782)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L6804-6812)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6905-6912)

### fn `def _extract_bracket_images_float(` `priv` (L6998-7004)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L7059-7084)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L7085-7100)
...
### fn `def _format_external_command_for_log(command)` `priv` (L7101-7116)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L7117-7124)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L7200-7203)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7237-7256)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7257-7282)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7283-7288)

### fn `def _estimate_opencv_camera_response(` `priv` (L7318-7322)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7351-7358)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7422-7441)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7442-7447)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L7526-7539)
...
### fn `def _run_opencv_merge_backend(` `priv` (L7540-7548)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L7645-7673)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L7674-7720)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L7721-7754)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L7755-7775)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L7776-7794)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L7795-7819)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L7820-7838)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L7839-7844)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L7897-7903)

### fn `def _hdrplus_align_layer(` `priv` (L7976-7983)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L8073-8160)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L8161-8185)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L8186-8190)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8271-8277)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8326-8398)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8399-8404)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8500-8510)
...
### fn `def _collect_missing_external_executables(` `priv` (L8511-8513)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L8532-8561)
...
### fn `def _resolve_numpy_dependency()` `priv` (L8562-8581)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L8582-8622)
...
### fn `def _sanitize_finite_float_array(np_module, image_data, dtype)` `priv` (L8623-8641)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L8642-8669)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L8670-8697)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8698-8724)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8725-8749)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L8750-8755)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L8785-8805)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L8806-8811)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L8870-8887)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L8888-8892)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L8922-8972)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L8973-9021)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L9022-9047)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L9048-9064)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L9065-9095)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L9096-9156)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L9157-9179)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L9180-9204)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L9205-9235)
...
### fn `def _apply_static_postprocess_float(` `priv` (L9236-9241)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9358-9375)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9376-9393)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9394-9411)
...
### fn `def _extract_finite_luminance_samples(np_module, luminance)` `priv` (L9412-9427)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9428-9480)
...
### fn `def _should_use_low_variance_auto_brightness_fallback(` `priv` (L9481-9485)

### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L9539-9584)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L9585-9590)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L9681-9708)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L9709-9747)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L9748-9778)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L9779-9800)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L9801-9848)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L9849-9868)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L9869-9907)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L9908-9935)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L9936-9987)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L9988-10040)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L10041-10080)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L10081-10104)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L10105-10168)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L10169-10188)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L10189-10209)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L10210-10226)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L10227-10242)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L10243-10259)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L10260-10275)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L10276-10291)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L10343-10384)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L10385-10417)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L10418-10617)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L10776-10868)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L10789-10805)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L10806-10808)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L10809-10828)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L10829-10831)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L10832-10843)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L10869-11002)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L11003-11009)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L11041-11078)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L11079-11109)
...
### fn `def _read_finite_metric(metric_values, metric_key, default_value)` `priv` (L11110-11131)
...
### fn `def _read_finite_int_metric(metric_values, metric_key, default_value)` `priv` (L11132-11146)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L11147-11346)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L11377-11380)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L11464-11487)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L11488-11493)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L11537-11655)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L11656-11816)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L11686-11719)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L11817-11818)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L11848-11894)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L11895-11923)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L11924-11925)

### fn `def _f_lab(values)` `priv` (L11958-11965)
...
### fn `def _f2xyz(values)` `priv` (L11966-11972)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L12008-12009)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L12043-12148)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L12149-12150)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L12185-12207)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L12208-12231)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L12232-12276)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L12277-12278)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L12308-12309)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L12362-12363)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L12405-12408)
...
### fn `def _clamp01(np_module, values)` `priv` (L12465-12478)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L12479-12501)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L12502-12535)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L12536-12566)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L12567-12607)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L12608-12609)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L12666-12696)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L12697-12728)
...
### fn `def logistic(z_values)` (L12719-12721)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L12729-12754)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L12755-12778)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L12779-12802)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L12803-12824)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L12825-12831)

### fn `def _sanitize_auto_adjust_stage(stage_rgb)` `priv` (L12850-12861)
...
### fn `def _load_piexif_dependency()` `priv` (L12966-12983)
...
### fn `def _postprocess(` `priv` (L12984-12992)

### fn `def _encode_jpg(` `priv` (L13122-13130)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L13190-13218)
...
### fn `def _is_supported_runtime_os()` `priv` (L13219-13238)
...
### fn `def _print_validated_run_parameters(` `priv` (L13239-13254)

### fn `def run(args)` (L13432-13631)
...
|`_load_image_dependencies`|fn|priv|5430-5467|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5468-5498|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5499-5561|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5562-5656|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5606-5623|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5657-5688|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5689-5711|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5712-5713|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5744-5786|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5787-5925|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5926-5932|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5982-5996|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5997-6014|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|6015-6033|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|6034-6063|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|6064-6067|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|6089-6118|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_downsample_xphoto_analysis_image_half`|fn|priv|6119-6165|def _downsample_xphoto_analysis_image_half(np_module, ana...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|6166-6169|def _build_xphoto_analysis_image_rgb_float(|
|`_build_white_balance_robust_analysis_mask`|fn|priv|6201-6240|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_resolve_xphoto_estimation_payload_scale`|fn|priv|6241-6243|def _resolve_xphoto_estimation_payload_scale(|
|`_rescale_xphoto_estimation_payload_rgb_float`|fn|priv|6274-6276|def _rescale_xphoto_estimation_payload_rgb_float(|
|`_compress_xphoto_estimation_payload_highlights_soft_knee`|fn|priv|6303-6305|def _compress_xphoto_estimation_payload_highlights_soft_k...|
|`_quantize_xphoto_estimation_payload_rgb`|fn|priv|6346-6350|def _quantize_xphoto_estimation_payload_rgb(|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|6386-6392|def _extract_white_balance_channel_gains_from_xphoto(|
|`_probe_xphoto_uint16_payload_support`|fn|priv|6463-6485|def _probe_xphoto_uint16_payload_support(np_module, wb_al...|
|`_resolve_white_balance_xphoto_estimation_domain`|fn|priv|6486-6488|def _resolve_white_balance_xphoto_estimation_domain(|
|`_prepare_xphoto_estimation_image_rgb_float`|fn|priv|6531-6534|def _prepare_xphoto_estimation_image_rgb_float(|
|`_resolve_learning_based_wb_hist_bin_num`|fn|priv|6569-6584|def _resolve_learning_based_wb_hist_bin_num(bits_per_color)|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|6585-6592|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6680-6683|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6718-6749|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6750-6753|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_channel_gains_to_white_balance_image`|fn|priv|6779-6782|def _apply_channel_gains_to_white_balance_image(|
|`_apply_auto_white_balance_stage_float`|fn|priv|6804-6812|def _apply_auto_white_balance_stage_float(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|6905-6912|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|6998-7004|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|7059-7084|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|7085-7100|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|7101-7116|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|7117-7124|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|7200-7203|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|7237-7256|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|7257-7282|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|7283-7288|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|7318-7322|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|7351-7358|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|7422-7441|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|7442-7447|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|7526-7539|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|7540-7548|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|7645-7673|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|7674-7720|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|7721-7754|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|7755-7775|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|7776-7794|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|7795-7819|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|7820-7838|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|7839-7844|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|7897-7903|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|7976-7983|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|8073-8160|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|8161-8185|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|8186-8190|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|8271-8277|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|8326-8398|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|8399-8404|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|8500-8510|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|8511-8513|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|8532-8561|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|8562-8581|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|8582-8622|def _to_float32_image_array(np_module, image_data)|
|`_sanitize_finite_float_array`|fn|priv|8623-8641|def _sanitize_finite_float_array(np_module, image_data, d...|
|`_normalize_float_rgb_image`|fn|priv|8642-8669|def _normalize_float_rgb_image(np_module, image_data)|
|`_prepare_postprocess_entry_rgb_float`|fn|priv|8670-8697|def _prepare_postprocess_entry_rgb_float(np_module, image...|
|`_write_rgb_float_tiff16`|fn|priv|8698-8724|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|8725-8749|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|8750-8755|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|8785-8805|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_write_hdr_merge_debug_checkpoints`|fn|priv|8806-8811|def _write_hdr_merge_debug_checkpoints(|
|`_format_debug_ev_suffix_value`|fn|priv|8870-8887|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|8888-8892|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|8922-8972|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|8973-9021|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|9022-9047|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|9048-9064|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|9065-9095|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|9096-9156|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|9157-9179|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|9180-9204|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|9205-9235|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|9236-9241|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|9358-9375|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|9376-9393|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|9394-9411|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_extract_finite_luminance_samples`|fn|priv|9412-9427|def _extract_finite_luminance_samples(np_module, luminance)|
|`_analyze_luminance_key`|fn|priv|9428-9480|def _analyze_luminance_key(np_module, luminance, eps)|
|`_should_use_low_variance_auto_brightness_fallback`|fn|priv|9481-9485|def _should_use_low_variance_auto_brightness_fallback(|
|`_choose_auto_key_value`|fn|priv|9539-9584|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|9585-9590|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|9681-9708|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|9709-9747|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|9748-9778|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|9779-9800|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|9801-9848|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|9849-9868|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|9869-9907|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|9908-9935|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|9936-9987|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|9988-10040|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|10041-10080|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|10081-10104|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|10105-10168|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|10169-10188|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|10189-10209|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|10210-10226|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|10227-10242|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|10243-10259|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|10260-10275|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|10276-10291|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|10343-10384|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|10385-10417|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|10418-10617|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|10776-10868|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|10789-10805|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|10806-10808|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|10809-10828|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|10829-10831|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|10832-10843|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|10869-11002|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|11003-11009|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|11041-11078|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|11079-11109|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_read_finite_metric`|fn|priv|11110-11131|def _read_finite_metric(metric_values, metric_key, defaul...|
|`_read_finite_int_metric`|fn|priv|11132-11146|def _read_finite_int_metric(metric_values, metric_key, de...|
|`_build_auto_levels_tone_curve_state`|fn|priv|11147-11346|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|11377-11380|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|11464-11487|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|11488-11493|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|11537-11655|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|11656-11816|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|11686-11719|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|11817-11818|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|11848-11894|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|11895-11923|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|11924-11925|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|11958-11965|def _f_lab(values)|
|`_f2xyz`|fn|priv|11966-11972|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|12008-12009|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|12043-12148|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|12149-12150|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|12185-12207|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|12208-12231|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|12232-12276|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|12277-12278|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|12308-12309|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|12362-12363|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|12405-12408|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|12465-12478|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|12479-12501|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|12502-12535|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|12536-12566|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|12567-12607|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|12608-12609|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|12666-12696|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|12697-12728|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|12719-12721|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|12729-12754|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|12755-12778|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|12779-12802|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|12803-12824|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|12825-12831|def _apply_validated_auto_adjust_pipeline(|
|`_sanitize_auto_adjust_stage`|fn|priv|12850-12861|def _sanitize_auto_adjust_stage(stage_rgb)|
|`_load_piexif_dependency`|fn|priv|12966-12983|def _load_piexif_dependency()|
|`_postprocess`|fn|priv|12984-12992|def _postprocess(|
|`_encode_jpg`|fn|priv|13122-13130|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|13190-13218|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|13219-13238|def _is_supported_runtime_os()|
|`_print_validated_run_parameters`|fn|priv|13239-13254|def _print_validated_run_parameters(|
|`run`|fn|pub|13432-13631|def run(args)|
