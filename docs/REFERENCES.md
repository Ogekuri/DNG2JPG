...
# dng2jpg.py | Python | 13099L | 421 symbols | 32 imports | 272 comments
...
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA = 1.0` (L182)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS = 1.0` (L183)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST = 1.4` (L184)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 0.6` (L185)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA = 1.0` (L186)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS = 1.0` (L187)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST = 1.0` (L188)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION = 1.0` (L189)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA = 0.9` (L190)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS = 1.2` (L191)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST = 1.4` (L192)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 0.5` (L193)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L194)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L195)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L196)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L197)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L198)
- var `HDRPLUS_TILE_SIZE = 32` (L199)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L200)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L201)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L202)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L203)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L204)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L205)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L206)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L208)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L473-508)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L510-538)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L540-563)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L565-583)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L585-603)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L605-630)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L632-653)
...
### class `class OpenCvTonemapOptions` `@dataclass(frozen=True)` (L655-684)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L686-784)
...
- fn `def auto_white_balance_mode(self) -> str | None` (L746-757)
...
- fn `def auto_white_balance_analysis_source(self) -> str` (L759-770)
...
- fn `def auto_white_balance_xphoto_domain(self) -> str` (L772-784)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L786-802)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L804-822)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L824-845)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L847-867)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L869-892)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L894-913)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L915-935)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L937-954)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L956-973)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L975-993)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L994-1030)
...
### fn `def _border(left, middle, right)` `priv` (L1014-1016)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L1017-1020)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L1031-1047)
...
### fn `def _print_help_section(title)` `priv` (L1048-1062)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L1063-1104)
...
### fn `def print_help(version)` (L1105-1304)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1574-1591)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1592-1637)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1638-1650)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1651-1677)
...
### fn `def _parse_ev_center_option(ev_center_raw)` `priv` (L1678-1704)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1705-1727)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1728-1747)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1748-1767)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1768-1788)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1789-1813)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1814-1835)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1836-1888)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1889-1891)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L2062-2121)
...
### fn `def _percentile(percentile_value)` `priv` (L2096-2106)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2122-2154)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2155-2184)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2185-2188)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2235-2258)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2259-2299)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2300-2357)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2358-2361)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2408-2426)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2427-2458)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2459-2508)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2509-2557)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2558-2578)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2579-2609)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2610-2637)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2638-2659)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2660-2679)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2680-2702)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2703-2721)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2722-2767)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2768-2787)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2788-2855)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2856-2893)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2894-2922)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2923-2927)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2957-2974)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2975-2992)
...
### fn `def _resolve_auto_ev_delta(` `priv` (L2993-2997)

### fn `def _resolve_opencv_tonemap_auto_ev_delta()` `priv` (L3051-3068)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L3069-3072)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3129-3149)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3150-3176)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3177-3200)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3201-3222)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3223-3246)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3247-3322)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3323-3339)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3340-3362)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3363-3387)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3388-3410)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3411-3436)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3437-3468)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3469-3565)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3566-3597)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3598-3670)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3671-3820)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3821-3839)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3840-3916)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3917-3970)
...
### fn `def _resolve_opencv_tonemap_gamma_inverse(resolved_merge_gamma)` `priv` (L3971-4004)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L4005-4028)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L4029-4056)
...
### fn `def _parse_auto_white_balance_mode_option(auto_white_balance_raw)` `priv` (L4057-4088)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L4089-4101)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L4102-4131)
...
### fn `def _parse_white_balance_xphoto_domain_option(xphoto_domain_raw)` `priv` (L4132-4158)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L4159-4189)
...
### fn `def _resolve_default_postprocess(` `priv` (L4190-4194)

### fn `def _parse_gamma_option(option_value)` `priv` (L4303-4341)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4342-4361)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4362-4413)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4414-4482)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4483-4529)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4530-4589)
...
### fn `def _format_gamma_number(value)` `priv` (L4541-4554)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4590-4632)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4633-4664)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4665-4694)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4695-4747)
...
### fn `def _parse_run_options(args)` `priv` (L4748-4947)
...
### fn `def _load_image_dependencies()` `priv` (L5386-5423)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5424-5454)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5455-5517)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5518-5612)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5562-5579)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5613-5644)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5645-5667)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5668-5669)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5700-5742)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5743-5876)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5877-5883)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5933-5947)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5948-5965)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L5966-5984)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L5985-6014)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L6015-6018)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L6040-6069)
...
### fn `def _downsample_xphoto_analysis_image_half(np_module, analysis_rgb, cv2_module)` `priv` (L6070-6116)
...
### fn `def _build_xphoto_analysis_image_rgb_float(` `priv` (L6117-6120)

### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L6152-6191)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L6192-6198)

### fn `def _resolve_white_balance_xphoto_estimation_domain(` `priv` (L6278-6280)
...
### fn `def _prepare_xphoto_estimation_image_rgb_float(` `priv` (L6323-6326)
...
### fn `def _resolve_learning_based_wb_hist_bin_num(bits_per_color)` `priv` (L6361-6376)
...
### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L6377-6384)

### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6459-6462)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6497-6528)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6529-6532)

### fn `def _apply_channel_gains_to_white_balance_image(` `priv` (L6558-6561)
...
### fn `def _apply_auto_white_balance_stage_float(` `priv` (L6583-6591)
...
### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6684-6691)

### fn `def _extract_bracket_images_float(` `priv` (L6777-6783)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L6838-6863)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L6864-6879)
...
### fn `def _format_external_command_for_log(command)` `priv` (L6880-6895)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L6896-6903)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L6979-6982)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L7016-7035)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L7036-7061)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L7062-7067)

### fn `def _estimate_opencv_camera_response(` `priv` (L7097-7101)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L7130-7137)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L7201-7220)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L7221-7226)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L7305-7318)
...
### fn `def _run_opencv_merge_backend(` `priv` (L7319-7327)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L7424-7452)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L7453-7499)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L7500-7533)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L7534-7554)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L7555-7573)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L7574-7598)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L7599-7617)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L7618-7623)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L7676-7682)

### fn `def _hdrplus_align_layer(` `priv` (L7755-7762)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L7852-7939)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L7940-7964)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L7965-7969)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L8050-8056)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L8105-8177)
...
### fn `def _run_hdr_plus_merge(` `priv` (L8178-8183)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L8279-8289)
...
### fn `def _collect_missing_external_executables(` `priv` (L8290-8292)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L8311-8340)
...
### fn `def _resolve_numpy_dependency()` `priv` (L8341-8360)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L8361-8392)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L8393-8420)
...
### fn `def _prepare_postprocess_entry_rgb_float(np_module, image_data)` `priv` (L8421-8448)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8449-8475)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L8476-8500)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L8501-8506)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L8536-8556)
...
### fn `def _write_hdr_merge_debug_checkpoints(` `priv` (L8557-8562)

### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L8621-8638)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L8639-8643)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L8673-8723)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L8724-8772)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L8773-8798)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L8799-8815)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L8816-8842)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L8843-8887)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L8888-8910)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L8911-8935)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L8936-8966)
...
### fn `def _apply_static_postprocess_float(` `priv` (L8967-8972)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L9089-9106)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L9107-9124)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L9125-9142)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L9143-9182)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L9183-9228)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L9229-9234)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L9268-9295)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L9296-9334)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L9335-9360)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L9361-9382)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L9383-9430)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L9431-9450)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L9451-9489)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L9490-9517)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L9518-9569)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L9570-9622)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L9623-9654)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L9655-9678)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L9679-9728)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L9729-9748)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L9749-9769)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L9770-9786)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L9787-9802)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L9803-9819)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L9820-9835)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L9836-9851)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L9903-9938)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L9939-9971)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L9972-10171)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L10245-10337)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L10258-10274)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L10275-10277)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L10278-10297)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L10298-10300)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L10301-10312)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L10338-10471)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L10472-10478)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L10510-10541)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L10542-10572)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L10573-10762)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L10763-10766)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L10850-10873)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L10874-10879)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L10923-11026)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L11027-11187)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L11057-11090)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L11188-11189)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L11219-11265)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L11266-11294)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L11295-11296)

### fn `def _f_lab(values)` `priv` (L11329-11336)
...
### fn `def _f2xyz(values)` `priv` (L11337-11343)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L11379-11380)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L11414-11519)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L11520-11521)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L11556-11578)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L11579-11602)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L11603-11647)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L11648-11649)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L11679-11680)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L11733-11734)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L11776-11779)
...
### fn `def _clamp01(np_module, values)` `priv` (L11835-11848)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L11849-11871)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L11872-11905)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L11906-11936)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L11937-11977)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L11978-11979)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L12028-12050)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L12051-12075)
...
### fn `def logistic(z_values)` (L12066-12068)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L12076-12093)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L12094-12117)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L12118-12141)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L12142-12163)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L12164-12170)

### fn `def _load_piexif_dependency()` `priv` (L12279-12296)
...
### fn `def _postprocess(` `priv` (L12297-12305)

### fn `def _encode_jpg(` `priv` (L12435-12443)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L12503-12531)
...
### fn `def _is_supported_runtime_os()` `priv` (L12532-12551)
...
|`DEFAULT_OPENCV_TONEMAP_DRAGO_POST_GAMMA`|var|pub|182||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BRIGHTNESS`|var|pub|183||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_CONTRAST`|var|pub|184||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|185||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_POST_GAMMA`|var|pub|186||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_BRIGHTNESS`|var|pub|187||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_CONTRAST`|var|pub|188||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_SATURATION`|var|pub|189||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_POST_GAMMA`|var|pub|190||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_BRIGHTNESS`|var|pub|191||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_CONTRAST`|var|pub|192||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|193||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|194||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|195||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|196||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|197||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|198||
|`HDRPLUS_TILE_SIZE`|var|pub|199||
|`HDRPLUS_TILE_STRIDE`|var|pub|200||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|201||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|202||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|203||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|204||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|205||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|206||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|208||
|`AutoAdjustOptions`|class|pub|473-508|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|510-538|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|540-563|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|565-583|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|585-603|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|605-630|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|632-653|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|655-684|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|686-784|class PostprocessOptions|
|`PostprocessOptions.auto_white_balance_mode`|fn|pub|746-757|def auto_white_balance_mode(self) -> str | None|
|`PostprocessOptions.auto_white_balance_analysis_source`|fn|pub|759-770|def auto_white_balance_analysis_source(self) -> str|
|`PostprocessOptions.auto_white_balance_xphoto_domain`|fn|pub|772-784|def auto_white_balance_xphoto_domain(self) -> str|
|`DebugArtifactContext`|class|pub|786-802|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|804-822|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|824-845|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|847-867|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|869-892|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|894-913|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|915-935|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|937-954|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|956-973|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|975-993|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|994-1030|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|1014-1016|def _border(left, middle, right)|
|`_line`|fn|priv|1017-1020|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|1031-1047|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|1048-1062|def _print_help_section(title)|
|`_print_help_option`|fn|priv|1063-1104|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1105-1304|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1574-1591|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1592-1637|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1638-1650|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1651-1677|def _parse_ev_option(ev_raw)|
|`_parse_ev_center_option`|fn|priv|1678-1704|def _parse_ev_center_option(ev_center_raw)|
|`_parse_percentage_option`|fn|priv|1705-1727|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1728-1747|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1748-1767|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1768-1788|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1789-1813|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1814-1835|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1836-1888|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1889-1891|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|2062-2121|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2096-2106|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2122-2154|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2155-2184|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2185-2188|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2235-2258|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2259-2299|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2300-2357|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2358-2361|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2408-2426|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2427-2458|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2459-2508|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2509-2557|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2558-2578|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2579-2609|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2610-2637|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2638-2659|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2660-2679|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2680-2702|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2703-2721|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2722-2767|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2768-2787|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2788-2855|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2856-2893|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2894-2922|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2923-2927|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2957-2974|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2975-2992|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_auto_ev_delta`|fn|priv|2993-2997|def _resolve_auto_ev_delta(|
|`_resolve_opencv_tonemap_auto_ev_delta`|fn|priv|3051-3068|def _resolve_opencv_tonemap_auto_ev_delta()|
|`_resolve_joint_auto_ev_solution`|fn|priv|3069-3072|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3129-3149|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3150-3176|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3177-3200|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3201-3222|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3223-3246|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3247-3322|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3323-3339|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|