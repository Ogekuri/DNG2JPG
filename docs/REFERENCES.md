...
# dng2jpg.py | Python | 6440L | 203 symbols | 23 imports | 136 comments
...
- var `DEFAULT_AL_CLIP_OUT_OF_GAMUT = True` (L62)
- var `DEFAULT_AL_GAIN_THRESHOLD = 1.0` (L63)
- var `DEFAULT_AL_HISTCOMPR = 3` (L64)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L352-375)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L377-411)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L413-433)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L435-449)
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L451-478)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L479-515)
...
### fn `def _border(left, middle, right)` `priv` (L499-501)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L502-505)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L516-532)
...
### fn `def print_help(version)` (L533-732)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L791-809)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L810-822)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L823-839)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L840-868)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L869-914)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L915-928)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L929-960)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L961-991)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L992-1009)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1010-1027)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1028-1050)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1051-1068)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1069-1086)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1087-1107)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1108-1121)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1122-1143)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1144-1165)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1166-1180)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1181-1240)
...
### fn `def _percentile(percentile_value)` `priv` (L1215-1225)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1241-1260)
...
### fn `def _derive_scene_key_preserving_median_target(p_median)` `priv` (L1261-1279)
...
### fn `def _optimize_auto_zero(auto_ev_inputs)` `priv` (L1280-1303)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1304-1333)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1334-1339)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L1367-1394)
...
### fn `def _resolve_ev_zero(` `priv` (L1395-1402)

### fn `def _resolve_ev_value(` `priv` (L1453-1460)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L1513-1533)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L1534-1570)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L1571-1594)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L1595-1611)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L1612-1634)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1635-1659)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L1660-1682)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L1683-1708)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L1709-1810)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L1811-1842)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L1843-1906)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L1907-2013)
...
### fn `def _parse_auto_adjust_mode_option(auto_adjust_raw)` `priv` (L2014-2037)
...
### fn `def _resolve_default_postprocess(` `priv` (L2038-2042)

### fn `def _parse_run_options(args)` `priv` (L2090-2289)
...
### fn `def _load_image_dependencies()` `priv` (L2816-2853)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L2854-2884)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L2885-2942)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L2943-2974)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L2975-2997)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L2998-2999)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L3028-3070)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L3071-3204)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L3205-3210)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L3259-3273)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L3274-3290)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L3291-3309)
...
### fn `def _write_bracket_images(` `priv` (L3310-3311)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L3348-3373)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L3374-3389)
...
### fn `def _run_enfuse(bracket_paths, merged_tiff)` `priv` (L3390-3410)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L3411-3412)

### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L3464-3491)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L3492-3526)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L3527-3533)

### fn `def _hdrplus_box_down2_uint16(np_module, frames_uint16)` `priv` (L3609-3636)
...
### fn `def _hdrplus_luminance_proxy_uint16(np_module, frames_rgb_uint16)` `priv` (L3637-3654)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L3655-3660)

### fn `def _hdrplus_compute_temporal_weights(np_module, layer_tiles)` `priv` (L3713-3755)
...
### fn `def _hdrplus_merge_temporal_rgb(np_module, full_tiles_rgb, weights, total_weight)` `priv` (L3756-3782)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L3783-3853)
...
### fn `def _run_hdr_plus_merge(bracket_paths, output_hdr_tiff, imageio_module, np_module)` `priv` (L3854-3916)
...
### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L3917-3929)
...
### fn `def _resolve_imagemagick_command()` `priv` (L3930-3947)
...
### fn `def _resolve_auto_adjust_opencv_dependencies()` `priv` (L3948-3972)
...
### fn `def _resolve_numpy_dependency()` `priv` (L3973-3990)
...
### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L3991-4037)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L4038-4082)
...
### fn `def _normalize_uint16_rgb_image(np_module, image_data)` `priv` (L4083-4110)
...
### fn `def _validate_uint16_rgb_stage_image(np_module, image_rgb_uint16, stage_label)` `priv` (L4111-4132)
...
### fn `def _apply_post_gamma_uint16(np_module, image_rgb_uint16, gamma_value)` `priv` (L4133-4169)
...
### fn `def _blend_uint16(np_module, base_uint16, target_uint16, factor)` `priv` (L4170-4188)
...
### fn `def _apply_brightness_uint16(np_module, image_rgb_uint16, brightness_factor)` `priv` (L4189-4218)
...
### fn `def _apply_contrast_uint16(np_module, image_rgb_uint16, contrast_factor)` `priv` (L4219-4249)
...
### fn `def _apply_saturation_uint16(np_module, image_rgb_uint16, saturation_factor)` `priv` (L4250-4285)
...
### fn `def _apply_static_postprocess_uint16(np_module, image_rgb_uint16, postprocess_options)` `priv` (L4286-4326)
...
### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L4327-4344)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L4345-4362)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L4363-4380)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L4381-4419)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L4420-4465)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L4466-4471)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L4505-4532)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L4533-4568)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L4569-4588)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L4589-4609)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L4610-4637)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L4638-4837)
...
### fn `def _apply_auto_levels_uint16(np_module, image_rgb_uint16, auto_levels_options)` `priv` (L4892-4971)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L4972-4990)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L4991-5036)
...
### fn `def _hlrecovery_cielab_uint16(` `priv` (L5037-5038)

### fn `def _f_lab(values)` `priv` (L5071-5078)
...
### fn `def _f2xyz(values)` `priv` (L5079-5085)

### fn `def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax, maxval=65535.0)` `priv` (L5121-5223)
...
### fn `def _dilate_mask_uint16(np_module, mask)` `priv` (L5224-5246)
...
### fn `def _box_mean_3x3_uint16(np_module, image_2d)` `priv` (L5247-5270)
...
### fn `def _hlrecovery_color_propagation_uint16(np_module, image_rgb, maxval=65535.0)` `priv` (L5271-5315)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L5316-5317)

### fn `def _apply_auto_brightness_rgb_uint8(np_module, image_rgb_uint8, auto_brightness_options)` `priv` (L5370-5434)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L5435-5436)

### fn `def _clamp01(np_module, values)` `priv` (L5517-5530)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L5531-5553)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L5554-5587)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L5588-5618)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L5619-5659)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L5660-5661)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L5710-5732)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L5733-5757)
...
### fn `def logistic(z_values)` (L5748-5750)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L5758-5775)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L5776-5799)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L5800-5823)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L5824-5845)
...
### fn `def _apply_validated_auto_adjust_pipeline_opencv(` `priv` (L5846-5847)

### fn `def _load_piexif_dependency()` `priv` (L5926-5943)
...
### fn `def _encode_jpg(` `priv` (L5944-5956)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L6103-6131)
...
### fn `def _is_supported_runtime_os()` `priv` (L6132-6151)
...
|`DEFAULT_AL_CLIP_OUT_OF_GAMUT`|var|pub|62||
|`DEFAULT_AL_GAIN_THRESHOLD`|var|pub|63||
|`DEFAULT_AL_HISTCOMPR`|var|pub|64||
...
|`AutoLevelsOptions`|class|pub|352-375|class AutoLevelsOptions|
|`PostprocessOptions`|class|pub|377-411|class PostprocessOptions|
|`LuminanceOptions`|class|pub|413-433|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|435-449|class OpenCvMergeOptions|
|`AutoEvInputs`|class|pub|451-478|class AutoEvInputs|
|`_print_box_table`|fn|priv|479-515|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|499-501|def _border(left, middle, right)|
|`_line`|fn|priv|502-505|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|516-532|def _build_two_line_operator_rows(operator_entries)|
|`print_help`|fn|pub|533-732|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|791-809|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|810-822|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|823-839|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|840-868|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|869-914|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|915-928|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|929-960|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|961-991|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|992-1009|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1010-1027|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1028-1050|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1051-1068|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1069-1086|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1087-1107|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_clamp_ev_to_supported`|fn|priv|1108-1121|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1122-1143|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1144-1165|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1166-1180|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1181-1240|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1215-1225|def _percentile(percentile_value)|
|`_coerce_positive_luminance`|fn|priv|1241-1260|def _coerce_positive_luminance(value, fallback)|
|`_derive_scene_key_preserving_median_target`|fn|priv|1261-1279|def _derive_scene_key_preserving_median_target(p_median)|
|`_optimize_auto_zero`|fn|priv|1280-1303|def _optimize_auto_zero(auto_ev_inputs)|
|`_optimize_adaptive_ev_delta`|fn|priv|1304-1333|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1334-1339|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|1367-1394|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|1395-1402|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|1453-1460|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|1513-1533|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|1534-1570|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|1571-1594|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|1595-1611|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|1612-1634|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|1635-1659|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|1660-1682|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|1683-1708|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_auto_brightness_options`|fn|priv|1709-1810|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|1811-1842|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|1843-1906|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|1907-2013|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_auto_adjust_mode_option`|fn|priv|2014-2037|def _parse_auto_adjust_mode_option(auto_adjust_raw)|
|`_resolve_default_postprocess`|fn|priv|2038-2042|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|2090-2289|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|2816-2853|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|2854-2884|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|2885-2942|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|2943-2974|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|2975-2997|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|2998-2999|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|3028-3070|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|3071-3204|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|3205-3210|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|3259-3273|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|3274-3290|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|3291-3309|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_write_bracket_images`|fn|priv|3310-3311|def _write_bracket_images(|
|`_order_bracket_paths`|fn|priv|3348-3373|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|3374-3389|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_enfuse`|fn|priv|3390-3410|def _run_enfuse(bracket_paths, merged_tiff)|
|`_run_luminance_hdr_cli`|fn|priv|3411-3412|def _run_luminance_hdr_cli(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|3464-3491|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|3492-3526|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|3527-3533|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_uint16`|fn|priv|3609-3636|def _hdrplus_box_down2_uint16(np_module, frames_uint16)|
|`_hdrplus_luminance_proxy_uint16`|fn|priv|3637-3654|def _hdrplus_luminance_proxy_uint16(np_module, frames_rgb...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|3655-3660|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_compute_temporal_weights`|fn|priv|3713-3755|def _hdrplus_compute_temporal_weights(np_module, layer_ti...|
|`_hdrplus_merge_temporal_rgb`|fn|priv|3756-3782|def _hdrplus_merge_temporal_rgb(np_module, full_tiles_rgb...|
|`_hdrplus_merge_spatial_rgb`|fn|priv|3783-3853|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|3854-3916|def _run_hdr_plus_merge(bracket_paths, output_hdr_tiff, i...|
|`_convert_compression_to_quality`|fn|priv|3917-3929|def _convert_compression_to_quality(jpg_compression)|
|`_resolve_imagemagick_command`|fn|priv|3930-3947|def _resolve_imagemagick_command()|
|`_resolve_auto_adjust_opencv_dependencies`|fn|priv|3948-3972|def _resolve_auto_adjust_opencv_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|3973-3990|def _resolve_numpy_dependency()|
|`_to_uint8_image_array`|fn|priv|3991-4037|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|4038-4082|def _to_uint16_image_array(np_module, image_data)|
|`_normalize_uint16_rgb_image`|fn|priv|4083-4110|def _normalize_uint16_rgb_image(np_module, image_data)|
|`_validate_uint16_rgb_stage_image`|fn|priv|4111-4132|def _validate_uint16_rgb_stage_image(np_module, image_rgb...|
|`_apply_post_gamma_uint16`|fn|priv|4133-4169|def _apply_post_gamma_uint16(np_module, image_rgb_uint16,...|
|`_blend_uint16`|fn|priv|4170-4188|def _blend_uint16(np_module, base_uint16, target_uint16, ...|
|`_apply_brightness_uint16`|fn|priv|4189-4218|def _apply_brightness_uint16(np_module, image_rgb_uint16,...|
|`_apply_contrast_uint16`|fn|priv|4219-4249|def _apply_contrast_uint16(np_module, image_rgb_uint16, c...|
|`_apply_saturation_uint16`|fn|priv|4250-4285|def _apply_saturation_uint16(np_module, image_rgb_uint16,...|
|`_apply_static_postprocess_uint16`|fn|priv|4286-4326|def _apply_static_postprocess_uint16(np_module, image_rgb...|
|`_to_linear_srgb`|fn|priv|4327-4344|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|4345-4362|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|4363-4380|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|4381-4419|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|4420-4465|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|4466-4471|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|4505-4532|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|4533-4568|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_rt_gamma2`|fn|priv|4569-4588|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|4589-4609|def _rt_igamma2(np_module, values)|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|4610-4637|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|4638-4837|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_apply_auto_levels_uint16`|fn|priv|4892-4971|def _apply_auto_levels_uint16(np_module, image_rgb_uint16...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|4972-4990|def _clip_auto_levels_out_of_gamut_uint16(np_module, imag...|
|`_hlrecovery_luminance_uint16`|fn|priv|4991-5036|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_uint16`|fn|priv|5037-5038|def _hlrecovery_cielab_uint16(|
|`_f_lab`|fn|priv|5071-5078|def _f_lab(values)|
|`_f2xyz`|fn|priv|5079-5085|def _f2xyz(values)|
|`_hlrecovery_blend_uint16`|fn|priv|5121-5223|def _hlrecovery_blend_uint16(np_module, image_rgb, hlmax,...|
|`_dilate_mask_uint16`|fn|priv|5224-5246|def _dilate_mask_uint16(np_module, mask)|
|`_box_mean_3x3_uint16`|fn|priv|5247-5270|def _box_mean_3x3_uint16(np_module, image_2d)|
|`_hlrecovery_color_propagation_uint16`|fn|priv|5271-5315|def _hlrecovery_color_propagation_uint16(np_module, image...|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|5316-5317|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_uint8`|fn|priv|5370-5434|def _apply_auto_brightness_rgb_uint8(np_module, image_rgb...|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|5435-5436|def _apply_validated_auto_adjust_pipeline(|
|`_clamp01`|fn|priv|5517-5530|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|5531-5553|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|5554-5587|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|5588-5618|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|5619-5659|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|5660-5661|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|5710-5732|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|5733-5757|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|5748-5750|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|5758-5775|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|5776-5799|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|5800-5823|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|5824-5845|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline_opencv`|fn|priv|5846-5847|def _apply_validated_auto_adjust_pipeline_opencv(|
|`_load_piexif_dependency`|fn|priv|5926-5943|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|5944-5956|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|6103-6131|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|6132-6151|def _is_supported_runtime_os()|
|`run`|fn|pub|6152-6351|def run(args)|
