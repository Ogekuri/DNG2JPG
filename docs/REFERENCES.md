...
# dng2jpg.py | Python | 12291L | 388 symbols | 30 imports | 256 comments
...
- var `RAW_WHITE_BALANCE_MODE_GREEN = "GREEN"` (L123)
- var `RAW_WHITE_BALANCE_MODE_MAX = "MAX"` (L124)
- var `RAW_WHITE_BALANCE_MODE_MIN = "MIN"` (L125)
- var `RAW_WHITE_BALANCE_MODE_MEAN = "MEAN"` (L126)
- var `DEFAULT_RAW_WHITE_BALANCE_MODE = RAW_WHITE_BALANCE_MODE_MEAN` (L127)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO = "ev-zero"` (L128)
- var `WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE = "linear-base"` (L129)
- var `OPENCV_TONEMAP_MAP_DRAGO = "drago"` (L130)
- var `OPENCV_TONEMAP_MAP_REINHARD = "reinhard"` (L131)
- var `OPENCV_TONEMAP_MAP_MANTIUK = "mantiuk"` (L132)
- var `OPENCV_MERGE_ALGORITHM_DEBEVEC = "Debevec"` (L133)
- var `OPENCV_MERGE_ALGORITHM_ROBERTSON = "Robertson"` (L134)
- var `OPENCV_MERGE_ALGORITHM_MERTENS = "Mertens"` (L135)
- var `DEFAULT_REINHARD02_POST_GAMMA = 0.9` (L136)
- var `DEFAULT_REINHARD02_BRIGHTNESS = 1.3` (L137)
- var `DEFAULT_REINHARD02_CONTRAST = 0.75` (L138)
- var `DEFAULT_REINHARD02_SATURATION = 0.7` (L139)
- var `DEFAULT_MANTIUK08_POST_GAMMA = 0.8` (L140)
- var `DEFAULT_MANTIUK08_BRIGHTNESS = 0.8` (L141)
- var `DEFAULT_MANTIUK08_CONTRAST = 1.1` (L142)
- var `DEFAULT_MANTIUK08_SATURATION = 1.05` (L143)
- var `DEFAULT_HDRPLUS_POST_GAMMA = 0.8` (L144)
- var `DEFAULT_HDRPLUS_BRIGHTNESS = 0.9` (L145)
- var `DEFAULT_HDRPLUS_CONTRAST = 1.0` (L146)
- var `DEFAULT_HDRPLUS_SATURATION = 1.0` (L147)
- var `DEFAULT_OPENCV_DEBEVEC_POST_GAMMA = 1.0` (L148)
- var `DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS = 1.0` (L149)
- var `DEFAULT_OPENCV_DEBEVEC_CONTRAST = 1.5` (L150)
- var `DEFAULT_OPENCV_DEBEVEC_SATURATION = 1.05` (L151)
- var `DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA = 1.0` (L152)
- var `DEFAULT_OPENCV_ROBERTSON_POST_GAMMA = 1.0` (L153)
- var `DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS = 1.0` (L154)
- var `DEFAULT_OPENCV_ROBERTSON_CONTRAST = 1.4` (L155)
- var `DEFAULT_OPENCV_ROBERTSON_SATURATION = 1.05` (L156)
- var `DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA = 0.9` (L157)
- var `DEFAULT_OPENCV_MERTENS_POST_GAMMA = 1.0` (L158)
- var `DEFAULT_OPENCV_MERTENS_BRIGHTNESS = 0.9` (L159)
- var `DEFAULT_OPENCV_MERTENS_CONTRAST = 1.3` (L160)
- var `DEFAULT_OPENCV_MERTENS_SATURATION = 1.1` (L161)
- var `DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA = 0.8` (L162)
- var `DEFAULT_OPENCV_POST_GAMMA = DEFAULT_OPENCV_ROBERTSON_POST_GAMMA` (L163)
- var `DEFAULT_OPENCV_BRIGHTNESS = DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS` (L164)
- var `DEFAULT_OPENCV_CONTRAST = DEFAULT_OPENCV_ROBERTSON_CONTRAST` (L165)
- var `DEFAULT_OPENCV_SATURATION = DEFAULT_OPENCV_ROBERTSON_SATURATION` (L166)
- var `DEFAULT_OPENCV_MERGE_ALGORITHM = OPENCV_MERGE_ALGORITHM_ROBERTSON` (L167)
- var `DEFAULT_OPENCV_TONEMAP_ENABLED = True` (L168)
- var `DEFAULT_OPENCV_TONEMAP_GAMMA = DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA` (L169)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION = 1.0` (L170)
- var `DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS = 0.85` (L171)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY = 0.0` (L172)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT = 0.0` (L173)
- var `DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT = 0.0` (L174)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE = 0.7` (L175)
- var `DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION = 1.0` (L176)
- var `DEFAULT_HDRPLUS_PROXY_MODE = "rggb"` (L177)
- var `DEFAULT_HDRPLUS_SEARCH_RADIUS = 4` (L178)
- var `DEFAULT_HDRPLUS_TEMPORAL_FACTOR = 8.0` (L179)
- var `DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST = 10.0` (L180)
- var `DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST = 300.0` (L181)
- var `HDRPLUS_TILE_SIZE = 32` (L182)
- var `HDRPLUS_TILE_STRIDE = HDRPLUS_TILE_SIZE // 2` (L183)
- var `HDRPLUS_DOWNSAMPLED_TILE_SIZE = HDRPLUS_TILE_STRIDE` (L184)
- var `HDRPLUS_ALIGNMENT_LEVELS = 3` (L185)
- var `HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE = 4` (L186)
- var `HDRPLUS_TEMPORAL_FACTOR = DEFAULT_HDRPLUS_TEMPORAL_FACTOR` (L187)
- var `HDRPLUS_TEMPORAL_MIN_DIST = DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST` (L188)
- var `HDRPLUS_TEMPORAL_MAX_DIST = DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST` (L189)
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L191)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L448-483)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L485-513)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L515-538)
...
### class `class PostGammaAutoOptions` `@dataclass(frozen=True)` (L540-558)
...
### class `class MergeGammaOption` `@dataclass(frozen=True)` (L560-578)
...
### class `class ResolvedMergeGamma` `@dataclass(frozen=True)` (L580-605)
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L607-628)
...
### class `class OpenCvTonemapOptions` `@dataclass(frozen=True)` (L630-659)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L661-714)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L716-732)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L734-752)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L754-775)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L777-797)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L799-822)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L824-843)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L845-865)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L867-884)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L886-903)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L905-923)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L924-960)
...
### fn `def _border(left, middle, right)` `priv` (L944-946)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L947-950)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L961-977)
...
### fn `def _print_help_section(title)` `priv` (L978-992)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L993-1034)
...
### fn `def print_help(version)` (L1035-1234)
...
### fn `def _validate_supported_bits_per_color(bits_per_color)` `priv` (L1496-1513)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1514-1559)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1560-1572)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1573-1598)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1599-1623)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1624-1643)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1644-1666)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1667-1686)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1687-1706)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1707-1727)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1728-1752)
...
### fn `def _resolve_default_opencv_tonemap_gamma(merge_algorithm)` `priv` (L1753-1774)
...
### fn `def _parse_opencv_merge_backend_options(opencv_raw_values)` `priv` (L1775-1826)
...
### fn `def _parse_opencv_tonemap_backend_options(` `priv` (L1827-1829)

### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1993-2052)
...
### fn `def _percentile(percentile_value)` `priv` (L2027-2037)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_camera_whitebalance_rgb_triplet(raw_handle)` `priv` (L2053-2085)
...
### fn `def _format_rgb_triplet_fixed4(rgb_values)` `priv` (L2086-2115)
...
### fn `def _normalize_white_balance_gains_rgb(` `priv` (L2116-2119)

### fn `def _apply_normalized_white_balance_to_rgb_float(np_module, image_rgb_float, normalized_gains_rgb)` `priv` (L2166-2189)
...
### fn `def _build_rawpy_neutral_postprocess_kwargs(raw_handle)` `priv` (L2190-2230)
...
### fn `def _extract_sensor_dynamic_range_max(raw_handle, np_module)` `priv` (L2231-2288)
...
### fn `def _extract_base_rgb_linear_float(` `priv` (L2289-2292)

### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L2339-2357)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L2358-2389)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L2390-2439)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L2440-2488)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L2489-2509)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L2510-2540)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L2541-2568)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L2569-2590)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L2591-2610)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L2611-2633)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L2634-2652)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2653-2698)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2699-2718)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2719-2786)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2787-2824)
...
### fn `def _select_ev_zero_candidate(evaluations)` `priv` (L2825-2853)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2854-2858)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2888-2905)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2906-2923)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2924-2927)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L3013-3033)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L3034-3060)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L3061-3084)
...
### fn `def _parse_post_gamma_selector_option(option_raw)` `priv` (L3085-3106)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L3107-3130)
...
### fn `def _parse_post_gamma_auto_options(post_gamma_auto_raw_values)` `priv` (L3131-3206)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L3207-3223)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L3224-3246)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3247-3271)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L3272-3294)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L3295-3320)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L3321-3352)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L3353-3449)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L3450-3481)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L3482-3554)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L3555-3704)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L3705-3723)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L3724-3800)
...
### fn `def _apply_merge_gamma_float_no_clip(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3801-3854)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L3855-3878)
...
### fn `def _parse_raw_white_balance_mode_option(raw_white_balance_mode_raw)` `priv` (L3879-3906)
...
### fn `def _parse_white_balance_mode_option(white_balance_raw)` `priv` (L3907-3935)
...
### fn `def _parse_white_balance_analysis_source_option(analysis_source_raw)` `priv` (L3936-3965)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L3966-3996)
...
### fn `def _resolve_default_postprocess(` `priv` (L3997-4000)

### fn `def _parse_gamma_option(option_value)` `priv` (L4081-4119)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L4120-4139)
...
### fn `def _exiftool_color_space_fallback(input_dng)` `priv` (L4140-4191)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L4192-4260)
...
### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L4261-4307)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L4308-4367)
...
### fn `def _format_gamma_number(value)` `priv` (L4319-4332)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L4368-4410)
...
### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L4411-4442)
...
### fn `def _ensure_three_channel_float_array_no_bounds(np_module, image_data)` `priv` (L4443-4472)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L4473-4525)
...
### fn `def _load_image_dependencies()` `priv` (L5188-5225)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L5226-5256)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L5257-5319)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L5320-5414)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L5364-5381)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L5415-5446)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L5447-5469)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L5470-5471)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L5502-5544)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L5545-5678)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L5679-5685)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L5735-5749)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L5750-5767)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L5768-5786)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L5787-5816)
...
### fn `def _build_white_balance_analysis_image_from_linear_base_float(` `priv` (L5817-5820)

### fn `def _validate_white_balance_triplet_shape(np_module, bracket_images_float)` `priv` (L5842-5869)
...
### fn `def _build_xphoto_analysis_image_rgb_float(np_module, analysis_image_rgb_float)` `priv` (L5870-5895)
...
### fn `def _build_white_balance_robust_analysis_mask(np_module, analysis_rgb_float)` `priv` (L5896-5928)
...
### fn `def _extract_white_balance_channel_gains_from_xphoto(` `priv` (L5929-5933)

### fn `def _estimate_xphoto_white_balance_gains_rgb(` `priv` (L5990-5994)
...
### fn `def _estimate_color_constancy_white_balance_gains_rgb(` `priv` (L6042-6045)
...
### fn `def _estimate_ttl_white_balance_gains_rgb(np_module, analysis_image_rgb_float)` `priv` (L6080-6111)
...
### fn `def _apply_channel_gains_to_white_balance_triplet(` `priv` (L6112-6115)

### fn `def _apply_white_balance_to_bracket_triplet(` `priv` (L6141-6145)
...
### fn `def _extract_bracket_images_float(` `priv` (L6225-6230)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L6266-6291)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L6292-6307)
...
### fn `def _format_external_command_for_log(command)` `priv` (L6308-6323)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L6324-6331)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L6407-6410)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L6444-6463)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L6464-6489)
...
### fn `def _run_opencv_merge_mertens(` `priv` (L6490-6495)

### fn `def _estimate_opencv_camera_response(` `priv` (L6525-6529)
...
### fn `def _run_opencv_merge_radiance(` `priv` (L6558-6565)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L6629-6648)
...
### fn `def _run_opencv_tonemap_backend(` `priv` (L6649-6653)

### fn `def _derive_opencv_tonemap_enabled(postprocess_options)` `priv` (L6722-6735)
...
### fn `def _run_opencv_merge_backend(` `priv` (L6736-6743)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L6831-6859)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L6860-6906)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L6907-6940)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L6941-6961)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L6962-6980)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L6981-7005)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L7006-7024)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L7025-7030)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L7083-7089)

### fn `def _hdrplus_align_layer(` `priv` (L7162-7169)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L7259-7346)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L7347-7371)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L7372-7376)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L7457-7463)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L7512-7584)
...
### fn `def _run_hdr_plus_merge(` `priv` (L7585-7589)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L7677-7687)
...
### fn `def _collect_missing_external_executables(` `priv` (L7688-7690)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L7709-7738)
...
### fn `def _resolve_numpy_dependency()` `priv` (L7739-7758)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L7759-7790)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L7791-7818)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7819-7845)
...
### fn `def _write_rgb_float_tiff32(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L7846-7870)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L7871-7876)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L7906-7926)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L7927-7944)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L7945-7949)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L7979-8025)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L8026-8070)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L8071-8096)
...
### fn `def _build_auto_post_gamma_lut_float(np_module, gamma_value, lut_size)` `priv` (L8097-8113)
...
### fn `def _ensure_three_channel_float_array_no_range_adjust(np_module, image_data)` `priv` (L8114-8140)
...
### fn `def _apply_auto_post_gamma_float(np_module, image_rgb_float, post_gamma_auto_options)` `priv` (L8141-8185)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L8186-8208)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L8209-8233)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L8234-8264)
...
### fn `def _apply_static_postprocess_float(` `priv` (L8265-8270)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L8387-8404)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L8405-8422)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L8423-8440)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L8441-8480)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L8481-8526)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L8527-8532)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L8566-8593)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L8594-8632)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L8633-8658)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L8659-8680)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L8681-8728)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L8729-8748)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L8749-8787)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L8788-8815)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L8816-8867)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L8868-8920)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L8921-8952)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L8953-8976)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L8977-9026)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L9027-9046)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L9047-9067)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L9068-9084)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L9085-9100)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L9101-9117)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L9118-9133)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L9134-9149)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L9201-9236)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L9237-9269)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L9270-9469)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L9543-9635)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L9556-9572)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L9573-9575)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L9576-9595)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L9596-9598)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L9599-9610)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L9636-9769)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L9770-9776)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L9808-9839)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L9840-9870)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L9871-10060)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L10061-10064)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L10148-10171)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L10172-10177)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L10221-10324)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L10325-10485)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L10355-10388)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L10486-10487)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L10517-10563)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L10564-10592)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L10593-10594)

### fn `def _f_lab(values)` `priv` (L10627-10634)
...
### fn `def _f2xyz(values)` `priv` (L10635-10641)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L10677-10678)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L10712-10817)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L10818-10819)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L10854-10876)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L10877-10900)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L10901-10945)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L10946-10947)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L10977-10978)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L11031-11032)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L11074-11077)
...
### fn `def _clamp01(np_module, values)` `priv` (L11135-11148)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L11149-11171)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L11172-11205)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L11206-11236)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L11237-11277)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L11278-11279)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L11328-11350)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L11351-11375)
...
### fn `def logistic(z_values)` (L11366-11368)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L11376-11393)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L11394-11417)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L11418-11441)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L11442-11463)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L11464-11470)

### fn `def _load_piexif_dependency()` `priv` (L11579-11596)
...
### fn `def _encode_jpg(` `priv` (L11597-11608)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L11742-11770)
...
### fn `def _is_supported_runtime_os()` `priv` (L11771-11790)
...
|`RAW_WHITE_BALANCE_MODE_GREEN`|var|pub|123||
|`RAW_WHITE_BALANCE_MODE_MAX`|var|pub|124||
|`RAW_WHITE_BALANCE_MODE_MIN`|var|pub|125||
|`RAW_WHITE_BALANCE_MODE_MEAN`|var|pub|126||
|`DEFAULT_RAW_WHITE_BALANCE_MODE`|var|pub|127||
|`WHITE_BALANCE_ANALYSIS_SOURCE_EV_ZERO`|var|pub|128||
|`WHITE_BALANCE_ANALYSIS_SOURCE_LINEAR_BASE`|var|pub|129||
|`OPENCV_TONEMAP_MAP_DRAGO`|var|pub|130||
|`OPENCV_TONEMAP_MAP_REINHARD`|var|pub|131||
|`OPENCV_TONEMAP_MAP_MANTIUK`|var|pub|132||
|`OPENCV_MERGE_ALGORITHM_DEBEVEC`|var|pub|133||
|`OPENCV_MERGE_ALGORITHM_ROBERTSON`|var|pub|134||
|`OPENCV_MERGE_ALGORITHM_MERTENS`|var|pub|135||
|`DEFAULT_REINHARD02_POST_GAMMA`|var|pub|136||
|`DEFAULT_REINHARD02_BRIGHTNESS`|var|pub|137||
|`DEFAULT_REINHARD02_CONTRAST`|var|pub|138||
|`DEFAULT_REINHARD02_SATURATION`|var|pub|139||
|`DEFAULT_MANTIUK08_POST_GAMMA`|var|pub|140||
|`DEFAULT_MANTIUK08_BRIGHTNESS`|var|pub|141||
|`DEFAULT_MANTIUK08_CONTRAST`|var|pub|142||
|`DEFAULT_MANTIUK08_SATURATION`|var|pub|143||
|`DEFAULT_HDRPLUS_POST_GAMMA`|var|pub|144||
|`DEFAULT_HDRPLUS_BRIGHTNESS`|var|pub|145||
|`DEFAULT_HDRPLUS_CONTRAST`|var|pub|146||
|`DEFAULT_HDRPLUS_SATURATION`|var|pub|147||
|`DEFAULT_OPENCV_DEBEVEC_POST_GAMMA`|var|pub|148||
|`DEFAULT_OPENCV_DEBEVEC_BRIGHTNESS`|var|pub|149||
|`DEFAULT_OPENCV_DEBEVEC_CONTRAST`|var|pub|150||
|`DEFAULT_OPENCV_DEBEVEC_SATURATION`|var|pub|151||
|`DEFAULT_OPENCV_DEBEVEC_TONEMAP_GAMMA`|var|pub|152||
|`DEFAULT_OPENCV_ROBERTSON_POST_GAMMA`|var|pub|153||
|`DEFAULT_OPENCV_ROBERTSON_BRIGHTNESS`|var|pub|154||
|`DEFAULT_OPENCV_ROBERTSON_CONTRAST`|var|pub|155||
|`DEFAULT_OPENCV_ROBERTSON_SATURATION`|var|pub|156||
|`DEFAULT_OPENCV_ROBERTSON_TONEMAP_GAMMA`|var|pub|157||
|`DEFAULT_OPENCV_MERTENS_POST_GAMMA`|var|pub|158||
|`DEFAULT_OPENCV_MERTENS_BRIGHTNESS`|var|pub|159||
|`DEFAULT_OPENCV_MERTENS_CONTRAST`|var|pub|160||
|`DEFAULT_OPENCV_MERTENS_SATURATION`|var|pub|161||
|`DEFAULT_OPENCV_MERTENS_TONEMAP_GAMMA`|var|pub|162||
|`DEFAULT_OPENCV_POST_GAMMA`|var|pub|163||
|`DEFAULT_OPENCV_BRIGHTNESS`|var|pub|164||
|`DEFAULT_OPENCV_CONTRAST`|var|pub|165||
|`DEFAULT_OPENCV_SATURATION`|var|pub|166||
|`DEFAULT_OPENCV_MERGE_ALGORITHM`|var|pub|167||
|`DEFAULT_OPENCV_TONEMAP_ENABLED`|var|pub|168||
|`DEFAULT_OPENCV_TONEMAP_GAMMA`|var|pub|169||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_SATURATION`|var|pub|170||
|`DEFAULT_OPENCV_TONEMAP_DRAGO_BIAS`|var|pub|171||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_INTENSITY`|var|pub|172||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_LIGHT_ADAPT`|var|pub|173||
|`DEFAULT_OPENCV_TONEMAP_REINHARD_COLOR_ADAPT`|var|pub|174||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SCALE`|var|pub|175||
|`DEFAULT_OPENCV_TONEMAP_MANTIUK_SATURATION`|var|pub|176||
|`DEFAULT_HDRPLUS_PROXY_MODE`|var|pub|177||
|`DEFAULT_HDRPLUS_SEARCH_RADIUS`|var|pub|178||
|`DEFAULT_HDRPLUS_TEMPORAL_FACTOR`|var|pub|179||
|`DEFAULT_HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|180||
|`DEFAULT_HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|181||
|`HDRPLUS_TILE_SIZE`|var|pub|182||
|`HDRPLUS_TILE_STRIDE`|var|pub|183||
|`HDRPLUS_DOWNSAMPLED_TILE_SIZE`|var|pub|184||
|`HDRPLUS_ALIGNMENT_LEVELS`|var|pub|185||
|`HDRPLUS_ALIGNMENT_DOWNSAMPLE_RATE`|var|pub|186||
|`HDRPLUS_TEMPORAL_FACTOR`|var|pub|187||
|`HDRPLUS_TEMPORAL_MIN_DIST`|var|pub|188||
|`HDRPLUS_TEMPORAL_MAX_DIST`|var|pub|189||
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|191||
|`AutoAdjustOptions`|class|pub|448-483|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|485-513|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|515-538|class AutoLevelsOptions|
|`PostGammaAutoOptions`|class|pub|540-558|class PostGammaAutoOptions|
|`MergeGammaOption`|class|pub|560-578|class MergeGammaOption|
|`ResolvedMergeGamma`|class|pub|580-605|class ResolvedMergeGamma|
|`ExifGammaTags`|class|pub|607-628|class ExifGammaTags|
|`OpenCvTonemapOptions`|class|pub|630-659|class OpenCvTonemapOptions|
|`PostprocessOptions`|class|pub|661-714|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|716-732|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|734-752|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|754-775|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|777-797|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|799-822|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|824-843|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|845-865|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|867-884|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|886-903|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|905-923|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|924-960|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|944-946|def _border(left, middle, right)|
|`_line`|fn|priv|947-950|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|961-977|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|978-992|def _print_help_section(title)|
|`_print_help_option`|fn|priv|993-1034|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|1035-1234|def print_help(version)|
|`_validate_supported_bits_per_color`|fn|priv|1496-1513|def _validate_supported_bits_per_color(bits_per_color)|
|`_detect_dng_bits_per_color`|fn|priv|1514-1559|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1560-1572|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1573-1598|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1599-1623|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1624-1643|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1644-1666|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1667-1686|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1687-1706|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1707-1727|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1728-1752|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_resolve_default_opencv_tonemap_gamma`|fn|priv|1753-1774|def _resolve_default_opencv_tonemap_gamma(merge_algorithm)|
|`_parse_opencv_merge_backend_options`|fn|priv|1775-1826|def _parse_opencv_merge_backend_options(opencv_raw_values)|
|`_parse_opencv_tonemap_backend_options`|fn|priv|1827-1829|def _parse_opencv_tonemap_backend_options(|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1993-2052|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|2027-2037|def _percentile(percentile_value)|
|`_extract_camera_whitebalance_rgb_triplet`|fn|priv|2053-2085|def _extract_camera_whitebalance_rgb_triplet(raw_handle)|
|`_format_rgb_triplet_fixed4`|fn|priv|2086-2115|def _format_rgb_triplet_fixed4(rgb_values)|
|`_normalize_white_balance_gains_rgb`|fn|priv|2116-2119|def _normalize_white_balance_gains_rgb(|
|`_apply_normalized_white_balance_to_rgb_float`|fn|priv|2166-2189|def _apply_normalized_white_balance_to_rgb_float(np_modul...|
|`_build_rawpy_neutral_postprocess_kwargs`|fn|priv|2190-2230|def _build_rawpy_neutral_postprocess_kwargs(raw_handle)|
|`_extract_sensor_dynamic_range_max`|fn|priv|2231-2288|def _extract_sensor_dynamic_range_max(raw_handle, np_module)|
|`_extract_base_rgb_linear_float`|fn|priv|2289-2292|def _extract_base_rgb_linear_float(|
|`_normalize_source_gamma_label`|fn|priv|2339-2357|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|2358-2389|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|2390-2439|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|2440-2488|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|2489-2509|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|2510-2540|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|2541-2568|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|2569-2590|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|2591-2610|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|2611-2633|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|2634-2652|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|2653-2698|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|2699-2718|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|2719-2786|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2787-2824|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2825-2853|def _select_ev_zero_candidate(evaluations)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2854-2858|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2888-2905|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2906-2923|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_joint_auto_ev_solution`|fn|priv|2924-2927|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|3013-3033|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_luminance_response_curve_option`|fn|priv|3034-3060|def _parse_luminance_response_curve_option(option_raw)|
|`_parse_positive_float_option`|fn|priv|3061-3084|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_post_gamma_selector_option`|fn|priv|3085-3106|def _parse_post_gamma_selector_option(option_raw)|
|`_parse_positive_int_option`|fn|priv|3107-3130|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_post_gamma_auto_options`|fn|priv|3131-3206|def _parse_post_gamma_auto_options(post_gamma_auto_raw_va...|
|`_parse_tmo_passthrough_value`|fn|priv|3207-3223|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|3224-3246|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|3247-3271|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|3272-3294|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|3295-3320|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|3321-3352|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|3353-3449|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|3450-3481|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|3482-3554|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|3555-3704|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|3705-3723|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|3724-3800|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_apply_merge_gamma_float_no_clip`|fn|priv|3801-3854|def _apply_merge_gamma_float_no_clip(np_module, image_rgb...|
|`_parse_auto_adjust_option`|fn|priv|3855-3878|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_raw_white_balance_mode_option`|fn|priv|3879-3906|def _parse_raw_white_balance_mode_option(raw_white_balanc...|
|`_parse_white_balance_mode_option`|fn|priv|3907-3935|def _parse_white_balance_mode_option(white_balance_raw)|
|`_parse_white_balance_analysis_source_option`|fn|priv|3936-3965|def _parse_white_balance_analysis_source_option(analysis_...|
|`_parse_hdr_merge_option`|fn|priv|3966-3996|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|3997-4000|def _resolve_default_postprocess(|
|`_parse_gamma_option`|fn|priv|4081-4119|def _parse_gamma_option(option_value)|
|`_decode_exif_text_value`|fn|priv|4120-4139|def _decode_exif_text_value(exif_value)|
|`_exiftool_color_space_fallback`|fn|priv|4140-4191|def _exiftool_color_space_fallback(input_dng)|
|`_extract_exif_gamma_tags`|fn|priv|4192-4260|def _extract_exif_gamma_tags(input_dng)|
|`_resolve_auto_merge_gamma`|fn|priv|4261-4307|def _resolve_auto_merge_gamma(exif_gamma_tags, source_gam...|
|`_describe_resolved_merge_gamma`|fn|priv|4308-4367|def _describe_resolved_merge_gamma(resolved_merge_gamma)|
|`_format_gamma_number`|fn|priv|4319-4332|def _format_gamma_number(value)|
|`_describe_exif_gamma_tags`|fn|priv|4368-4410|def _describe_exif_gamma_tags(exif_gamma_tags)|
|`_ensure_three_channel_float_array_no_clip`|fn|priv|4411-4442|def _ensure_three_channel_float_array_no_clip(np_module, ...|
|`_ensure_three_channel_float_array_no_bounds`|fn|priv|4443-4472|def _ensure_three_channel_float_array_no_bounds(np_module...|
|`_apply_merge_gamma_float`|fn|priv|4473-4525|def _apply_merge_gamma_float(np_module, image_rgb_float, ...|
|`_parse_run_options`|fn|priv|4526-4725|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|5188-5225|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|5226-5256|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|5257-5319|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|5320-5414|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|5364-5381|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|5415-5446|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|5447-5469|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|5470-5471|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|5502-5544|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|5545-5678|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|5679-5685|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|5735-5749|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|5750-5767|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|5768-5786|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|5787-5816|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_build_white_balance_analysis_image_from_linear_base_float`|fn|priv|5817-5820|def _build_white_balance_analysis_image_from_linear_base_...|
|`_validate_white_balance_triplet_shape`|fn|priv|5842-5869|def _validate_white_balance_triplet_shape(np_module, brac...|
|`_build_xphoto_analysis_image_rgb_float`|fn|priv|5870-5895|def _build_xphoto_analysis_image_rgb_float(np_module, ana...|
|`_build_white_balance_robust_analysis_mask`|fn|priv|5896-5928|def _build_white_balance_robust_analysis_mask(np_module, ...|
|`_extract_white_balance_channel_gains_from_xphoto`|fn|priv|5929-5933|def _extract_white_balance_channel_gains_from_xphoto(|
|`_estimate_xphoto_white_balance_gains_rgb`|fn|priv|5990-5994|def _estimate_xphoto_white_balance_gains_rgb(|
|`_estimate_color_constancy_white_balance_gains_rgb`|fn|priv|6042-6045|def _estimate_color_constancy_white_balance_gains_rgb(|
|`_estimate_ttl_white_balance_gains_rgb`|fn|priv|6080-6111|def _estimate_ttl_white_balance_gains_rgb(np_module, anal...|
|`_apply_channel_gains_to_white_balance_triplet`|fn|priv|6112-6115|def _apply_channel_gains_to_white_balance_triplet(|
|`_apply_white_balance_to_bracket_triplet`|fn|priv|6141-6145|def _apply_white_balance_to_bracket_triplet(|
|`_extract_bracket_images_float`|fn|priv|6225-6230|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|6266-6291|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|6292-6307|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_format_external_command_for_log`|fn|priv|6308-6323|def _format_external_command_for_log(command)|
|`_run_luminance_hdr_cli`|fn|priv|6324-6331|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|6407-6410|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|6444-6463|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|6464-6489|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|6490-6495|def _run_opencv_merge_mertens(|
|`_estimate_opencv_camera_response`|fn|priv|6525-6529|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|6558-6565|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|6629-6648|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_tonemap_backend`|fn|priv|6649-6653|def _run_opencv_tonemap_backend(|
|`_derive_opencv_tonemap_enabled`|fn|priv|6722-6735|def _derive_opencv_tonemap_enabled(postprocess_options)|
|`_run_opencv_merge_backend`|fn|priv|6736-6743|def _run_opencv_merge_backend(|
|`_hdrplus_box_down2_float32`|fn|priv|6831-6859|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|6860-6906|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|6907-6940|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|6941-6961|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|6962-6980|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|6981-7005|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|7006-7024|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|7025-7030|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|7083-7089|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|7162-7169|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|7259-7346|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|7347-7371|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|7372-7376|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|7457-7463|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|7512-7584|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|7585-7589|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|7677-7687|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|7688-7690|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|7709-7738|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|7739-7758|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|7759-7790|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|7791-7818|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|7819-7845|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_rgb_float_tiff32`|fn|priv|7846-7870|def _write_rgb_float_tiff32(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|7871-7876|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|7906-7926|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|7927-7944|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|7945-7949|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|7979-8025|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|8026-8070|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|8071-8096|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_build_auto_post_gamma_lut_float`|fn|priv|8097-8113|def _build_auto_post_gamma_lut_float(np_module, gamma_val...|
|`_ensure_three_channel_float_array_no_range_adjust`|fn|priv|8114-8140|def _ensure_three_channel_float_array_no_range_adjust(np_...|
|`_apply_auto_post_gamma_float`|fn|priv|8141-8185|def _apply_auto_post_gamma_float(np_module, image_rgb_flo...|
|`_apply_brightness_float`|fn|priv|8186-8208|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|8209-8233|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|8234-8264|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|8265-8270|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|8387-8404|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|8405-8422|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|8423-8440|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|8441-8480|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|8481-8526|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|8527-8532|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|8566-8593|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|8594-8632|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|8633-8658|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|8659-8680|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|8681-8728|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|8729-8748|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|8749-8787|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|8788-8815|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|8816-8867|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|8868-8920|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|8921-8952|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|8953-8976|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|8977-9026|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|9027-9046|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|9047-9067|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|9068-9084|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|9085-9100|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|9101-9117|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|9118-9133|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|9134-9149|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|9201-9236|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|9237-9269|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|9270-9469|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|9543-9635|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|9556-9572|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|9573-9575|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|9576-9595|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|9596-9598|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|9599-9610|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|9636-9769|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|9770-9776|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|9808-9839|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|9840-9870|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_build_auto_levels_tone_curve_state`|fn|priv|9871-10060|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|10061-10064|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|10148-10171|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|10172-10177|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|10221-10324|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|10325-10485|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|10355-10388|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|10486-10487|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|10517-10563|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|10564-10592|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|10593-10594|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|10627-10634|def _f_lab(values)|
|`_f2xyz`|fn|priv|10635-10641|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|10677-10678|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|10712-10817|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|10818-10819|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|10854-10876|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|10877-10900|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|10901-10945|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|10946-10947|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|10977-10978|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|11031-11032|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|11074-11077|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|11135-11148|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|11149-11171|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|11172-11205|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|11206-11236|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|11237-11277|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|11278-11279|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|11328-11350|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|11351-11375|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|11366-11368|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|11376-11393|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|11394-11417|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|11418-11441|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|11442-11463|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|11464-11470|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|11579-11596|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|11597-11608|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|11742-11770|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|11771-11790|def _is_supported_runtime_os()|
|`run`|fn|pub|11791-11990|def run(args)|
