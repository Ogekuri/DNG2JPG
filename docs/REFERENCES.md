...
# dng2jpg.py | Python | 9244L | 286 symbols | 24 imports | 197 comments
...
### class `class AutoEvInputs` `@dataclass(frozen=True)` (L599-626)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L628-646)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L647-683)
...
### fn `def _border(left, middle, right)` `priv` (L667-669)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L670-673)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L684-700)
...
### fn `def _print_help_section(title)` `priv` (L701-715)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L716-757)
...
### fn `def print_help(version)` (L758-957)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1128-1146)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1147-1159)
...
### fn `def _derive_supported_ev_zero_values(base_max_ev)` `priv` (L1160-1176)
...
### fn `def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)` `priv` (L1177-1205)
...
### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1206-1251)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1252-1265)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1266-1297)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1298-1328)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1329-1348)
...
### fn `def _parse_auto_zero_option(auto_zero_raw)` `priv` (L1349-1368)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1369-1391)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1392-1411)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1412-1431)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1432-1452)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1453-1477)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1478-1524)
...
### fn `def _clamp_ev_to_supported(ev_candidate, ev_values)` `priv` (L1525-1538)
...
### fn `def _quantize_ev_to_supported(ev_value, ev_values)` `priv` (L1539-1560)
...
### fn `def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)` `priv` (L1561-1582)
...
### fn `def _apply_auto_percentage_scaling(ev_value, percentage)` `priv` (L1583-1597)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1598-1657)
...
### fn `def _percentile(percentile_value)` `priv` (L1632-1642)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L1658-1686)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1687-1706)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1707-1729)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1730-1748)
...
### fn `def _calculate_entropy_optimized_ev(cv2_module, np_module, luminance_float)` `priv` (L1749-1794)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L1795-1814)
...
### fn `def _calculate_detail_preservation_ev(cv2_module, np_module, luminance_float)` `priv` (L1815-1881)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L1882-1919)
...
### fn `def _evaluate_auto_zero_exposure(cv2_module, np_module, image_rgb_float)` `priv` (L1920-1953)
...
### fn `def _optimize_adaptive_ev_delta(auto_ev_inputs)` `priv` (L1954-1983)
...
### fn `def _compute_auto_ev_value_from_stats(` `priv` (L1984-1989)

### fn `def _compute_auto_ev_value(raw_handle, supported_ev_values=None, ev_zero=0.0)` `priv` (L2017-2044)
...
### fn `def _resolve_ev_zero(` `priv` (L2045-2054)

### fn `def _resolve_ev_value(` `priv` (L2118-2125)
...
### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2178-2198)
...
### fn `def _parse_gamma_option(gamma_raw)` `priv` (L2199-2237)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2238-2261)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2262-2285)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2286-2302)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2303-2325)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2326-2350)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2351-2373)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2374-2399)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2400-2431)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2432-2528)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2529-2560)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2561-2624)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2625-2774)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2775-2793)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2794-2870)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2871-2894)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2895-2924)
...
### fn `def _resolve_default_postprocess(` `priv` (L2925-2928)

### fn `def _parse_run_options(args)` `priv` (L3000-3199)
...
### fn `def _load_image_dependencies()` `priv` (L3821-3858)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3859-3889)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L3890-3952)
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L4020-4051)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L4052-4074)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4075-4076)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4107-4149)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4150-4283)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4284-4290)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4340-4354)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4355-4372)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L4373-4391)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4392-4420)
...
### fn `def _extract_bracket_images_float(` `priv` (L4421-4426)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4462-4487)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4488-4503)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4504-4511)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L4575-4578)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4612-4631)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4632-4655)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L4656-4677)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L4678-4682)

### fn `def _run_opencv_merge_radiance(` `priv` (L4707-4714)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4766-4785)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4786-4793)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L4856-4884)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L4885-4931)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L4932-4965)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L4966-4986)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L4987-5005)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L5006-5030)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L5031-5049)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L5050-5055)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L5108-5114)

### fn `def _hdrplus_align_layer(` `priv` (L5187-5194)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5284-5371)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5372-5396)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5397-5401)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5482-5488)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5537-5609)
...
### fn `def _run_hdr_plus_merge(` `priv` (L5610-5613)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5690-5700)
...
### fn `def _collect_missing_external_executables(` `priv` (L5701-5703)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5722-5747)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5748-5767)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5768-5799)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5800-5827)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5828-5851)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L5852-5857)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L5887-5907)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L5908-5925)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L5926-5930)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L5960-6006)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L6007-6051)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L6052-6077)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L6078-6100)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L6101-6125)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L6126-6155)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6156-6161)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6238-6255)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6256-6273)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6274-6291)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6292-6331)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6332-6377)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6378-6383)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6417-6444)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6445-6483)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6484-6509)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6510-6531)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6532-6579)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6580-6599)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L6600-6638)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L6639-6666)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L6667-6718)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L6719-6771)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6772-6803)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6804-6827)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6828-6877)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L6878-6897)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L6898-6918)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L6919-6935)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L6936-6951)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L6952-6968)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L6969-6984)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L6985-7000)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L7052-7087)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L7088-7120)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L7121-7320)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L7394-7399)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L7443-7542)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L7543-7561)
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L7562-7563)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L7593-7639)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L7640-7668)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L7669-7670)

### fn `def _f_lab(values)` `priv` (L7703-7710)
...
### fn `def _f2xyz(values)` `priv` (L7711-7717)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L7753-7754)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L7788-7893)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L7894-7895)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L7930-7952)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L7953-7976)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L7977-8021)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L8022-8023)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L8053-8054)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L8107-8108)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L8150-8153)
...
### fn `def _clamp01(np_module, values)` `priv` (L8210-8223)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L8224-8246)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L8247-8280)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L8281-8311)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L8312-8352)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L8353-8354)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L8403-8425)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L8426-8450)
...
### fn `def logistic(z_values)` (L8441-8443)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L8451-8468)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L8469-8492)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L8493-8516)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L8517-8538)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L8539-8545)

### fn `def _load_piexif_dependency()` `priv` (L8654-8671)
...
### fn `def _encode_jpg(` `priv` (L8672-8683)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L8815-8843)
...
### fn `def _is_supported_runtime_os()` `priv` (L8844-8863)
...
|`AutoEvInputs`|class|pub|599-626|class AutoEvInputs|
|`AutoZeroEvaluation`|class|pub|628-646|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|647-683|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|667-669|def _border(left, middle, right)|
|`_line`|fn|priv|670-673|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|684-700|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|701-715|def _print_help_section(title)|
|`_print_help_option`|fn|priv|716-757|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|758-957|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1128-1146|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1147-1159|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_zero_values`|fn|priv|1160-1176|def _derive_supported_ev_zero_values(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1177-1205|def _derive_supported_ev_values(bits_per_color, ev_zero=0.0)|
|`_detect_dng_bits_per_color`|fn|priv|1206-1251|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1252-1265|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1266-1297|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1298-1328|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1329-1348|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_auto_zero_option`|fn|priv|1349-1368|def _parse_auto_zero_option(auto_zero_raw)|
|`_parse_percentage_option`|fn|priv|1369-1391|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1392-1411|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1412-1431|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1432-1452|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1453-1477|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1478-1524|def _parse_opencv_options(opencv_raw_values)|
|`_clamp_ev_to_supported`|fn|priv|1525-1538|def _clamp_ev_to_supported(ev_candidate, ev_values)|
|`_quantize_ev_to_supported`|fn|priv|1539-1560|def _quantize_ev_to_supported(ev_value, ev_values)|
|`_quantize_ev_toward_zero_step`|fn|priv|1561-1582|def _quantize_ev_toward_zero_step(ev_value, step=EV_STEP)|
|`_apply_auto_percentage_scaling`|fn|priv|1583-1597|def _apply_auto_percentage_scaling(ev_value, percentage)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1598-1657|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1632-1642|def _percentile(percentile_value)|
|`_extract_base_rgb_linear_float`|fn|priv|1658-1686|def _extract_base_rgb_linear_float(raw_handle, np_module)|
|`_coerce_positive_luminance`|fn|priv|1687-1706|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|1707-1729|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|1730-1748|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|1749-1794|def _calculate_entropy_optimized_ev(cv2_module, np_module...|
|`_calculate_ettr_ev`|fn|priv|1795-1814|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|1815-1881|def _calculate_detail_preservation_ev(cv2_module, np_modu...|
|`_calculate_auto_zero_evaluations`|fn|priv|1882-1919|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_evaluate_auto_zero_exposure`|fn|priv|1920-1953|def _evaluate_auto_zero_exposure(cv2_module, np_module, i...|
|`_optimize_adaptive_ev_delta`|fn|priv|1954-1983|def _optimize_adaptive_ev_delta(auto_ev_inputs)|
|`_compute_auto_ev_value_from_stats`|fn|priv|1984-1989|def _compute_auto_ev_value_from_stats(|
|`_compute_auto_ev_value`|fn|priv|2017-2044|def _compute_auto_ev_value(raw_handle, supported_ev_value...|
|`_resolve_ev_zero`|fn|priv|2045-2054|def _resolve_ev_zero(|
|`_resolve_ev_value`|fn|priv|2118-2125|def _resolve_ev_value(|
|`_parse_luminance_text_option`|fn|priv|2178-2198|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_gamma_option`|fn|priv|2199-2237|def _parse_gamma_option(gamma_raw)|
|`_parse_positive_float_option`|fn|priv|2238-2261|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|2262-2285|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|2286-2302|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2303-2325|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2326-2350|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2351-2373|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2374-2399|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2400-2431|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2432-2528|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2529-2560|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2561-2624|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2625-2774|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|2775-2793|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|2794-2870|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|2871-2894|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_hdr_merge_option`|fn|priv|2895-2924|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|2925-2928|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|3000-3199|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3821-3858|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3859-3889|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|3890-3952|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|3953-4019|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_resolve_thumbnail_transpose_map`|fn|priv|4020-4051|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|4052-4074|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|4075-4076|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|4107-4149|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|4150-4283|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|4284-4290|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|4340-4354|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|4355-4372|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|4373-4391|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|4392-4420|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_extract_bracket_images_float`|fn|priv|4421-4426|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|4462-4487|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|4488-4503|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|4504-4511|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|4575-4578|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|4612-4631|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|4632-4655|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|4656-4677|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_estimate_opencv_camera_response`|fn|priv|4678-4682|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|4707-4714|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|4766-4785|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|4786-4793|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|4856-4884|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|4885-4931|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|4932-4965|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|4966-4986|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|4987-5005|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|5006-5030|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|5031-5049|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|5050-5055|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|5108-5114|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|5187-5194|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|5284-5371|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|5372-5396|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|5397-5401|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|5482-5488|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|5537-5609|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|5610-5613|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|5690-5700|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|5701-5703|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|5722-5747|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|5748-5767|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|5768-5799|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|5800-5827|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|5828-5851|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|5852-5857|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|5887-5907|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|5908-5925|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|5926-5930|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|5960-6006|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|6007-6051|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|6052-6077|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|6078-6100|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|6101-6125|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|6126-6155|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|6156-6161|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|6238-6255|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|6256-6273|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|6274-6291|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|6292-6331|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|6332-6377|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|6378-6383|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|6417-6444|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|6445-6483|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|6484-6509|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|6510-6531|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|6532-6579|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|6580-6599|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|6600-6638|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|6639-6666|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|6667-6718|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|6719-6771|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|6772-6803|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|6804-6827|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|6828-6877|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|6878-6897|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|6898-6918|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|6919-6935|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|6936-6951|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|6952-6968|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|6969-6984|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|6985-7000|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|7052-7087|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|7088-7120|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|7121-7320|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_call_auto_levels_compat_helper`|fn|priv|7394-7399|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|7443-7542|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|7543-7561|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|7562-7563|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|7593-7639|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|7640-7668|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|7669-7670|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|7703-7710|def _f_lab(values)|
|`_f2xyz`|fn|priv|7711-7717|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|7753-7754|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|7788-7893|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|7894-7895|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|7930-7952|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|7953-7976|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|7977-8021|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|8022-8023|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|8053-8054|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|8107-8108|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|8150-8153|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|8210-8223|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|8224-8246|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|8247-8280|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|8281-8311|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|8312-8352|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|8353-8354|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|8403-8425|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|8426-8450|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|8441-8443|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|8451-8468|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|8469-8492|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|8493-8516|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|8517-8538|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|8539-8545|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|8654-8671|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|8672-8683|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|8815-8843|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|8844-8863|def _is_supported_runtime_os()|
|`run`|fn|pub|8864-9063|def run(args)|
