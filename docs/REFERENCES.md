...
# dng2jpg.py | Python | 10749L | 305 symbols | 26 imports | 224 comments
...
### class `class ExifGammaTags` `@dataclass(frozen=True)` (L493-514)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L516-554)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L556-572)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L574-592)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L594-615)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L617-637)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L639-662)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L664-683)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L685-705)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L707-724)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L726-743)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L745-763)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L764-800)
...
### fn `def _border(left, middle, right)` `priv` (L784-786)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L787-790)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L801-817)
...
### fn `def _print_help_section(title)` `priv` (L818-832)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L833-874)
...
### fn `def print_help(version)` (L875-1074)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1256-1274)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1275-1287)
...
### fn `def _derive_supported_ev_values(` `priv` (L1288-1290)

### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1314-1359)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1360-1372)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1373-1398)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1399-1423)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1424-1443)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1444-1466)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1467-1486)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1487-1506)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1507-1527)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1528-1552)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1553-1599)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1600-1659)
...
### fn `def _percentile(percentile_value)` `priv` (L1634-1644)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L1660-1688)
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L1689-1707)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L1708-1739)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L1740-1789)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L1790-1838)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L1839-1859)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L1860-1890)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L1891-1918)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L1919-1940)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1941-1960)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1961-1983)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1984-2002)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L2003-2048)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L2049-2068)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L2069-2136)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2137-2174)
...
### fn `def _select_ev_zero_candidate(evaluations, safe_ev_zero_max)` `priv` (L2175-2204)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2205-2209)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2239-2256)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2257-2274)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2275-2281)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2380-2400)
...
### fn `def _parse_luminance_response_curve_option(option_raw)` `priv` (L2401-2427)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2428-2451)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2452-2475)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2476-2492)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2493-2515)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2516-2540)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2541-2563)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2564-2589)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2590-2621)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2622-2718)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2719-2750)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2751-2823)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2824-2973)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2974-2992)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2993-3069)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L3070-3093)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L3094-3123)
...
### fn `def _resolve_default_postprocess(` `priv` (L3124-3127)

### fn `def _parse_gamma_option(option_value)` `priv` (L3199-3237)
...
### fn `def _decode_exif_text_value(exif_value)` `priv` (L3238-3257)
...
### fn `def _extract_exif_gamma_tags(input_dng)` `priv` (L3258-3320)
- @brief Extract EXIF color-space metadata relevant to auto merge gamma.
- @details Opens the source RAW/DNG file as a binary stream via `exifread.process_file` and normalizes `EXIF ColorSpace`, `Interop InteroperabilityIndex`, `Image Model`, and `Image Make` tags for deterministic auto transfer resolution. Does not use Pillow for this extraction. Complexity: O(file_size). Side effects: none (read-only file access).
- @param input_dng {Path} Source RAW/DNG file path.
- @return {ExifGammaTags} Normalized EXIF merge-gamma evidence payload.
- @satisfies REQ-169, REQ-172, REQ-173

### fn `def _resolve_auto_merge_gamma(exif_gamma_tags, source_gamma_info)` `priv` (L3321-3367)
...
### fn `def _describe_resolved_merge_gamma(resolved_merge_gamma)` `priv` (L3368-3427)
...
### fn `def _format_gamma_number(value)` `priv` (L3379-3392)
- @brief Format one deterministic merge-gamma runtime diagnostic line.
...
### fn `def _describe_exif_gamma_tags(exif_gamma_tags)` `priv` (L3428-3452)
- @brief Format one deterministic EXIF merge-gamma input diagnostic line.
- @details Renders one stable runtime payload exposing the normalized EXIF `ColorSpace`, `InteroperabilityIndex`, `ImageModel`, and `ImageMake` values consumed by automatic merge-gamma resolution. Missing values are rendered as `missing`.
- @param exif_gamma_tags {ExifGammaTags} Normalized EXIF merge-gamma evidence payload.
- @return {str} Deterministic runtime diagnostic line.
- @satisfies REQ-172

### fn `def _ensure_three_channel_float_array_no_clip(np_module, image_data)` `priv` (L3453-3484)
...
### fn `def _apply_merge_gamma_float(np_module, image_rgb_float, resolved_merge_gamma)` `priv` (L3485-3537)
...
### fn `def _parse_run_options(args)` `priv` (L3538-3737)
...
### fn `def _load_image_dependencies()` `priv` (L4399-4436)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L4437-4467)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L4468-4530)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L4531-4625)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L4575-4592)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L4626-4657)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L4658-4680)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4681-4682)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4713-4755)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4756-4889)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4890-4896)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4946-4960)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4961-4978)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L4979-4997)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4998-5026)
...
### fn `def _extract_bracket_images_float(` `priv` (L5027-5031)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L5065-5090)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L5091-5106)
...
### fn `def _format_external_command_for_log(command)` `priv` (L5107-5122)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L5123-5130)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L5205-5208)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L5242-5261)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L5262-5285)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L5286-5307)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L5308-5312)

### fn `def _run_opencv_merge_radiance(` `priv` (L5341-5348)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L5412-5431)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L5432-5439)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L5521-5549)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L5550-5596)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L5597-5630)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L5631-5651)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L5652-5670)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L5671-5695)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L5696-5714)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L5715-5720)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L5773-5779)

### fn `def _hdrplus_align_layer(` `priv` (L5852-5859)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5949-6036)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L6037-6061)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L6062-6066)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L6147-6153)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L6202-6274)
...
### fn `def _run_hdr_plus_merge(` `priv` (L6275-6279)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L6367-6377)
...
### fn `def _collect_missing_external_executables(` `priv` (L6378-6380)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L6399-6424)
...
### fn `def _resolve_numpy_dependency()` `priv` (L6425-6444)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L6445-6476)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L6477-6504)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L6505-6528)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L6529-6534)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L6564-6584)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L6585-6602)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L6603-6607)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L6637-6683)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L6684-6728)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L6729-6754)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L6755-6777)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L6778-6802)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L6803-6832)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6833-6838)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6915-6932)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6933-6950)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6951-6968)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6969-7008)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L7009-7054)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L7055-7060)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L7094-7121)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L7122-7160)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L7161-7186)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L7187-7208)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L7209-7256)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L7257-7276)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L7277-7315)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L7316-7343)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L7344-7395)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L7396-7448)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L7449-7480)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L7481-7504)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L7505-7554)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L7555-7574)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L7575-7595)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L7596-7612)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L7613-7628)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L7629-7645)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L7646-7661)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L7662-7677)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L7729-7764)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L7765-7797)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L7798-7997)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L8071-8163)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L8084-8100)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L8101-8103)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L8104-8123)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L8124-8126)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L8127-8138)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L8164-8297)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L8298-8304)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L8336-8367)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L8368-8398)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L8399-8588)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L8589-8592)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L8676-8699)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L8700-8705)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L8749-8855)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L8856-9016)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L8886-8919)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L9017-9018)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L9048-9094)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L9095-9123)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L9124-9125)

### fn `def _f_lab(values)` `priv` (L9158-9165)
...
### fn `def _f2xyz(values)` `priv` (L9166-9172)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L9208-9209)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L9243-9348)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L9349-9350)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L9385-9407)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L9408-9431)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L9432-9476)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L9477-9478)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L9508-9509)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L9562-9563)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L9605-9608)
...
### fn `def _clamp01(np_module, values)` `priv` (L9665-9678)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L9679-9701)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L9702-9735)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L9736-9766)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L9767-9807)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L9808-9809)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L9858-9880)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L9881-9905)
...
### fn `def logistic(z_values)` (L9896-9898)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L9906-9923)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L9924-9947)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L9948-9971)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L9972-9993)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L9994-10000)

### fn `def _load_piexif_dependency()` `priv` (L10109-10126)
...
### fn `def _encode_jpg(` `priv` (L10127-10138)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L10270-10298)
...
### fn `def _is_supported_runtime_os()` `priv` (L10299-10318)
...
|`ExifGammaTags`|class|pub|493-514|class ExifGammaTags|
|`PostprocessOptions`|class|pub|516-554|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|556-572|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|574-592|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|594-615|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|617-637|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|639-662|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|664-683|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|685-705|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|707-724|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|726-743|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|745-763|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|764-800|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|784-786|def _border(left, middle, right)|
|`_line`|fn|priv|787-790|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|801-817|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|818-832|def _print_help_section(title)|
|`_print_help_option`|fn|priv|833-874|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|875-1074|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1256-1274|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1275-1287|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1288-1290|def _derive_supported_ev_values(|
|`_detect_dng_bits_per_color`|fn|priv|1314-1359|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1360-1372|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1373-1398|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1399-1423|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1424-1443|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1444-1466|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1467-1486|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1487-1506|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1507-1527|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1528-1552|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1553-1599|def _parse_opencv_options(opencv_raw_values)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1600-1659|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|