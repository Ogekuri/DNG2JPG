...
# dng2jpg.py | Python | 10192L | 291 symbols | 24 imports | 210 comments
...
- var `DEFAULT_AUTO_EV_SHADOW_CLIPPING = 5.0` (L45)
- var `DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING = 5.0` (L46)
- var `DEFAULT_AUTO_EV_STEP = 0.1` (L47)
...
- var `MIN_SUPPORTED_BITS_PER_COLOR = 9` (L137)
### class `class AutoAdjustOptions` `@dataclass(frozen=True)` (L353-388)
...
### class `class AutoBrightnessOptions` `@dataclass(frozen=True)` (L390-418)
...
### class `class AutoLevelsOptions` `@dataclass(frozen=True)` (L420-443)
...
### class `class PostprocessOptions` `@dataclass(frozen=True)` (L445-481)
...
### class `class DebugArtifactContext` `@dataclass(frozen=True)` (L483-499)
...
### class `class SourceGammaInfo` `@dataclass(frozen=True)` (L501-519)
...
### class `class LuminanceOptions` `@dataclass(frozen=True)` (L521-541)
...
### class `class OpenCvMergeOptions` `@dataclass(frozen=True)` (L543-563)
...
### class `class HdrPlusOptions` `@dataclass(frozen=True)` (L565-588)
...
### class `class HdrPlusTemporalRuntimeOptions` `@dataclass(frozen=True)` (L590-609)
...
### class `class JointAutoEvSolution` `@dataclass(frozen=True)` (L611-631)
...
### class `class AutoEvIterationStep` `@dataclass(frozen=True)` (L633-650)
...
### class `class AutoEvOptions` `@dataclass(frozen=True)` (L652-669)
...
### class `class AutoZeroEvaluation` `@dataclass(frozen=True)` (L671-689)
...
### fn `def _print_box_table(headers, rows, header_rows=())` `priv` (L690-726)
...
### fn `def _border(left, middle, right)` `priv` (L710-712)
- @brief Print one Unicode box-drawing table.
...
### fn `def _line(values)` `priv` (L713-716)

### fn `def _build_two_line_operator_rows(operator_entries)` `priv` (L727-743)
...
### fn `def _print_help_section(title)` `priv` (L744-758)
...
### fn `def _print_help_option(option_label, description, detail_lines=())` `priv` (L759-800)
...
### fn `def print_help(version)` (L801-1000)
...
### fn `def _calculate_max_ev_from_bits(bits_per_color)` `priv` (L1171-1189)
...
### fn `def _calculate_safe_ev_zero_max(base_max_ev)` `priv` (L1190-1202)
...
### fn `def _derive_supported_ev_values(` `priv` (L1203-1205)

### fn `def _detect_dng_bits_per_color(raw_handle)` `priv` (L1229-1274)
...
### fn `def _is_ev_value_on_supported_step(ev_value)` `priv` (L1275-1287)
...
### fn `def _parse_ev_option(ev_raw)` `priv` (L1288-1313)
...
### fn `def _parse_ev_zero_option(ev_zero_raw)` `priv` (L1314-1338)
...
### fn `def _parse_auto_ev_option(auto_ev_raw)` `priv` (L1339-1358)
...
### fn `def _parse_percentage_option(option_name, option_raw)` `priv` (L1359-1381)
...
### fn `def _parse_auto_brightness_option(auto_brightness_raw)` `priv` (L1382-1401)
...
### fn `def _parse_auto_levels_option(auto_levels_raw)` `priv` (L1402-1421)
...
### fn `def _parse_explicit_boolean_option(option_name, option_raw)` `priv` (L1422-1442)
...
### fn `def _parse_opencv_merge_algorithm_option(algorithm_raw)` `priv` (L1443-1467)
...
### fn `def _parse_opencv_options(opencv_raw_values)` `priv` (L1468-1514)
...
### fn `def _extract_normalized_preview_luminance_stats(raw_handle)` `priv` (L1515-1574)
...
### fn `def _percentile(percentile_value)` `priv` (L1549-1559)
- @brief Extract normalized preview luminance percentiles from RAW handle.
...
### fn `def _extract_base_rgb_linear_float(raw_handle, np_module)` `priv` (L1575-1603)
...
### fn `def _normalize_source_gamma_label(label_raw)` `priv` (L1604-1622)
...
### fn `def _decode_raw_metadata_text(metadata_raw)` `priv` (L1623-1654)
...
### fn `def _classify_explicit_source_gamma(raw_handle)` `priv` (L1655-1704)
...
### fn `def _classify_tone_curve_gamma(raw_handle)` `priv` (L1705-1753)
...
### fn `def _has_nonzero_matrix(matrix_raw)` `priv` (L1754-1774)
...
### fn `def _classify_matrix_hint_gamma(raw_handle)` `priv` (L1775-1805)
...
### fn `def _extract_source_gamma_info(raw_handle)` `priv` (L1806-1833)
...
### fn `def _describe_source_gamma_info(source_gamma_info)` `priv` (L1834-1855)
...
### fn `def _coerce_positive_luminance(value, fallback)` `priv` (L1856-1875)
...
### fn `def _calculate_bt709_luminance(np_module, image_rgb_float)` `priv` (L1876-1898)
...
### fn `def _smoothstep(np_module, values, edge0, edge1)` `priv` (L1899-1917)
...
### fn `def _calculate_entropy_optimized_ev(_cv2_module, np_module, luminance_float)` `priv` (L1918-1963)
...
### fn `def _calculate_ettr_ev(np_module, luminance_float)` `priv` (L1964-1983)
...
### fn `def _calculate_detail_preservation_ev(_cv2_module, np_module, luminance_float)` `priv` (L1984-2051)
...
### fn `def _calculate_auto_zero_evaluations(cv2_module, np_module, image_rgb_float)` `priv` (L2052-2089)
...
### fn `def _select_ev_zero_candidate(evaluations, safe_ev_zero_max)` `priv` (L2090-2119)
...
### fn `def _build_unclipped_bracket_images_from_linear_base_float(` `priv` (L2120-2124)

### fn `def _measure_any_channel_highlight_clipping_pct(np_module, image_rgb_float)` `priv` (L2154-2171)
...
### fn `def _measure_any_channel_shadow_clipping_pct(np_module, image_rgb_float)` `priv` (L2172-2189)
...
### fn `def _resolve_joint_auto_ev_solution(` `priv` (L2190-2196)

### fn `def _parse_luminance_text_option(option_name, option_raw)` `priv` (L2295-2315)
...
### fn `def _parse_positive_float_option(option_name, option_raw)` `priv` (L2316-2339)
...
### fn `def _parse_positive_int_option(option_name, option_raw)` `priv` (L2340-2363)
...
### fn `def _parse_tmo_passthrough_value(option_name, option_raw)` `priv` (L2364-2380)
...
### fn `def _parse_jpg_compression_option(compression_raw)` `priv` (L2381-2403)
...
### fn `def _parse_float_exclusive_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2404-2428)
...
### fn `def _parse_non_negative_float_option(option_name, option_raw)` `priv` (L2429-2451)
...
### fn `def _parse_float_in_range_option(option_name, option_raw, min_value, max_value)` `priv` (L2452-2477)
...
### fn `def _parse_positive_int_pair_option(option_name, option_raw)` `priv` (L2478-2509)
...
### fn `def _parse_auto_brightness_options(auto_brightness_raw_values)` `priv` (L2510-2606)
...
### fn `def _parse_auto_levels_hr_method_option(auto_levels_method_raw)` `priv` (L2607-2638)
...
### fn `def _parse_auto_levels_options(auto_levels_raw_values)` `priv` (L2639-2711)
...
### fn `def _parse_auto_adjust_options(auto_adjust_raw_values)` `priv` (L2712-2861)
...
### fn `def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)` `priv` (L2862-2880)
...
### fn `def _parse_hdrplus_options(hdrplus_raw_values)` `priv` (L2881-2957)
...
### fn `def _parse_auto_adjust_option(auto_adjust_raw)` `priv` (L2958-2981)
...
### fn `def _parse_hdr_merge_option(hdr_merge_raw)` `priv` (L2982-3011)
...
### fn `def _resolve_default_postprocess(` `priv` (L3012-3015)

### fn `def _parse_run_options(args)` `priv` (L3087-3286)
...
### fn `def _load_image_dependencies()` `priv` (L3936-3973)
...
### fn `def _parse_exif_datetime_to_timestamp(datetime_raw)` `priv` (L3974-4004)
...
### fn `def _parse_exif_exposure_time_to_seconds(exposure_raw)` `priv` (L4005-4067)
...
### fn `def _extract_dng_exif_payload_and_timestamp(pil_image_module, input_dng)` `priv` (L4068-4162)
...
### fn `def _read_exif_value(exif_tag)` `priv` (L4112-4129)
- @brief Extract DNG EXIF payload bytes, preferred datetime timestamp, source orientation, and exposure time.
...
### fn `def _resolve_thumbnail_transpose_map(pil_image_module)` `priv` (L4163-4194)
...
### fn `def _apply_orientation_transform(pil_image_module, pil_image, source_orientation)` `priv` (L4195-4217)
...
### fn `def _build_oriented_thumbnail_jpeg_bytes(` `priv` (L4218-4219)

### fn `def _coerce_exif_int_like_value(raw_value)` `priv` (L4250-4292)
...
### fn `def _normalize_ifd_integer_like_values_for_piexif_dump(piexif_module, exif_dict)` `priv` (L4293-4426)
...
### fn `def _refresh_output_jpg_exif_thumbnail_after_save(` `priv` (L4427-4433)

### fn `def _set_output_file_timestamps(output_jpg, exif_timestamp)` `priv` (L4483-4497)
...
### fn `def _sync_output_file_timestamps_from_exif(output_jpg, exif_timestamp)` `priv` (L4498-4515)
...
### fn `def _build_exposure_multipliers(ev_value, ev_zero=0.0)` `priv` (L4516-4534)
...
### fn `def _build_bracket_images_from_linear_base_float(np_module, base_rgb_float, multipliers)` `priv` (L4535-4563)
...
### fn `def _extract_bracket_images_float(` `priv` (L4564-4568)

### fn `def _order_bracket_paths(bracket_paths)` `priv` (L4602-4627)
...
### fn `def _order_hdr_plus_reference_paths(bracket_paths)` `priv` (L4628-4643)
...
### fn `def _run_luminance_hdr_cli(` `priv` (L4644-4651)

### fn `def _build_opencv_radiance_exposure_times(` `priv` (L4715-4718)
...
### fn `def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_delta)` `priv` (L4752-4771)
...
### fn `def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rgb_float32)` `priv` (L4772-4795)
...
### fn `def _run_opencv_merge_mertens(cv2_module, np_module, exposures_float)` `priv` (L4796-4817)
...
### fn `def _estimate_opencv_camera_response(` `priv` (L4818-4822)

### fn `def _run_opencv_merge_radiance(` `priv` (L4851-4858)
...
### fn `def _normalize_debevec_hdr_to_unit_range(np_module, hdr_rgb_float32, white_point_percentile)` `priv` (L4922-4941)
...
### fn `def _run_opencv_hdr_merge(` `priv` (L4942-4948)

### fn `def _hdrplus_box_down2_float32(np_module, frames_float32)` `priv` (L5009-5037)
...
### fn `def _hdrplus_gauss_down4_float32(np_module, frames_float32)` `priv` (L5038-5084)
...
### fn `def _hdrplus_build_scalar_proxy_float32(np_module, frames_rgb_float32, hdrplus_options)` `priv` (L5085-5118)
...
### fn `def _hdrplus_compute_tile_start_positions(np_module, axis_length, tile_stride, pad_margin)` `priv` (L5119-5139)
...
### fn `def _hdrplus_trunc_divide_int32(np_module, values_int32, divisor)` `priv` (L5140-5158)
...
### fn `def _hdrplus_compute_alignment_bounds(search_radius)` `priv` (L5159-5183)
...
### fn `def _hdrplus_compute_alignment_margin(search_radius, divisor=1)` `priv` (L5184-5202)
...
### fn `def _hdrplus_extract_overlapping_tiles(` `priv` (L5203-5208)

### fn `def _hdrplus_extract_aligned_tiles(` `priv` (L5261-5267)

### fn `def _hdrplus_align_layer(` `priv` (L5340-5347)
...
### fn `def _hdrplus_align_layers(np_module, scalar_frames, hdrplus_options)` `priv` (L5437-5524)
...
### fn `def _hdrplus_resolve_temporal_runtime_options(hdrplus_options)` `priv` (L5525-5549)
...
### fn `def _hdrplus_compute_temporal_weights(` `priv` (L5550-5554)

### fn `def _hdrplus_merge_temporal_rgb(` `priv` (L5635-5641)
...
### fn `def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles, width, height)` `priv` (L5690-5762)
...
### fn `def _run_hdr_plus_merge(` `priv` (L5763-5766)

### fn `def _convert_compression_to_quality(jpg_compression)` `priv` (L5843-5853)
...
### fn `def _collect_missing_external_executables(` `priv` (L5854-5856)

### fn `def _resolve_auto_adjust_dependencies()` `priv` (L5875-5900)
...
### fn `def _resolve_numpy_dependency()` `priv` (L5901-5920)
...
### fn `def _to_float32_image_array(np_module, image_data)` `priv` (L5921-5952)
...
### fn `def _normalize_float_rgb_image(np_module, image_data)` `priv` (L5953-5980)
...
### fn `def _write_rgb_float_tiff16(imageio_module, np_module, output_path, image_rgb_float)` `priv` (L5981-6004)
...
### fn `def _write_debug_rgb_float_tiff(` `priv` (L6005-6010)

### fn `def _build_debug_artifact_context(output_jpg, input_dng, postprocess_options)` `priv` (L6040-6060)
...
### fn `def _format_debug_ev_suffix_value(ev_value)` `priv` (L6061-6078)
...
### fn `def _materialize_bracket_tiffs_from_float(` `priv` (L6079-6083)

### fn `def _to_uint8_image_array(np_module, image_data)` `priv` (L6113-6159)
...
### fn `def _to_uint16_image_array(np_module, image_data)` `priv` (L6160-6204)
...
### fn `def _apply_post_gamma_float(np_module, image_rgb_float, gamma_value)` `priv` (L6205-6230)
...
### fn `def _apply_brightness_float(np_module, image_rgb_float, brightness_factor)` `priv` (L6231-6253)
...
### fn `def _apply_contrast_float(np_module, image_rgb_float, contrast_factor)` `priv` (L6254-6278)
...
### fn `def _apply_saturation_float(np_module, image_rgb_float, saturation_factor)` `priv` (L6279-6308)
...
### fn `def _apply_static_postprocess_float(` `priv` (L6309-6314)

### fn `def _to_linear_srgb(np_module, image_srgb)` `priv` (L6391-6408)
...
### fn `def _from_linear_srgb(np_module, image_linear)` `priv` (L6409-6426)
...
### fn `def _compute_bt709_luminance(np_module, linear_rgb)` `priv` (L6427-6444)
...
### fn `def _analyze_luminance_key(np_module, luminance, eps)` `priv` (L6445-6484)
...
### fn `def _choose_auto_key_value(key_analysis, auto_brightness_options)` `priv` (L6485-6530)
...
### fn `def _reinhard_global_tonemap_luminance(` `priv` (L6531-6536)

### fn `def _luminance_preserving_desaturate_to_fit(np_module, rgb_linear, luminance, eps)` `priv` (L6570-6597)
...
### fn `def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_module, image_bgr_uint16, options)` `priv` (L6598-6636)
...
### fn `def _quantize_clahe_luminance_bins(np_module, luminance_values, histogram_size)` `priv` (L6637-6662)
...
### fn `def _build_clahe_float_tile_histogram(np_module, luminance_tile, histogram_size)` `priv` (L6663-6684)
...
### fn `def _clip_clahe_histogram(np_module, histogram, clip_limit, tile_population)` `priv` (L6685-6732)
...
### fn `def _build_clahe_float_lut(np_module, histogram, tile_population)` `priv` (L6733-6752)
...
### fn `def _pad_clahe_luminance_float(np_module, luminance_float, tile_grid_size)` `priv` (L6753-6791)
...
### fn `def _build_clahe_axis_interpolation(np_module, axis_length, tile_size, tile_count)` `priv` (L6792-6819)
...
### fn `def _build_clahe_tile_luts_float(np_module, luminance_float, clip_limit, tile_grid_size, histogram_size)` `priv` (L6820-6871)
...
### fn `def _interpolate_clahe_bilinear_float(np_module, luminance_float, tile_luts, tile_height, tile_width)` `priv` (L6872-6924)
...
### fn `def _apply_clahe_luminance_float(np_module, luminance_float, clip_limit, tile_grid_size)` `priv` (L6925-6956)
...
### fn `def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np_module, luminance_float, cr_channel, cb_channel)` `priv` (L6957-6980)
...
### fn `def _apply_clahe_luma_rgb_float(cv2_module, np_module, image_rgb_float, auto_adjust_options)` `priv` (L6981-7030)
...
### fn `def _rt_gamma2(np_module, values)` `priv` (L7031-7050)
...
### fn `def _rt_igamma2(np_module, values)` `priv` (L7051-7071)
...
### fn `def _auto_levels_index_to_normalized_value(histogram_value, histcompr)` `priv` (L7072-7088)
...
### fn `def _auto_levels_normalized_to_legacy_code_value(value)` `priv` (L7089-7104)
...
### fn `def _auto_levels_normalized_to_legacy_code(np_module, values)` `priv` (L7105-7121)
...
### fn `def _auto_levels_legacy_code_to_normalized(np_module, values)` `priv` (L7122-7137)
...
### fn `def _pack_auto_levels_metrics(` `priv` (L7138-7153)

### fn `def _build_autoexp_histogram_rgb_float(np_module, image_rgb_float, histcompr)` `priv` (L7205-7240)
...
### fn `def _build_autoexp_histogram_rgb_uint16(np_module, image_rgb_uint16, histcompr)` `priv` (L7241-7273)
...
### fn `def _compute_auto_levels_from_histogram(np_module, histogram, histcompr, clip_percent)` `priv` (L7274-7473)
...
### fn `def _rt_simplebasecurve_scalar(x_value, black, shadow_recovery)` `priv` (L7547-7639)
...
### fn `def _basel(x_input, slope_start, slope_end)` `priv` (L7560-7576)
- @brief Evaluate RawTherapee `simplebasecurve` for one normalized sample.
...
### fn `def _baseu(x_input, slope_start, slope_end)` `priv` (L7577-7579)

### fn `def _cupper(x_input, slope_value, highlight_recovery)` `priv` (L7580-7599)

### fn `def _clower(x_input, slope_value, shadow_value)` `priv` (L7600-7602)

### fn `def _clower2(x_input, slope_value, shadow_value)` `priv` (L7603-7614)

### fn `def _build_rt_nurbs_curve_lut(np_module, x_points, y_points, sample_count)` `priv` (L7640-7773)
...
### fn `def _sample_auto_levels_lut_float(` `priv` (L7774-7780)

### fn `def _build_auto_levels_full_histogram_rgb_float(np_module, image_rgb_float)` `priv` (L7812-7843)
...
### fn `def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange, levels_code)` `priv` (L7844-7874)
...
### fn `def _build_auto_levels_tone_curve_state(np_module, image_rgb_float, auto_levels_metrics)` `priv` (L7875-8064)
...
### fn `def _apply_auto_levels_tonal_transform_float(` `priv` (L8065-8068)

### fn `def _auto_levels_has_full_tone_metrics(auto_levels_metrics)` `priv` (L8152-8175)
...
### fn `def _call_auto_levels_compat_helper(` `priv` (L8176-8181)

### fn `def _apply_auto_levels_float(np_module, image_rgb_float, auto_levels_options)` `priv` (L8225-8331)
...
### fn `def _clip_auto_levels_out_of_gamut_float(np_module, image_rgb, maxval=1.0)` `priv` (L8332-8492)
...
### fn `def _filmlike_clip_rgb_tone(primary, middle, lower)` `priv` (L8362-8395)
- @brief Clip overflowing RGB triplets with RawTherapee film-like gamut logic.
...
### fn `def _clip_auto_levels_out_of_gamut_uint16(` `priv` (L8493-8494)

### fn `def _hlrecovery_luminance_float(np_module, image_rgb, maxval=1.0)` `priv` (L8524-8570)
...
### fn `def _hlrecovery_luminance_uint16(np_module, image_rgb, maxval=_AUTO_LEVELS_CODE_MAX)` `priv` (L8571-8599)
...
### fn `def _hlrecovery_cielab_float(` `priv` (L8600-8601)

### fn `def _f_lab(values)` `priv` (L8634-8641)
...
### fn `def _f2xyz(values)` `priv` (L8642-8648)

### fn `def _hlrecovery_cielab_uint16(` `priv` (L8684-8685)

### fn `def _hlrecovery_blend_float(np_module, image_rgb, hlmax, maxval=1.0)` `priv` (L8719-8824)
...
### fn `def _hlrecovery_blend_uint16(` `priv` (L8825-8826)

### fn `def _dilate_mask_float(np_module, mask)` `priv` (L8861-8883)
...
### fn `def _box_mean_3x3_float(np_module, image_2d)` `priv` (L8884-8907)
...
### fn `def _hlrecovery_color_propagation_float(np_module, image_rgb, maxval=1.0)` `priv` (L8908-8952)
...
### fn `def _hlrecovery_color_propagation_uint16(` `priv` (L8953-8954)

### fn `def _hlrecovery_inpaint_opposed_float(` `priv` (L8984-8985)
...
### fn `def _hlrecovery_inpaint_opposed_uint16(` `priv` (L9038-9039)
...
### fn `def _apply_auto_brightness_rgb_float(` `priv` (L9081-9084)
...
### fn `def _clamp01(np_module, values)` `priv` (L9141-9154)
...
### fn `def _gaussian_kernel_2d(np_module, sigma, radius=None)` `priv` (L9155-9177)
...
### fn `def _rgb_to_hsl(np_module, rgb)` `priv` (L9178-9211)
...
### fn `def _hue_to_rgb(np_module, p_values, q_values, t_values)` `priv` (L9212-9242)
...
### fn `def _hsl_to_rgb(np_module, hue, saturation, lightness)` `priv` (L9243-9283)
...
### fn `def _selective_blur_contrast_gated_vectorized(` `priv` (L9284-9285)

### fn `def _level_per_channel_adaptive(np_module, rgb, low_pct=0.1, high_pct=99.9)` `priv` (L9334-9356)
...
### fn `def _sigmoidal_contrast(np_module, rgb, contrast=3.0, midpoint=0.5)` `priv` (L9357-9381)
...
### fn `def logistic(z_values)` (L9372-9374)
- @brief Execute sigmoidal contrast stage.
...
### fn `def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=0.8)` `priv` (L9382-9399)
...
### fn `def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)` `priv` (L9400-9423)
...
### fn `def _high_pass_math_gray(cv2_module, np_module, rgb, blur_sigma=2.5)` `priv` (L9424-9447)
...
### fn `def _overlay_composite(np_module, base_rgb, overlay_gray)` `priv` (L9448-9469)
...
### fn `def _apply_validated_auto_adjust_pipeline(` `priv` (L9470-9476)

### fn `def _load_piexif_dependency()` `priv` (L9585-9602)
...
### fn `def _encode_jpg(` `priv` (L9603-9614)

### fn `def _collect_processing_errors(rawpy_module)` `priv` (L9746-9774)
...
### fn `def _is_supported_runtime_os()` `priv` (L9775-9794)
...
|`DEFAULT_AUTO_EV_SHADOW_CLIPPING`|var|pub|45||
|`DEFAULT_AUTO_EV_HIGHLIGHT_CLIPPING`|var|pub|46||
|`DEFAULT_AUTO_EV_STEP`|var|pub|47||
...
|`MIN_SUPPORTED_BITS_PER_COLOR`|var|pub|137||
|`AutoAdjustOptions`|class|pub|353-388|class AutoAdjustOptions|
|`AutoBrightnessOptions`|class|pub|390-418|class AutoBrightnessOptions|
|`AutoLevelsOptions`|class|pub|420-443|class AutoLevelsOptions|
|`PostprocessOptions`|class|pub|445-481|class PostprocessOptions|
|`DebugArtifactContext`|class|pub|483-499|class DebugArtifactContext|
|`SourceGammaInfo`|class|pub|501-519|class SourceGammaInfo|
|`LuminanceOptions`|class|pub|521-541|class LuminanceOptions|
|`OpenCvMergeOptions`|class|pub|543-563|class OpenCvMergeOptions|
|`HdrPlusOptions`|class|pub|565-588|class HdrPlusOptions|
|`HdrPlusTemporalRuntimeOptions`|class|pub|590-609|class HdrPlusTemporalRuntimeOptions|
|`JointAutoEvSolution`|class|pub|611-631|class JointAutoEvSolution|
|`AutoEvIterationStep`|class|pub|633-650|class AutoEvIterationStep|
|`AutoEvOptions`|class|pub|652-669|class AutoEvOptions|
|`AutoZeroEvaluation`|class|pub|671-689|class AutoZeroEvaluation|
|`_print_box_table`|fn|priv|690-726|def _print_box_table(headers, rows, header_rows=())|
|`_border`|fn|priv|710-712|def _border(left, middle, right)|
|`_line`|fn|priv|713-716|def _line(values)|
|`_build_two_line_operator_rows`|fn|priv|727-743|def _build_two_line_operator_rows(operator_entries)|
|`_print_help_section`|fn|priv|744-758|def _print_help_section(title)|
|`_print_help_option`|fn|priv|759-800|def _print_help_option(option_label, description, detail_...|
|`print_help`|fn|pub|801-1000|def print_help(version)|
|`_calculate_max_ev_from_bits`|fn|priv|1171-1189|def _calculate_max_ev_from_bits(bits_per_color)|
|`_calculate_safe_ev_zero_max`|fn|priv|1190-1202|def _calculate_safe_ev_zero_max(base_max_ev)|
|`_derive_supported_ev_values`|fn|priv|1203-1205|def _derive_supported_ev_values(|
|`_detect_dng_bits_per_color`|fn|priv|1229-1274|def _detect_dng_bits_per_color(raw_handle)|
|`_is_ev_value_on_supported_step`|fn|priv|1275-1287|def _is_ev_value_on_supported_step(ev_value)|
|`_parse_ev_option`|fn|priv|1288-1313|def _parse_ev_option(ev_raw)|
|`_parse_ev_zero_option`|fn|priv|1314-1338|def _parse_ev_zero_option(ev_zero_raw)|
|`_parse_auto_ev_option`|fn|priv|1339-1358|def _parse_auto_ev_option(auto_ev_raw)|
|`_parse_percentage_option`|fn|priv|1359-1381|def _parse_percentage_option(option_name, option_raw)|
|`_parse_auto_brightness_option`|fn|priv|1382-1401|def _parse_auto_brightness_option(auto_brightness_raw)|
|`_parse_auto_levels_option`|fn|priv|1402-1421|def _parse_auto_levels_option(auto_levels_raw)|
|`_parse_explicit_boolean_option`|fn|priv|1422-1442|def _parse_explicit_boolean_option(option_name, option_raw)|
|`_parse_opencv_merge_algorithm_option`|fn|priv|1443-1467|def _parse_opencv_merge_algorithm_option(algorithm_raw)|
|`_parse_opencv_options`|fn|priv|1468-1514|def _parse_opencv_options(opencv_raw_values)|
|`_extract_normalized_preview_luminance_stats`|fn|priv|1515-1574|def _extract_normalized_preview_luminance_stats(raw_handle)|
|`_percentile`|fn|priv|1549-1559|def _percentile(percentile_value)|
|`_extract_base_rgb_linear_float`|fn|priv|1575-1603|def _extract_base_rgb_linear_float(raw_handle, np_module)|
|`_normalize_source_gamma_label`|fn|priv|1604-1622|def _normalize_source_gamma_label(label_raw)|
|`_decode_raw_metadata_text`|fn|priv|1623-1654|def _decode_raw_metadata_text(metadata_raw)|
|`_classify_explicit_source_gamma`|fn|priv|1655-1704|def _classify_explicit_source_gamma(raw_handle)|
|`_classify_tone_curve_gamma`|fn|priv|1705-1753|def _classify_tone_curve_gamma(raw_handle)|
|`_has_nonzero_matrix`|fn|priv|1754-1774|def _has_nonzero_matrix(matrix_raw)|
|`_classify_matrix_hint_gamma`|fn|priv|1775-1805|def _classify_matrix_hint_gamma(raw_handle)|
|`_extract_source_gamma_info`|fn|priv|1806-1833|def _extract_source_gamma_info(raw_handle)|
|`_describe_source_gamma_info`|fn|priv|1834-1855|def _describe_source_gamma_info(source_gamma_info)|
|`_coerce_positive_luminance`|fn|priv|1856-1875|def _coerce_positive_luminance(value, fallback)|
|`_calculate_bt709_luminance`|fn|priv|1876-1898|def _calculate_bt709_luminance(np_module, image_rgb_float)|
|`_smoothstep`|fn|priv|1899-1917|def _smoothstep(np_module, values, edge0, edge1)|
|`_calculate_entropy_optimized_ev`|fn|priv|1918-1963|def _calculate_entropy_optimized_ev(_cv2_module, np_modul...|
|`_calculate_ettr_ev`|fn|priv|1964-1983|def _calculate_ettr_ev(np_module, luminance_float)|
|`_calculate_detail_preservation_ev`|fn|priv|1984-2051|def _calculate_detail_preservation_ev(_cv2_module, np_mod...|
|`_calculate_auto_zero_evaluations`|fn|priv|2052-2089|def _calculate_auto_zero_evaluations(cv2_module, np_modul...|
|`_select_ev_zero_candidate`|fn|priv|2090-2119|def _select_ev_zero_candidate(evaluations, safe_ev_zero_max)|
|`_build_unclipped_bracket_images_from_linear_base_float`|fn|priv|2120-2124|def _build_unclipped_bracket_images_from_linear_base_float(|
|`_measure_any_channel_highlight_clipping_pct`|fn|priv|2154-2171|def _measure_any_channel_highlight_clipping_pct(np_module...|
|`_measure_any_channel_shadow_clipping_pct`|fn|priv|2172-2189|def _measure_any_channel_shadow_clipping_pct(np_module, i...|
|`_resolve_joint_auto_ev_solution`|fn|priv|2190-2196|def _resolve_joint_auto_ev_solution(|
|`_parse_luminance_text_option`|fn|priv|2295-2315|def _parse_luminance_text_option(option_name, option_raw)|
|`_parse_positive_float_option`|fn|priv|2316-2339|def _parse_positive_float_option(option_name, option_raw)|
|`_parse_positive_int_option`|fn|priv|2340-2363|def _parse_positive_int_option(option_name, option_raw)|
|`_parse_tmo_passthrough_value`|fn|priv|2364-2380|def _parse_tmo_passthrough_value(option_name, option_raw)|
|`_parse_jpg_compression_option`|fn|priv|2381-2403|def _parse_jpg_compression_option(compression_raw)|
|`_parse_float_exclusive_range_option`|fn|priv|2404-2428|def _parse_float_exclusive_range_option(option_name, opti...|
|`_parse_non_negative_float_option`|fn|priv|2429-2451|def _parse_non_negative_float_option(option_name, option_...|
|`_parse_float_in_range_option`|fn|priv|2452-2477|def _parse_float_in_range_option(option_name, option_raw,...|
|`_parse_positive_int_pair_option`|fn|priv|2478-2509|def _parse_positive_int_pair_option(option_name, option_raw)|
|`_parse_auto_brightness_options`|fn|priv|2510-2606|def _parse_auto_brightness_options(auto_brightness_raw_va...|
|`_parse_auto_levels_hr_method_option`|fn|priv|2607-2638|def _parse_auto_levels_hr_method_option(auto_levels_metho...|
|`_parse_auto_levels_options`|fn|priv|2639-2711|def _parse_auto_levels_options(auto_levels_raw_values)|
|`_parse_auto_adjust_options`|fn|priv|2712-2861|def _parse_auto_adjust_options(auto_adjust_raw_values)|
|`_parse_hdrplus_proxy_mode_option`|fn|priv|2862-2880|def _parse_hdrplus_proxy_mode_option(proxy_mode_raw)|
|`_parse_hdrplus_options`|fn|priv|2881-2957|def _parse_hdrplus_options(hdrplus_raw_values)|
|`_parse_auto_adjust_option`|fn|priv|2958-2981|def _parse_auto_adjust_option(auto_adjust_raw)|
|`_parse_hdr_merge_option`|fn|priv|2982-3011|def _parse_hdr_merge_option(hdr_merge_raw)|
|`_resolve_default_postprocess`|fn|priv|3012-3015|def _resolve_default_postprocess(|
|`_parse_run_options`|fn|priv|3087-3286|def _parse_run_options(args)|
|`_load_image_dependencies`|fn|priv|3936-3973|def _load_image_dependencies()|
|`_parse_exif_datetime_to_timestamp`|fn|priv|3974-4004|def _parse_exif_datetime_to_timestamp(datetime_raw)|
|`_parse_exif_exposure_time_to_seconds`|fn|priv|4005-4067|def _parse_exif_exposure_time_to_seconds(exposure_raw)|
|`_extract_dng_exif_payload_and_timestamp`|fn|priv|4068-4162|def _extract_dng_exif_payload_and_timestamp(pil_image_mod...|
|`_read_exif_value`|fn|priv|4112-4129|def _read_exif_value(exif_tag)|
|`_resolve_thumbnail_transpose_map`|fn|priv|4163-4194|def _resolve_thumbnail_transpose_map(pil_image_module)|
|`_apply_orientation_transform`|fn|priv|4195-4217|def _apply_orientation_transform(pil_image_module, pil_im...|
|`_build_oriented_thumbnail_jpeg_bytes`|fn|priv|4218-4219|def _build_oriented_thumbnail_jpeg_bytes(|
|`_coerce_exif_int_like_value`|fn|priv|4250-4292|def _coerce_exif_int_like_value(raw_value)|
|`_normalize_ifd_integer_like_values_for_piexif_dump`|fn|priv|4293-4426|def _normalize_ifd_integer_like_values_for_piexif_dump(pi...|
|`_refresh_output_jpg_exif_thumbnail_after_save`|fn|priv|4427-4433|def _refresh_output_jpg_exif_thumbnail_after_save(|
|`_set_output_file_timestamps`|fn|priv|4483-4497|def _set_output_file_timestamps(output_jpg, exif_timestamp)|
|`_sync_output_file_timestamps_from_exif`|fn|priv|4498-4515|def _sync_output_file_timestamps_from_exif(output_jpg, ex...|
|`_build_exposure_multipliers`|fn|priv|4516-4534|def _build_exposure_multipliers(ev_value, ev_zero=0.0)|
|`_build_bracket_images_from_linear_base_float`|fn|priv|4535-4563|def _build_bracket_images_from_linear_base_float(np_modul...|
|`_extract_bracket_images_float`|fn|priv|4564-4568|def _extract_bracket_images_float(|
|`_order_bracket_paths`|fn|priv|4602-4627|def _order_bracket_paths(bracket_paths)|
|`_order_hdr_plus_reference_paths`|fn|priv|4628-4643|def _order_hdr_plus_reference_paths(bracket_paths)|
|`_run_luminance_hdr_cli`|fn|priv|4644-4651|def _run_luminance_hdr_cli(|
|`_build_opencv_radiance_exposure_times`|fn|priv|4715-4718|def _build_opencv_radiance_exposure_times(|
|`_build_ev_times_from_ev_zero_and_delta`|fn|priv|4752-4771|def _build_ev_times_from_ev_zero_and_delta(ev_zero, ev_de...|
|`_normalize_opencv_hdr_to_unit_range`|fn|priv|4772-4795|def _normalize_opencv_hdr_to_unit_range(np_module, hdr_rg...|
|`_run_opencv_merge_mertens`|fn|priv|4796-4817|def _run_opencv_merge_mertens(cv2_module, np_module, expo...|
|`_estimate_opencv_camera_response`|fn|priv|4818-4822|def _estimate_opencv_camera_response(|
|`_run_opencv_merge_radiance`|fn|priv|4851-4858|def _run_opencv_merge_radiance(|
|`_normalize_debevec_hdr_to_unit_range`|fn|priv|4922-4941|def _normalize_debevec_hdr_to_unit_range(np_module, hdr_r...|
|`_run_opencv_hdr_merge`|fn|priv|4942-4948|def _run_opencv_hdr_merge(|
|`_hdrplus_box_down2_float32`|fn|priv|5009-5037|def _hdrplus_box_down2_float32(np_module, frames_float32)|
|`_hdrplus_gauss_down4_float32`|fn|priv|5038-5084|def _hdrplus_gauss_down4_float32(np_module, frames_float32)|
|`_hdrplus_build_scalar_proxy_float32`|fn|priv|5085-5118|def _hdrplus_build_scalar_proxy_float32(np_module, frames...|
|`_hdrplus_compute_tile_start_positions`|fn|priv|5119-5139|def _hdrplus_compute_tile_start_positions(np_module, axis...|
|`_hdrplus_trunc_divide_int32`|fn|priv|5140-5158|def _hdrplus_trunc_divide_int32(np_module, values_int32, ...|
|`_hdrplus_compute_alignment_bounds`|fn|priv|5159-5183|def _hdrplus_compute_alignment_bounds(search_radius)|
|`_hdrplus_compute_alignment_margin`|fn|priv|5184-5202|def _hdrplus_compute_alignment_margin(search_radius, divi...|
|`_hdrplus_extract_overlapping_tiles`|fn|priv|5203-5208|def _hdrplus_extract_overlapping_tiles(|
|`_hdrplus_extract_aligned_tiles`|fn|priv|5261-5267|def _hdrplus_extract_aligned_tiles(|
|`_hdrplus_align_layer`|fn|priv|5340-5347|def _hdrplus_align_layer(|
|`_hdrplus_align_layers`|fn|priv|5437-5524|def _hdrplus_align_layers(np_module, scalar_frames, hdrpl...|
|`_hdrplus_resolve_temporal_runtime_options`|fn|priv|5525-5549|def _hdrplus_resolve_temporal_runtime_options(hdrplus_opt...|
|`_hdrplus_compute_temporal_weights`|fn|priv|5550-5554|def _hdrplus_compute_temporal_weights(|
|`_hdrplus_merge_temporal_rgb`|fn|priv|5635-5641|def _hdrplus_merge_temporal_rgb(|
|`_hdrplus_merge_spatial_rgb`|fn|priv|5690-5762|def _hdrplus_merge_spatial_rgb(np_module, temporal_tiles,...|
|`_run_hdr_plus_merge`|fn|priv|5763-5766|def _run_hdr_plus_merge(|
|`_convert_compression_to_quality`|fn|priv|5843-5853|def _convert_compression_to_quality(jpg_compression)|
|`_collect_missing_external_executables`|fn|priv|5854-5856|def _collect_missing_external_executables(|
|`_resolve_auto_adjust_dependencies`|fn|priv|5875-5900|def _resolve_auto_adjust_dependencies()|
|`_resolve_numpy_dependency`|fn|priv|5901-5920|def _resolve_numpy_dependency()|
|`_to_float32_image_array`|fn|priv|5921-5952|def _to_float32_image_array(np_module, image_data)|
|`_normalize_float_rgb_image`|fn|priv|5953-5980|def _normalize_float_rgb_image(np_module, image_data)|
|`_write_rgb_float_tiff16`|fn|priv|5981-6004|def _write_rgb_float_tiff16(imageio_module, np_module, ou...|
|`_write_debug_rgb_float_tiff`|fn|priv|6005-6010|def _write_debug_rgb_float_tiff(|
|`_build_debug_artifact_context`|fn|priv|6040-6060|def _build_debug_artifact_context(output_jpg, input_dng, ...|
|`_format_debug_ev_suffix_value`|fn|priv|6061-6078|def _format_debug_ev_suffix_value(ev_value)|
|`_materialize_bracket_tiffs_from_float`|fn|priv|6079-6083|def _materialize_bracket_tiffs_from_float(|
|`_to_uint8_image_array`|fn|priv|6113-6159|def _to_uint8_image_array(np_module, image_data)|
|`_to_uint16_image_array`|fn|priv|6160-6204|def _to_uint16_image_array(np_module, image_data)|
|`_apply_post_gamma_float`|fn|priv|6205-6230|def _apply_post_gamma_float(np_module, image_rgb_float, g...|
|`_apply_brightness_float`|fn|priv|6231-6253|def _apply_brightness_float(np_module, image_rgb_float, b...|
|`_apply_contrast_float`|fn|priv|6254-6278|def _apply_contrast_float(np_module, image_rgb_float, con...|
|`_apply_saturation_float`|fn|priv|6279-6308|def _apply_saturation_float(np_module, image_rgb_float, s...|
|`_apply_static_postprocess_float`|fn|priv|6309-6314|def _apply_static_postprocess_float(|
|`_to_linear_srgb`|fn|priv|6391-6408|def _to_linear_srgb(np_module, image_srgb)|
|`_from_linear_srgb`|fn|priv|6409-6426|def _from_linear_srgb(np_module, image_linear)|
|`_compute_bt709_luminance`|fn|priv|6427-6444|def _compute_bt709_luminance(np_module, linear_rgb)|
|`_analyze_luminance_key`|fn|priv|6445-6484|def _analyze_luminance_key(np_module, luminance, eps)|
|`_choose_auto_key_value`|fn|priv|6485-6530|def _choose_auto_key_value(key_analysis, auto_brightness_...|
|`_reinhard_global_tonemap_luminance`|fn|priv|6531-6536|def _reinhard_global_tonemap_luminance(|
|`_luminance_preserving_desaturate_to_fit`|fn|priv|6570-6597|def _luminance_preserving_desaturate_to_fit(np_module, rg...|
|`_apply_mild_local_contrast_bgr_uint16`|fn|priv|6598-6636|def _apply_mild_local_contrast_bgr_uint16(cv2_module, np_...|
|`_quantize_clahe_luminance_bins`|fn|priv|6637-6662|def _quantize_clahe_luminance_bins(np_module, luminance_v...|
|`_build_clahe_float_tile_histogram`|fn|priv|6663-6684|def _build_clahe_float_tile_histogram(np_module, luminanc...|
|`_clip_clahe_histogram`|fn|priv|6685-6732|def _clip_clahe_histogram(np_module, histogram, clip_limi...|
|`_build_clahe_float_lut`|fn|priv|6733-6752|def _build_clahe_float_lut(np_module, histogram, tile_pop...|
|`_pad_clahe_luminance_float`|fn|priv|6753-6791|def _pad_clahe_luminance_float(np_module, luminance_float...|
|`_build_clahe_axis_interpolation`|fn|priv|6792-6819|def _build_clahe_axis_interpolation(np_module, axis_lengt...|
|`_build_clahe_tile_luts_float`|fn|priv|6820-6871|def _build_clahe_tile_luts_float(np_module, luminance_flo...|
|`_interpolate_clahe_bilinear_float`|fn|priv|6872-6924|def _interpolate_clahe_bilinear_float(np_module, luminanc...|
|`_apply_clahe_luminance_float`|fn|priv|6925-6956|def _apply_clahe_luminance_float(np_module, luminance_flo...|
|`_reconstruct_rgb_from_ycrcb_luma_float`|fn|priv|6957-6980|def _reconstruct_rgb_from_ycrcb_luma_float(cv2_module, np...|
|`_apply_clahe_luma_rgb_float`|fn|priv|6981-7030|def _apply_clahe_luma_rgb_float(cv2_module, np_module, im...|
|`_rt_gamma2`|fn|priv|7031-7050|def _rt_gamma2(np_module, values)|
|`_rt_igamma2`|fn|priv|7051-7071|def _rt_igamma2(np_module, values)|
|`_auto_levels_index_to_normalized_value`|fn|priv|7072-7088|def _auto_levels_index_to_normalized_value(histogram_valu...|
|`_auto_levels_normalized_to_legacy_code_value`|fn|priv|7089-7104|def _auto_levels_normalized_to_legacy_code_value(value)|
|`_auto_levels_normalized_to_legacy_code`|fn|priv|7105-7121|def _auto_levels_normalized_to_legacy_code(np_module, val...|
|`_auto_levels_legacy_code_to_normalized`|fn|priv|7122-7137|def _auto_levels_legacy_code_to_normalized(np_module, val...|
|`_pack_auto_levels_metrics`|fn|priv|7138-7153|def _pack_auto_levels_metrics(|
|`_build_autoexp_histogram_rgb_float`|fn|priv|7205-7240|def _build_autoexp_histogram_rgb_float(np_module, image_r...|
|`_build_autoexp_histogram_rgb_uint16`|fn|priv|7241-7273|def _build_autoexp_histogram_rgb_uint16(np_module, image_...|
|`_compute_auto_levels_from_histogram`|fn|priv|7274-7473|def _compute_auto_levels_from_histogram(np_module, histog...|
|`_rt_simplebasecurve_scalar`|fn|priv|7547-7639|def _rt_simplebasecurve_scalar(x_value, black, shadow_rec...|
|`_basel`|fn|priv|7560-7576|def _basel(x_input, slope_start, slope_end)|
|`_baseu`|fn|priv|7577-7579|def _baseu(x_input, slope_start, slope_end)|
|`_cupper`|fn|priv|7580-7599|def _cupper(x_input, slope_value, highlight_recovery)|
|`_clower`|fn|priv|7600-7602|def _clower(x_input, slope_value, shadow_value)|
|`_clower2`|fn|priv|7603-7614|def _clower2(x_input, slope_value, shadow_value)|
|`_build_rt_nurbs_curve_lut`|fn|priv|7640-7773|def _build_rt_nurbs_curve_lut(np_module, x_points, y_poin...|
|`_sample_auto_levels_lut_float`|fn|priv|7774-7780|def _sample_auto_levels_lut_float(|
|`_build_auto_levels_full_histogram_rgb_float`|fn|priv|7812-7843|def _build_auto_levels_full_histogram_rgb_float(np_module...|
|`_rt_hlcurve_float`|fn|priv|7844-7874|def _rt_hlcurve_float(np_module, exp_scale, comp, hlrange...|
|`_build_auto_levels_tone_curve_state`|fn|priv|7875-8064|def _build_auto_levels_tone_curve_state(np_module, image_...|
|`_apply_auto_levels_tonal_transform_float`|fn|priv|8065-8068|def _apply_auto_levels_tonal_transform_float(|
|`_auto_levels_has_full_tone_metrics`|fn|priv|8152-8175|def _auto_levels_has_full_tone_metrics(auto_levels_metrics)|
|`_call_auto_levels_compat_helper`|fn|priv|8176-8181|def _call_auto_levels_compat_helper(|
|`_apply_auto_levels_float`|fn|priv|8225-8331|def _apply_auto_levels_float(np_module, image_rgb_float, ...|
|`_clip_auto_levels_out_of_gamut_float`|fn|priv|8332-8492|def _clip_auto_levels_out_of_gamut_float(np_module, image...|
|`_filmlike_clip_rgb_tone`|fn|priv|8362-8395|def _filmlike_clip_rgb_tone(primary, middle, lower)|
|`_clip_auto_levels_out_of_gamut_uint16`|fn|priv|8493-8494|def _clip_auto_levels_out_of_gamut_uint16(|
|`_hlrecovery_luminance_float`|fn|priv|8524-8570|def _hlrecovery_luminance_float(np_module, image_rgb, max...|
|`_hlrecovery_luminance_uint16`|fn|priv|8571-8599|def _hlrecovery_luminance_uint16(np_module, image_rgb, ma...|
|`_hlrecovery_cielab_float`|fn|priv|8600-8601|def _hlrecovery_cielab_float(|
|`_f_lab`|fn|priv|8634-8641|def _f_lab(values)|
|`_f2xyz`|fn|priv|8642-8648|def _f2xyz(values)|
|`_hlrecovery_cielab_uint16`|fn|priv|8684-8685|def _hlrecovery_cielab_uint16(|
|`_hlrecovery_blend_float`|fn|priv|8719-8824|def _hlrecovery_blend_float(np_module, image_rgb, hlmax, ...|
|`_hlrecovery_blend_uint16`|fn|priv|8825-8826|def _hlrecovery_blend_uint16(|
|`_dilate_mask_float`|fn|priv|8861-8883|def _dilate_mask_float(np_module, mask)|
|`_box_mean_3x3_float`|fn|priv|8884-8907|def _box_mean_3x3_float(np_module, image_2d)|
|`_hlrecovery_color_propagation_float`|fn|priv|8908-8952|def _hlrecovery_color_propagation_float(np_module, image_...|
|`_hlrecovery_color_propagation_uint16`|fn|priv|8953-8954|def _hlrecovery_color_propagation_uint16(|
|`_hlrecovery_inpaint_opposed_float`|fn|priv|8984-8985|def _hlrecovery_inpaint_opposed_float(|
|`_hlrecovery_inpaint_opposed_uint16`|fn|priv|9038-9039|def _hlrecovery_inpaint_opposed_uint16(|
|`_apply_auto_brightness_rgb_float`|fn|priv|9081-9084|def _apply_auto_brightness_rgb_float(|
|`_clamp01`|fn|priv|9141-9154|def _clamp01(np_module, values)|
|`_gaussian_kernel_2d`|fn|priv|9155-9177|def _gaussian_kernel_2d(np_module, sigma, radius=None)|
|`_rgb_to_hsl`|fn|priv|9178-9211|def _rgb_to_hsl(np_module, rgb)|
|`_hue_to_rgb`|fn|priv|9212-9242|def _hue_to_rgb(np_module, p_values, q_values, t_values)|
|`_hsl_to_rgb`|fn|priv|9243-9283|def _hsl_to_rgb(np_module, hue, saturation, lightness)|
|`_selective_blur_contrast_gated_vectorized`|fn|priv|9284-9285|def _selective_blur_contrast_gated_vectorized(|
|`_level_per_channel_adaptive`|fn|priv|9334-9356|def _level_per_channel_adaptive(np_module, rgb, low_pct=0...|
|`_sigmoidal_contrast`|fn|priv|9357-9381|def _sigmoidal_contrast(np_module, rgb, contrast=3.0, mid...|
|`logistic`|fn|pub|9372-9374|def logistic(z_values)|
|`_vibrance_hsl_gamma`|fn|priv|9382-9399|def _vibrance_hsl_gamma(np_module, rgb, saturation_gamma=...|
|`_gaussian_blur_rgb`|fn|priv|9400-9423|def _gaussian_blur_rgb(cv2_module, np_module, rgb, sigma)|
|`_high_pass_math_gray`|fn|priv|9424-9447|def _high_pass_math_gray(cv2_module, np_module, rgb, blur...|
|`_overlay_composite`|fn|priv|9448-9469|def _overlay_composite(np_module, base_rgb, overlay_gray)|
|`_apply_validated_auto_adjust_pipeline`|fn|priv|9470-9476|def _apply_validated_auto_adjust_pipeline(|
|`_load_piexif_dependency`|fn|priv|9585-9602|def _load_piexif_dependency()|
|`_encode_jpg`|fn|priv|9603-9614|def _encode_jpg(|
|`_collect_processing_errors`|fn|priv|9746-9774|def _collect_processing_errors(rawpy_module)|
|`_is_supported_runtime_os`|fn|priv|9775-9794|def _is_supported_runtime_os()|
|`run`|fn|pub|9795-9994|def run(args)|
